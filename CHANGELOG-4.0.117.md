...
#1783 bekræftede udløbsfilteret, men afslørede, at den nyeste HARMONIE-generation kun havde publiceret en kort forecastforkant. Umiddelbart generationsskift nulstillede derfor den progressive opbygning. #1785 produktionsbekræftede, at 21Z med 51,7 timers forkant blev udskudt til fordel for 18Z med 54,7 timer, og at fulde gates og deploy bestod. Målingen korrigerede samtidig den tidligere femdøgnsantagelse: denne HARMONIE-samling rækker naturligt cirka 60 timer, ikke 120. HARMONIE-run fastholdes derfor ved mindst 48 resterende timer; marine samlinger beholder 96-timerskravet. Valgt/nyeste run, tærskel og udskudt publikation logges diagnostisk.

DEC-0030 præciserer produktkravet: cirka 60 timer er HARMONIEs native kildehorisont, ikke RavRadars samlede prognosemål. En P1-analyse skal efter cachestabiliseringen kortlægge cirka 120-timers DMI-first kæder individuelt for vind, bølger, strøm, vandstand, temperatur og øvrige aktive komponenter. Fallback må kun udfylde den manglende hale og må ikke erstatte valide DMI-timer. Dette er roadmap-/kravregistrering uden ændring af produktionslogik eller RavScore.

#1788 produktionsverificerede den kildespecifikke 48-timers HARMONIE-fastholdelse: 18Z-reference blev bevaret, fire assets blev genbrugt, serien voksede fra fire til syv tider, og fulde gates samt deploy bestod. Cache-stabiliseringens stopregel er dermed opfyldt, så DEC-0030-kortlægningen er næste analyseopgave.

DEC-0030 fase A er påbegyndt som dokumentationsanalyse uden produktionsændring. Officielle DMI-kilder fastslår 54 timers HARMONIE NEA, 5½ døgns WAM og 5 døgns DKSS. WAM og DKSS indeholder også 10 m vind, så de skal vurderes som DMI-hale før ekstern fallback. Audit af den eksisterende kode fandt allerede komponentvis DMI-first merge, men også åbne krav til collection/run/lead-time-proveniens, eksplicit fallbackmodel og UTC-entydig sammensyning.
