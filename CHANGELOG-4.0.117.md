...
#1783 bekræftede udløbsfilteret, men afslørede, at den nyeste HARMONIE-generation kun havde publiceret en kort forecastforkant. Umiddelbart generationsskift nulstillede derfor den progressive femdøgnsopbygning. Bulk vælger nu stabilt: behold den foretrukne generation, mens den har mindst 96 fremtidige timer; ellers vælg den nyeste generation med mindst 96 timer. Valgt/nyeste run og udskudt ufuldstændig publikation logges diagnostisk.
