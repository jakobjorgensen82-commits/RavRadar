...
- #2855 viste dog, at den første cursor kun gik videre ved nye modelassets. Det ville gøre den geografiske rotation for langsom til en syvdøgnscache. Almindelige runs genlæser nu et lille, tidsafgrænset udsnit af de allerede cachede GRIB-filer for næste 15 kystdele. Der downloades intet ekstra, og replayet har ingen adgang til offentlig zoneoutput. 673 dele gennemløbes på 45 normale kørsler, cirka 11 timer og 15 minutter ved den aktuelle cadence.
- Statusdiagnostikken viser nu cursor, om rotationen avancerede, antal cache-replayassets og antal nye prøver. Regressioner beskytter tidsvindue, isolation og fremdrift; frisk CI-bevis mangler.
