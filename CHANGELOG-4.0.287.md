...
- Rollback-deploy `33014772035` satte `TRIP_STORAGE_MODE=supabase`, deployede de versionsstyrede Edge-funktioner og bestod ikke-skrivende CORS-, login- og feltkontrol. D1-shards/Worker, migration, kandidatens endelige exact-head/merge, fuld produktion og offentlig verifikation afventer fortsat.
