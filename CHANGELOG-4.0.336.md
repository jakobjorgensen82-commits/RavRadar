...
- Repositoryets webhåndbog og den statiske Supabase-installationskopi er synkroniseret bytepræcist efter tilføjelsen af 4.0.336-afsnittet.

## Evidensgrænse og scope

- Normalrun `34229976645` efterlod 2.015 par til Open-Meteo og bevarede cacherne uden handoff.
- PR #269 blev merged som `269db74b…`, mens exact-head-run `34245761528` stadig kørte. Runnet bestod releasegaten og stoppede senere alene på den nu rettede, usynkroniserede Supabase-håndbogskopi; det nåede ingen vejrruntime eller deploy.
