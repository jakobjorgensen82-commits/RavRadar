...
- DMI-cache-backfill er data-bevarende og atomisk: en hel donor-time fra samme kompatible registry må kun kopieres ind i en manglende eller strukturelt tom time; felter og komponenter blandes aldrig mellem runs. Alle saves sker før `DMI_READY`/strict-anchor-terminalgaten.
