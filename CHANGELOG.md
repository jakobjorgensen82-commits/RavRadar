...
- Den målrettede lokale matrix er grøn. GitHub-run `33986893042` nåede alle underliggende kode-/kontrakttests, men releasegaten fejlede alene på manglende `CHANGELOG-4.0.324.md`. Changelog/status-only-opfølgningscommitten er lokalt målvalideret. Ejeren har 2026-09-05 eksplicit beordret admin-merge uden ny exact-head; 4.0.324 får derfor ikke grønt exact-head-bevis og må ikke kaldes exact-head-grøn. Merge, cachebootstrap/runtime, fuld produktionsgate og komplet 210/673/118 afventer.
