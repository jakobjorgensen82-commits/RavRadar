...
RavRadar kører fortsat Candidate G/4.0.316 offentligt. Nødrollback PR #236 lagde den eksakte Candidate G-tree tilbage på `origin/main` `c58deb78`; exact-head-kørslen `33342157517` og den fulde post-merge-produktion `33342219152` var grønne. `33345476979`/`rr-20260831010337-210` var det første grønne recoverybevis. Den seneste offentlige kørsel er external-watchdog-`workflow_dispatch` `33347230240`, som bestod fuld DMI, validate, releasegate, storage gate og Pages og publicerede `rr-20260831012407-210` med 210 zoner/673 kystdele, `evidenceTrust=VERIFIED_ONLY` og `syntheticSampleCount=0`. Candidate G har aktuelt 0/210 aktive zoner, fordi dens historikhukommelse endnu er ufuldstændig. Den visuelle kontrol på mobil og computer er endnu ikke afsluttet. Den nye samlede model er derfor stadig 4.0.318-kandidat og ikke offentlig.
