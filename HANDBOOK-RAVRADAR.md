...
Den endelige integrerede 4.0.319-binding er `a226e7d10f5c9fa94e122c0e4e3dc1367f1d5e44e763593e4568ac8a3ed1b14b`/`8f723615a4ec0c0809c83caadfb843de2c5811e213d29518e1d60d9baa973807` over 44 transitive filer og otte deklarerede forbrugere. Candidate G-rollbackbindingen er særskilt `c73dac1b4376005e792580791d84eb79c9370e905a2a7fd0bdee857506a20cf8`/`1efabdda91d8ba491b10d406bfc325079a75e75b7c84807d8c24dfdf4f9e6fc3` over 56 filer. Bindingerne og de målrettede lokale tests er grønne; exact-head, slutlig 118-timers evidens, merge, frisk fuld produktion og offentlig browserkontrol afventer. Det aktive 15-minutters kontroljob skal diagnosticere run, gates, deploy og live side før en sikker reparation; det må ikke blindt starte en ny produktion eller oprette en ekstra scheduler eller vagthund. To tidligere runs, `33343469247` og `33344823000`, stoppede sikkert på forbigående 503 uden deploy. Efter PR #238/#239/#240 stoppede også `33391418061` og `33393684620` sikkert før DMI og før beskyttede writes; de er bevis for sikker afbrydelse, ikke for offentlig state 6. Den afgrænsede retry-rettelse bestod PR #237 exact-head `33352520408`, blev merged som `8c03e25d`, og backend-/fuld produktion `33352661061`/`33352634365` var grøn.
