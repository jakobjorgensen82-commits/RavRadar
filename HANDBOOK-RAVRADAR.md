...
Feggesund/`DK-B05-11` mangler 118/118 bølgefelter i det sanitiserede parent-zone-forecast `rr-20260830104132-210`. Men de tre aktive kystdele findes, er markeret med fuld marine dækning, og Candidate G-current virker for strand og waders. Den nye model beregner fra 673 kystdelsserier, så en frisk integreret produktion skal bevise de tre deles 3 × 118 direkte bølgetimer. En nabozoneproxy kan derfor være helt unødvendig, og den er nu pensioneret for denne release.

Et reelt hul på kystdelsniveau giver i denne release `UNAVAILABLE` og stopper releasegaten. Den tidligere idé om konservativ nabozoneinterpolation er ikke implementeret og er ikke længere en åben leverancevej: ingen proxy, syntese, carry, historieskabelse eller strømlån. Geometri, land-/vandpunkter og kystnormal flyttes ikke.
...
Den fælles 11-feltsbinding omfatter også ranking `direction-broad-19-history-tie-v2`, bedste tidspunkt `score-history-water-tie-earliest-v3` og præsentation `score-bands-35-55-75-exceptional90-v1`. 4.0.319 er låst med `modelContractSha256=778db7aa3946f925607a8304daa42ed17dd30294e4a51bf6d895d7293e84c4e7` og `modelBundleSha256=e880d5425e6f7b93d8afc99cddf491e58ad5a4a2ab055f8e4455193609c90a73` over 43 kanonisk normaliserede transitive implementeringsfiler og otte deklarerede forbrugere. Bindingen er regenereret og lokalt valideret; den er ikke i sig selv bevis for offentlig aktivering.
