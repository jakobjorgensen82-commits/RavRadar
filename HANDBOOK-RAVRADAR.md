...
Der findes ingen ekstra offentlig shadowmodel. Hvis 4.0.321 består det samlede DEC-0110/DEC-0112-cutover, bliver `RRS-COASTAL-PROCESS-INTEGRATED-1.1.0`/state `6.0.0` den eneste offentlige model, mens Candidate G kun ligger privat som migrations-/offline-/rollback-orakel. Kandidaten mangler egen exact-head, 673 × 118/Feggesund, live Supabase-bevis, frisk fuld produktion og offentlig desktop-/mobilkontrol. Kun en senere særskilt, manuel og fuldt verificeret hel rollback kan gøre Candidate G til den ene offentlige model igen; den er aldrig en samtidig eller automatisk fallback. Denne lokale dokumentation er ikke i sig selv et produktionsbevis.
...
*4.0.320-cutoverkandidatens beregning, trin for trin; den bliver først offentlig ved det samlede, verificerede cutover.*
...
Den offentlige projektion viser de tre komponenter, 20/50/30-vægtene, deres bidrag, den aktuelle profil, supply-/delivery-/mobiliseringsforløbet samt den strukturelle sidste-mile-usikkerhed. Den markerer, at gridstrøm ikke er surfzonens undertow eller ripstrøm, og at scoren ikke er fundprocent. Ufuldstændig historik giver fortsat score og prognose med konservative bounds; kun manglende direkte obligatoriske input gør den konkrete zone, søgemåde og time `UNAVAILABLE`. Hverken Candidate G eller den gamle 25/40/35-model kan overtage automatisk, og profiler blandes aldrig. Candidate G kan kun igen blive den ene offentlige model gennem den manuelle, fuldt verificerede hel rollback i kapitel 55.1.
