...
Den korte vejrkørsel hentede nye data og gemte arbejdet, men den
kunne ikke lægge en ny prognose på hjemmesiden. To forskellige
kontroller stoppede den: en vandstandstest manglede sin testfil,
og hjemmesidens hjælpefunktion var endnu ikke opdateret til den
aktuelle scoremodels identitet. Det siger ikke, at selve vejrdataene
er væk. Den hidtidige offentlige prognose blev bevaret.
...
Der mangler fortsat gyldige felter i alle fem vejrtyper, og årsagen
til Copernicus' manglende nye bidrag kræver særskilt undersøgelse.
R2 har endnu kun de fem tidligere produktionsobjekter (199,96 MB,
$0). Supabase Pro viste 0,20 GB cachet og 0,004 GB øvrig trafik i
den nye periode. Flere vellykkede driftsdøgn er nødvendige, før
gratisplanerne kan vurderes sikkert.

## 89.91 4.0.495 – Skeln mellem prognosetime og byggetid (historisk)
...
Begge gemte vejrpakker er nu kopieret til det private R2-lager og
kontrolleret byte for byte. Den næste korte kørsel hentede dem
korrekt tilbage, men stoppede før ny vejrhentning: samme klokkeslæt
var skrevet på to forskellige gyldige måder, som koden ikke begge
accepterede. Det er rettet uden at flytte eller afrunde tidspunktet.

Gennemgangen fandt også en fejl ved samling af Open-Meteo-data.
To leverandørsvar kan dække de samme timer, selv om cachen har valgt
forskellige svar for hver time. Samlingen skal bevare netop disse
valgte værdier, ikke vælge om ud fra rækkefølgen af hele svarene.
Den nye samler kontrollerer originalerne og udfylder kun hullerne.

Scoreberegning, leverandørprioritet og modelidentitet er uændrede.
De lokale kontroller består, men ny gemning i R2, offentlig deploy
og de tidligere 34 tabte temperaturfelter kræver stadig bevis fra
én kort normal vejrkørsel. Lange kørsler og cron venter på det.
R2- og Supabase-forbrug skal fortsat måles; flytningen er ikke i
sig selv bevis for, at gratisgrænserne kan overholdes.
...
Den seneste vejrhentning nåede gennem leverandørerne, men blev
stoppet, før den nye prognose kom online. Kontrollen fandt 34 steder
og timer, hvor en gyldig vandtemperatur ville blive tom. Det er en
reel fejl, som stadig skal afklares. Den færdige prognose fra den
kørsel er derfor ikke gemt som produktionscache.

Derimod blev arbejdet med at hente og samle vejrdata gemt i en
krypteret fremdriftspakke. Den næste korte kørsel skal først bevise,
at det er **præcis den pakke**, der åbnes og passer til den beskyttede
gamle cache. Hvis ikke, stopper den, før den bruger tid på ny
vejrindsamling. Leverandørerne får korte tidsrammer i dette forsøg;
hele den rigtige prognose skal stadig bygges, kontrolleres, gemmes
og vises på hjemmesiden. Først da er end-to-end-kæden bevist. En
lang ny opfyldning eller automatisk drift må vente på det bevis.
...
4.0.480 kom online og bevarede alle gamle gyldige værdier på de timer,
vi kunne sammenligne direkte. Men datasættet er endnu ikke komplet.
DMI nåede kun de første 31 af 115 officielle Limfjordstimer i sidste
kørsel. Når en ny prognose fra DMI kom, begyndte arbejdet forfra ved
den første time, så de fjernere timer kunne blive ved med at vente.

DMI skal stadig kontrollere de tre nærmeste timer først. Derefter
fortsætter den fra den sidste faktisk forsøgte prognosetime og roterer
gennem resten. Et mislykket forsøg tæller kun for turordenen, aldrig
som gyldigt vejr. Gyldige gamle felter bevares, og vandstand kommer
fortsat kun fra DMI.

Copernicus udfylder som før faktiske huller før Open-Meteo. En kort
ekstra tur efter dagens pakke er bygget forsøger også at forbedre
allerede brugbare Open-Meteo-reserver. Den ændrer ikke dagens viste
prognose og gemmes kun i den krypterede private cache til næste
kørsel. Hvis kilden ikke svarer, vises dagens pakke stadig. Vi måler
først i de næste rigtige kørsler, om DMI og Copernicus faktisk vokser;
rettelsen alene er ikke et bevis for fuldt vejr.

## 89.76 4.0.480 – Et nyt DMI-svar må ikke fjerne en gyldig gammel time

Den seneste normale vejrkørsel gemte faktisk en ny pakke og opdaterede
hjemmesiden. Ved en præcis sammenligning med den forrige pakke fandt vi
alligevel, at nogle Limfjordstimer med gyldig strøm, vandstand og
vandtemperatur var blevet tomme. DMI havde leveret en nyere prognose
for en senere time, men den ældre værdi var stadig gyldig for timen
imellem. Systemet afviste med rette at regne mellem to forskellige
prognoser, men glemte at bruge den gamle gyldige værdi alene.

Fra 4.0.480 må RavRadar i netop den situation beholde den verificerede
værdi for hvert vejrslag separat. Den må ikke være for gammel, komme
fra et andet sted eller dybdelag, eller fremstilles som en ny måling.
Nyere gyldige DMI-data vinder stadig, og en tom værdi må ikke slette
en gyldig. Hvis hverken nye eller gamle data er gyldige, vises et
ærligt hul. En lokal test er bestået; næste rigtige vejrkørsel skal
vise, at alle de berørte timer bevares på hjemmesiden.

Det betyder ikke, at vejrdatasættet er komplet. DMI's korte
prognosehorisont, Copernicus' udsatte kald og Open-Meteos rester skal
stadig undersøges hver for sig. Vandstand kommer fortsat kun fra DMI.

## 89.75 4.0.479 – Vejrpakken skal fortsætte, og hvert kald skal nå at blive gemt

Dette afsnit beskriver den tidligere 4.0.478-fejl. Den kørsel hentede
data, men opdaterede ikke hjemmesiden. Den fik ikke åbnet den senest
gemte private vejrpakke,
...
Den efterfølgende 4.0.479-kørsel gjorde det; resterende vejrdatahuller
og 4.0.480's modelrunskant er beskrevet i afsnittet ovenfor.
...
Den almindelige 4.0.435-kørsel kom faktisk gennem hele vejrhentningen og
scoreberegningen. Dens sikre kontrol viste gyldig vind og beregnelig vade- og
strandscore for alle 673 kyststrækninger. Fejlen kom bagefter, da programmet
forsøgte at samle hele den store private vejr- og scorepakke som én tekststreng
før den blev gemt. Den streng blev større, end Node kunne oprette.

4.0.436 gemmer nøjagtig de samme data lidt ad gangen i en midlertidig fil.
Først når hele filen er skrevet og synkroniseret, erstatter den den gamle fil.
Hvis noget fejler, bliver den seneste gyldige fil derfor stående. Der er også
en fast grænse under den størrelse, som de næste trin faktisk kan læse igen.

Rettelsen fjerner ingen timer, scorer eller kystdele. Den ændrer heller ikke
RavScore eller kildeprioriteten. Den løser kun den tekniske lagring af det
...
4.0.410 blev bygget, kontrolleret og lagt på Pages i run `35331664087`.
Først bagefter stoppede den centrale forsegling på de 673 kendte
historikfund. Derfor viser offentligheden den nye pakke, mens den centrale
aktive post stadig peger på den forrige pakke. Det er grunden til, at både en
kode-only-fortsættelse og en almindelig vejrstart efterfølgende stoppede sikkert.

4.0.412 har en engangsgenopretning, der kun kan genkende netop source-run
`35331109332` og target-run `35331664087`. Den sammenligner deres eksakte
heads, artifacts, digests, deployment-id'er, modelbinding, manifest, audit,
readiness, implementation closure og Pages-forsegling og kontrollerer live
igen. Kun hvis alt stemmer, registreres det allerede offentlige target som
central version 24. De 673 diagnostiske fund betyder fortsat, at data ikke må
bruges til kalibrering.

Genopretningen henter ikke vejr og deployer ikke. Når central og offentlig
sandhed igen er samlet, genbruger kode-only-ruten de gemte vejrdata og lægger
4.0.411's last-mile-rettelse online som 4.0.412. Derefter skal en almindelig
vejrvedligeholdelse bevise aktuel time, sammenhængende historik, lokal
femdøgnsvisning og cachevedligeholdelse.
...
### Den faste regel for alle vejrkilder

**Status – bindende regel; implementering og livebevis er i gang**

RavRadar følger altid denne rækkefølge:
...
Det betyder, at et tomt eller modstridende nyt svar ikke må viske en god
værdi væk. Hvis den gamle værdi stadig gælder den samme prognosetime og hele
dens kildebevis er i orden, bruges den videre. Den bliver ikke for gammel,
bare fordi den blev hentet i en tidligere RavRadar-kørsel.

Kildeordenen er fortsat DMI, Copernicus Baltic, Copernicus AMM15, regional
DMI og til sidst Open-Meteo. En ny god værdi fra en bedre kilde overtager.
RavRadar gætter aldrig en manglende værdi og låner ikke fra en anden
kystdel.

Alle 673 kystdele og 118 timer skal stadig stå i resultatet. Det giver
79.414 identiteter, men de kan være enten en valideret værdi eller et ærligt
`MISSING`. Kun nul `MISSING` må kaldes et komplet vejrdatasæt, og RavRadar
skal fortsat forsøge at lukke alle huller.

Hvis et ærligt hul alligevel er tilbage, bliver kun den berørte kystdel,
søgemåde og time utilgængelig. Resten af kortet og de øvrige scorer med
gyldige data fortsætter. Har zonen mindst én anden gyldig kystdel, vises en
tydeligt markeret delvis score med antallet af medregnede dele. Den må ikke
bruges til kalibrering, og vinderen markeres usikker. Først når ingen del i
den konkrete zone, søgemåde og time kan beregnes, bliver hele den konkrete
zonescore utilgængelig. Fejl i identitet, kildebevis, fysik, overlap,
datakontrakt eller sikkerhed er ikke lokale huller og stopper stadig.
...
### Aktuel status – RavScore 4.0.383 kode-only-rettelse

**Status for det aktuelle modelarbejde – lokal 4.0.383 samlet, exact-head og deploy afventer**

**Kort fortalt:** 4.0.382 byggede faktisk den rigtige komplette hjemmesidepakke
med alle 79 browserfiler. Den kom ikke online, fordi den centrale historik
stadig pegede på en ældre Pages-udgave end den side, der reelt er offentlig.

Den offentlige side er 4.0.381 og mangler den ene kendte decoderfil. Den
centrale pointer peger på en endnu ældre deployment. Den normale kontrol
afviste derfor med rette at fortsætte, fordi de to kilder ikke var ens.

4.0.383 har en enkelt, meget snæver reparationsvej. Den genkender 4.0.381 på
dens præcise run, commit, deployment, artifact og digitale fingeraftryk. Den
kontrollerer stadig alle 79 forventede filer: 78 skal være korrekte, og kun
den allerede dokumenterede decoder må svare 404. Alt andet stopper.

Det er kun den gamle kilde, der får denne behandling. Den nye 4.0.383-side
skal stadig have alle 79 filer og bestå de normale kontroller før upload og
igen efter deploy. Dermed kan den kendte defekte side repareres uden at gøre
fremtidige leveringer mindre sikre.

Leveringen henter intet vejr. Når 4.0.383 er verificeret offentligt og
centralt, følger én almindelig tidsbegrænset vejrkørsel for at bevise
numeriske scorer, DMI-rotation og cachevedligeholdelse. Der køres ingen
oneoff.
...
### Aktuel status – RavScore 4.0.380 kode-only-rettelse

**Status for det aktuelle modelarbejde – lokal 4.0.380 samlet, exact-head og deploy afventer**

4.0.379 kom helt gennem kontrollen af Pages-pakken og nåede også at gemme den
nye private runtime, lukke anonym adgang samt installere assistenten og dens
readiness. Der blev ikke hentet vejr. Kørselen stoppede før selve Pages-skiftet,
fordi to dele af koden var uenige om, hvor mange felter en auditrapport har.

Rapporten havde fire rigtige oplysninger: antal scores med fuld historik,
antal med ufuldstændig historik, antal utilgængelige scores og et samlet
ja/nej-felt. Kontrollen forventede kun tre og afviste derfor de 420 ærligt
utilgængelige aktuelle scores. 4.0.380 kræver nu alle fire oplysninger og at de
tre antal tilsammen er præcis 420. Utilgængelige scores bliver fortsat ikke
opfundet og må ikke bruges til kalibrering.

En samlet gennemgang fandt også en fremtidig genoptagelsesfejl. Efter en
kodeopgradering skal den næste private opgradering starte fra den pakke, der
faktisk er aktiv nu, ikke fra en gammel fast commit. Workflowet læser derfor en
snæver beskrivelse af den aktuelle beskyttede pakke, beviser at dens commit
ligger før den nye main og bruger præcis samme pakke gennem gendannelse,
migration og publicering. Beskrivelsen indeholder ingen private data eller
Storage-stier.

Kun modellens digitale bundlefingeraftryk må ændres. Vejr, målinger, scorer,
modeltilstande og de øvrige private filer skal være uændrede. Den gamle
...
**Produktionsstatus for rettelsen**

Den første produktionskørsel med 4.0.378 kom gennem central modelbinding,
gendannelse af den private cache, modelmigration, offentlig genopbygning,
210/673-strukturkontrol samt privat specifikation og bundle. Derefter stoppede
...
vejrdata, score, modeltilstand eller centralt gemt indhold. Næste bevis er én
exact-head-kildekontrol og derefter en ny providerfri kodelevering; normal
vejrhentning venter fortsat, til den nye model er offentligt verificeret.

## 88.82 4.0.378 – Robust kodelevering og historisk rollback

**Status efter samlet gennemgang 15. september:** Rettelserne er samlet
implementeret lokalt, men endnu ikke leveret. Ingen ny installation,
vejrkørsel eller oneoff er startet. En fuld liste over zoner er fortsat ikke
bevis for komplette vejrdata eller fungerende scorer. Se
`docs/ai/ASTRA_DELIVERY_CHAIN_REVIEW_2026-09-15.md`.

4.0.377 fandt den gemte DMI-cache og byggede både hjemmesidens data og den
private bundle. Publiceringen stoppede dog, fordi den gamle gemte runtime blev
krævet at have den nye models digitale fingeraftryk, før overgangen måtte
kontrolleres. En forgænger har naturligvis det gamle fingeraftryk.

4.0.378 skelner derfor mellem rollerne. Normalt skal den aktive private runtime
matche den aktuelle model præcist. Under den ene dokumenterede overgang må den
gamle aktive runtime kun accepteres, når den passer præcist med det forseglede
forgængermanifest. Efter publiceringen bliver den nye runtime aktiv, mens den
gamle bevares som historisk rollback.

Rollbackens binding kontrolleres fortsat for præcis form og gyldige hashes, og
dens filer må først bruges efter kontrol mod den konkrete forventning og den
lagrede bundle. Samme vejrtid er tilladt mellem de to, fordi vejret er uændret;
den strenge migrationskontrol skal stadig bevise, at kun modelmetadata er
ændret. En ældre vejrtid må fortsat ikke blive ny current.

Den direkte kodelevering installerer nu kun den eksakte RavRadar-assistent og
kontrollerer den før offentlig readiness. Privat specifikation, privat bundle,
Pages-pakke og privacy køres alle før nogen produktionwrite og rapporteres
samlet. Fejl kan dermed ses i samme gennemløb, uden at et halvt artifact bliver
publiceret.

Rene versionsnumre gør ikke længere en uændret privat vejr-cache inkompatibel,
og en ny kodecommit omskriver ikke pointeren, når alle data, kontrakter, model
og tider er identiske. Hvis et Supabase-svar forsvinder efter gemt write, læses
den præcise version og indholdshash tilbage; writet gentages ikke blindt.
Kortvarige sikre fejl prøves én gang mere. Et gammelt, udløbet current kan føre
til en ærlig målt koldstart, selv om tidligere modelhistorik er uegnet; udløbet
state bliver aldrig kaldt frisk, og korruption stopper fortsat.

Historisk gendannelse er nu afprøvet med to forskellige, selvkonsistente
arkiver, ikke en kunstig descriptor over samme fil. Den offentlige detaljefil
bruger desuden manifestets præcise størrelse under det fælles 192 MiB-loft.

## 88.81 4.0.377 – Code-only bruger den installerede cache

4.0.376 kom gennem hele genopbygningen af hjemmesidens data og kontrollen af
alle 210 zoner og 673 kystdele. Først bagefter stoppede den private
specifikation, fordi den ledte efter DMI-data i en midlertidig arbejdsfil fra
en rigtig vejrhentning. Dataene manglede ikke; den komplette cache var allerede
installeret i den faste fil under `data/live`.

4.0.377 læser den installerede `data/live/dmi-bulk-cache.json`. Den henter ikke
nye data hos DMI, Copernicus eller Open-Meteo.

Den gemte runtime skal samtidig kunne føres til den nye model uden at foregive,
at der er kommet nyt vejr. Derfor accepteres en ny privat runtime med samme
vejrtid kun, når et præcist bevis viser samme datasæt, ni filer, 210 zoner og
673 dele, uændrede målinger og modeltilstande samt byteidentiske øvrige
cachefiler. Kun den allerede kontrollerede modelmetadata må være ændret. Hvis
noget andet afviger, stopper publiceringen fortsat.

## 88.80 4.0.376 – En privacytekst er også en teknisk sti

4.0.375 flyttede hele den gemte modelidentitet korrekt og installerede den
private runtime. Den offentlige genopbygning stoppede bagefter på en koordinat,
som RavRadar allerede har godkendt til kortets dokumenterede strømpil.

Fejlen var ikke koordinaten. Den ekstra code-only-kontrol fik teksten
“Code-only startup runtime”, men kontrollen bruger teksten som begyndelsen på
den tekniske sti gennem dataene. Derfor kunne den ikke genkende den godkendte
sti under `startup`.

4.0.376 bruger nu de samme tre rødder som den fælles generator: `startup`,
`details` og `manifest`. Listen over tilladte koordinater er ikke udvidet.
Ukendte koordinater, rå strømvektorer og privat modeltilstand bliver fortsat
afvist. Der hentes ingen nye vejrdata og køres ingen oneoff.
...
4.0.363 kom igennem kildekontrollen og blev lagt på main. Et kort handoff genbrugte de eksisterende cacher uden at hente nyt vejr. Den næste cutover byggede igen alle 210 zoner, 673 kystdele og begge scorevisninger, men stoppede før database og hjemmeside.

Den forrige rettelse virkede: 32 af de 48 fejl var væk. De sidste 24 beskeder kom fra de samme otte korte strømfastholdelser. Der var ikke 24 nye fejl. Kontrollen glemte at give den virkelige ældre kildetid videre, da den selv regnede resultatet efter. Derfor troede den fejlagtigt, at et senere tomt svar var nyere end den rigtige måling. Først gav det én misvisende metadatafejl og bagefter to følgefejl pr. kystdel.

4.0.364 giver nu kontrollen præcis den kildetid, som modellen allerede brugte og gemte. Det sker kun, når tilstanden på forhånd er verificeret som en kort native strømfastholdelse. En direkte prøve beviser, at kontrollen nu får præcis samme resultat som producenten for både vadersøgning og strandsøgning.

Selve scoremodellen, vejret, rotationen, cachen og databasebindingen er uændrede. Næste trin er én kildekontrol på præcis 4.0.364, merge, et kort cache-handoff og cutover. Der køres hverken oneoff eller almindelig weather før modellen er online.

## 88.67 Lokal 4.0.363 – Den næste time må ikke ændre den forrige

4.0.362 blev kontrolleret, merged og fik et kort cache-handoff uden ny vejrhentning. Cutoveren byggede derefter hele runtimepakken for 210 zoner og 673 kystdele. Den stoppede før database og hjemmeside, fordi runtimekontrollen fandt fejl ved de samme otte korte strømfastholdelser.

Den vigtigste fejl var enkel: programmet genbrugte den samme interne liste over strømfastholdelser til flere forecasttimer. Da den næste time tilføjede en tidsmarkør, kom den også til at stå i den allerede færdige tilstand for mål-timen. Mål-timens tilstand så dermed ud til at kende fremtiden og kunne ikke læses igen. 4.0.363 giver hver time sin egen kopi, så en senere time ikke kan ændre en tidligere.

Candidate G-delen var allerede gyldig. Ved en kort fastholdelse skal dens reference fortsat pege på den virkelige måling to timer tidligere. Kontrollen krævede fejlagtigt en reference i selve mål-timen, som om der fandtes en ny måling. Nu accepterer den kun den ældre reference, når den integrerede model samtidig siger kort fastholdelse, begge peger på samme kildetid, det regionale kildebevis er korrekt, og alderen er højst tre timer.

Fejlene bliver altså ikke ignoreret. Den virkelige tilstandsfejl og den forkerte kontrol er begge rettet, og prøver uden bevis eller over tre timer bliver stadig afvist. Næste trin er én kildekontrol på præcis 4.0.363, merge, et kort same-head cache-handoff og cutover. Der køres hverken oneoff eller almindelig weather før modellen er online.

## 88.66 Lokal 4.0.362 – Få modellen online og ret videre på virkeligheden

Det seneste handoff havde et resultat for alle 79.414 kombinationer af kystdel og time. Det betød ikke, at alle havde et målt strømtal. Nogle resultater var en ærlig besked om, at kilden ikke havde en værdi. Den efterfølgende diagnose viste ved den første scoretime vind for 669 af 673 dele, bølger for alle 673, direkte strøm for 659, otte godkendte korte fastholdelser og seks dele uden brugbar strøm.

Alle scorer endte alligevel tomme på grund af én konkret vindfejl. Programmet fandt to nabotider fra hver sit DMI-modelrun og afviste korrekt at blande dem, men det ledte ikke bagefter efter to sikre tider inden for det samme DKSS-run. 4.0.362 gør netop det for DKSS-halevinden. Den almindelige HARMONIE-vind er fortsat streng.

De otte korte strømfastholdelser havde også en konkret forbindelsesfejl: den virkelige ældre kildetid blev ikke ført helt frem til scoretimen i begge modelveje. Nu må en kanonisk kilde højst tre timer tilbage bruges, hvis der ikke findes en nyere rigtig strømværdi. Senere tomme svar bliver ved med at være ukendt historik. RavRadar opfinder hverken en pil eller bevægelse, og scoren mærkes som ufuldstændig historik.

Ejeren har besluttet, at modellen nu skal online, også hvis nogle eller alle scorer først står ærligt utilgængelige. Den første cutover gentager derfor ikke de fire store kontrolpakker, som allerede har kørt. Den eksakte kildekontrol køres én gang før merge, og de nødvendige tekniske trin bygger modellen, installerer den append-only databasebinding, beskytter private data og deployer hjemmesiden.

Efter launch gennemgår vi den faktiske offentlige side og retter konkrete fejl samlet. Derefter genstarter vi almindelig vejrdrift og beviser, at cache, DMI-rotation og fallback vedligeholdes uden en ny oneoff.
...
4.0.359 kom gennem kildekontrollen og blev lagt på main. Det korte handoff genbrugte de komplette cacher uden at hente vejr og havde alle 79.414 strømpar. Cutover `34790416354` gennemførte alle fem hovedkontroller og samtlige 272 underkontroller. Fire hovedkontroller var grønne. Kun den rumlige kontrol fejlede for 617 dele, og derfor blev database og hjemmeside ikke ændret.

Det var ikke 617 manglende DMI-data. DMI gemmer først en streng, rå kilderække. Når RavRadar bygger de timeopdelte data til modellen og hjemmesiden, tilføjer den nogle afledte oplysninger, blandt andet hvilke native tider der blev brugt, tidsopløsningen og prognosens alder. Kontrollen sammenlignede den færdige form direkte med den rå form. De var derfor forskellige, selv om de beskrev præcis samme DMI-data.

4.0.360 bruger nu den samme eksisterende produktionsfunktion på begge sider af sammenligningen. Først skal den rå DMI-række stadig bestå alle sine identitets-, modelrun-, grid-, punkt-, tids- og hashkontroller. Derefter omformes den på præcis samme måde som i den rigtige runtime. Kontrollen bruger også dataenes fastlåste produktionstid og ikke det senere klokkeslæt, hvor den samlede fil tilfældigvis blev bygget.

En regression bruger nu en realistisk rå bulkrække uden de afledte runtimefelter. Den beviser desuden, at en senere byggetid ikke må forveksles med den fastlåste produktionsreference.

Rettelsen ignorerer ingen fejl og slækker ikke på cutoveren. Alle fem hovedkontroller og alle 272 underkontroller er stadig bindende. Vejrværdier, scoreformel, modelstate, rotation, geometri, database og privacy ændres ikke. Der køres ingen oneoff eller almindelig vejrdrift før modellen er online.

Næste trin er én exact-head-kildekontrol, merge, samme korte cachebaserede handoff og ny cutover. Ved grønt resultat fortsætter installationen automatisk til offentlig kontrol.

## 88.63 Lokal 4.0.359 – Den komplette fejlliste var seks fejl i kontrollerne

Cutover `34781869394` nåede denne gang hele vejen gennem alle 272 selvstændige kontroller. Fire af de fem hovedkontroller var grønne. Den sidste samlede seks røde underkontroller, så installationen stoppede før database og hjemmeside blev ændret.

De seks viste ikke manglende vejr eller en fejl i scoreberegningen. To tests forventede en gammel rotationsindstilling. En test brugte et gammelt format for tilgængelighed. En rumlig kontrol læste den gamle fallbackcache i stedet for den friskbyggede candidate-cache. En test forventede kunstige mellemtimer, selv om dens prøve med vilje manglede kildebevis. Den sidste talte gamle tekstlige kald og kendte ikke det nye, legitime Feggesund-tjek.

4.0.359 retter alle seks steder samlet. Den rumlige kontrol får samme candidate-cache som den almindelige fulde validering, og testene følger de kontrakter, der allerede gælder for produktet. Fejlene bliver altså ikke bare overset eller mærket ufarlige; selve de forkerte kontroller bliver rettet.

Hele sikkerhedsbarrieren består. En ny ukendt fejl eller en reel fejl i score, vejrdata, installation, hjemmeside eller sikkerhed stopper stadig efter den komplette kontrolliste og før eksterne ændringer. Der køres ingen oneoff, og scoremodel, vejrdata, geometri og database ændres ikke i denne rettelse.

Efter én exact-head-kildekontrol og merge genskabes kun det korte SHA-bundne handoff fra de samme komplette cacher. Derefter køres cutover igen. Almindelig vejrdrift starter først, når modellen og hjemmesiden er verificeret offentligt.

Den første exact-head-kontrol fandt én glemt kopi: det nye håndbogsafsnit var endnu ikke ført ind i Supabase-installationsfilen. Kopien er nu synkroniseret med projektets eget værktøj. Kontrollen nåede ikke resten af sourceplanen, så de resterende 90 punkter blev kørt samlet lokalt; ingen ny kodefejl blev fundet.

## 88.62 Lokal 4.0.358 – Hele kontrollen skal fortælle om alle selvstændige fejl

Den seneste cutover gennemførte fem hovedkontroller, men den største af dem stoppede ved sin første gamle testfejl. Derfor vidste vi ikke, om der lå flere uafhængige fejl længere nede i samme kontrol.

4.0.358 laver fra start en liste over alle selvstændige kontroller. Den gemmer løbende, hvad der ikke er startet, hvad der kører, og hvad der er bestået eller fejlet. En fejl stopper ikke de næste selvstændige kontroller. Når alle fem hovedkontroller er færdige, får vi én samlet fejlliste. Hvis listen er grøn, fortsætter installationen automatisk. Hvis den indeholder en reel fejl, stoppes der én gang før database og offentlig side ændres.

Samtidig er de allerede fundne fejl rettet: strømtesten bruger det rigtige DMI-kildebevis, en gammel test bruger ikke længere den gamle scoremodel, gyldige nej-værdier stopper ikke shellen, og Pages sammenblander ikke et lokalt datahul med modellens historikhukommelse.

Det ændrer ikke scoreformlen eller vejret. First-cutover må bruge op til 180 minutter på hele forløbet, mens almindelig drift og DMI's egne tider er uændrede. De eksisterende cacher genbruges; der køres ingen ny oneoff.
...
**Status:** Fortsættelse `34745557797` hentede ikke nyt vejr og gentog ikke den store 210/673-kontrol. Den gendannede de fire gemte cacher og byggede den private runtime. Komprimeringen fra 4.0.352 virkede og fjernede den gamle tekstfejl.

Det nye stop skyldtes, at alle private filer tilsammen var større end den gamle samlede grænse på 768 MiB. En enkelt fil var ikke nødvendigvis for stor, og fejlen siger intet om huller i vejret eller scoren.

Efter ejerens præcise godkendelse må den nye komprimerede arkivtype rumme højst 2 GiB, når man regner filernes oprindelige størrelser sammen. Hver fil må stadig højst være 768 MiB. Gamle arkiver må stadig højst være 768 MiB samlet. Første cutover må stadig højst sende 50.000.000 komprimerede byte til Supabase, inden for det tekniske loft på 50 MiB.

Ved gendannelse behandles én fil ad gangen. Den pakkes ud, dens størrelse og kontrolsum kontrolleres, og den skrives til et privat midlertidigt område. Først når alle filer er kontrolleret, bliver hele pakken gjort gældende på én gang. En fejl midtvejs efterlader derfor ikke en halv pakke.

Rettelsen ændrer ikke vejrdata, scoremodel, geometri eller den offentlige side. Næste trin er én samlet GitHub-kildekontrol og derefter den samme hurtige cachefortsættelse uden oneoff. Hvis kapacitet og handoff er grønne, fortsætter den eksisterende fuldt kontrollerede cutover.
...
RavScore 4.0.375 flyttede kun eksakt genkendte `modelBundleSha256`-felter og
beviste bagefter, at ingen gammel hash var tilbage. 4.0.376 beviste derefter
offentlig genopbygning og 210/673-audit, men den private specifikation brugte
en midlertidig DMI-sti. 4.0.377 bruger den installerede kanoniske cache og
binder en efterfølger på samme vejrtid til det eksakte migrationsbevis.
4.0.380 er låst med
`modelContractSha256=a226e7d10f5c9fa94e122c0e4e3dc1367f1d5e44e763593e4568ac8a3ed1b14b`.
Den tilhørende `modelBundleSha256=8727feba7227fa546861ec73091879ca9fec07b6375f81b219c752e5d25df733` over 56 kanonisk normaliserede transitive implementeringsfiler og otte deklarerede forbrugere skal matche runtime og releasegate.

Efter Astra-gennemgangen installerer den providerfri code-only-vej den eksakte
assistent, samler alle fire uafhængige prewrite-kontroller og håndterer
identisk privat indhold, historisk restore, mistede Supabase-svar, sikre
transienter, udløbet state og offentlig detailstørrelse uden de fundne falske
stop. Målrettede lokale kontroller er grønne; dette er endnu ikke et livebevis.
...
Version 4.0.334 er endnu kun en lokal, måltestet kandidat. Den ændrer den kritiske vejrhentning, så begge WAM-områder får reel køretid, og så et ufuldstændigt run gemmer sin brugbare progression, men stopper før et ufærdigt produkt kan blive offentligt.

- Efter højst ét nødvendigt DKSS-lead reserveres fair runtime til både `wam_dw` og `wam_nsb`. Den samlede runtimegrænse gælder stadig.
- Hver WAM-familie skal dække sin egen 118-timersakse. En bro må højst være fire timer og må ikke krydse collection, modelrun, grid eller celle.
- Allerede behandlede filer genbruges. En scheduler-reserve er ikke det samme som et leverandørudfald.
- Alle dele får præcis 118 positioner. Manglende værdier markeres `MISSING`, og sammenhørende vejrkomponenter udskiftes samlet, så gamle og nye delværdier ikke blandes.
- Feggesund skal bevise tre dele × 118 timer både før scoring og ved slutkontrollen. Beviserne skal være identiske.
- En gammel, men ensartet Candidate G-target bruges ikke til en lang kunstig bro: højst tre timers targetforskel accepteres; ellers startes en source-attesteret cold start på produktionsmålet. Blandede targets stopper.
- Første cutover bindes til det konkrete positive run-id. Oneoff `34161930631` gav fuld strømclosure 79.414/79.414, men stoppede på Feggesund og publicerede derfor intet.
- Efter reaktivering er de normale vejrkørsler den faste vedligeholder; oneoff er kun en accelerator. To kendte P2-latenspunkter følges efter launch og ændrer ikke correctnesskravene.

## Open-Meteo genbestiller kun uløste huller – 4.0.333

Den seneste komplette 4.0.332-kildekontrol blev grøn, og versionen kom på `main`. Engangskørsel `34127986853` genbrugte de eksisterende cacher og nåede samlet 79.132 af 79.414 strømpar. Efter DMI, Copernicus og regional DMI modtog Open-Meteo 472 præcise rester, bevarede 76 fra cachen, hentede 114 nye og udfyldte i alt 190. De sidste 282 manglede stadig, så RavRadar byggede eller udgav korrekt intet nyt artifact og skiftede ikke scoremodel.

Runnet beviser, at cachen ikke blev nulstillet: eksisterende data blev genbrugt, og nye Open-Meteo-par blev gemt. Det beviser ikke den konkrete payload-/stopårsag, fordi den nye diagnostik endnu ikke fandtes. Kodegennemgangen viste samtidig en selvstændig risiko: Når Open-Meteo gav et delvist svar, blev de gode par gemt, men resten kunne blive genbestilt samlet og ramme et fælles loft efter tre runder. 4.0.333 fjerner hvert godkendt kystdel/time-par fra køen med det samme. Kun de uløste par går bagest i en rigtig bredde-først-kø. En tvetydig gruppe deles højst i to, indtil den konkrete defekte kystdel eller time står alene. Raske søskende kan derfor fortsætte og checkpointes. Næste main-oneoff skal vise, hvad de eventuelle rester faktisk skyldes.

Køen er stadig stramt begrænset. Hver eksakt arbejdsgruppe får højst tre transportforsøg og ét ekstra forsøg på et modtaget, men ufuldstændigt svar. En kørsel får højst 1.024 Open-Meteo-kald, højst 2.048 ventende grupper og én fælles tidsfrist. Rate limits og midlertidige HTTP-fejl giver en kort fælles leverandørpause; `Retry-After` begrænses til 15 sekunder. En fælles query-/providerfejl som HTTP 400 stopper Open-Meteo uden tusind opsplittede kald. Kun fejl om for stor request, 413/414, må isoleres ved deling. Når tid eller budget slutter, gemmes fremgangen, og resten er stadig ærligt missing til næste kørsel.

Datareglerne er ikke lempet: samme punkt og time, UTC/GMT, m/s og grader, højst 15 km, ingen interpolation, kopiering fra naboer eller opfundet historik. Open-Meteo er fortsat en kombineret strømreserve med `calibrationEligible=false` og kan senere erstattes af DMI eller Copernicus. Et nyt vejrsæt og modelskift kræver stadig præcis 79.414/79.414, én kilde pr. par, nul overlap/missing og alle fulde produktionskontroller.

Status: Den korte DMI/Copernicus/regional/Open-Meteo/closure-kæde, live-runtime-kontrollerne og de nye 8-del-, 50-del-, defekt-time-, retry- og budgettests er grønne lokalt; to uafhængige reviews er GO. 4.0.333 mangler endnu exact-head GitHub-kontrol, merge og den afgørende main-oneoff. Candidate G er fortsat offentlig, og det almindelige workflow er deaktiveret, indtil et komplet run kan aflevere det runbundne handoff til den kontrollerede modelcutover.
...
DMI-, Copernicus- og Open-Meteo-cacher kontrolleres i små uafhængige bevisenheder. En enkelt ugyldig record fjernes som et ærligt hul, mens andre verificerede rækker og deres genbyggede hashes/seals bevares. Ugyldig topidentitet, target, register eller anden central kontrolinformation stopper fortsat. Hvis DMI-kataloget ærligt ikke kan vælge et modelrun og ledgeren derfor har nul positive eller kildebærende rækker, bidrager denne collection ingen DMI-dækning, og hele den eksakte rest går videre. Dokumenterede retained rækker fra et ældre run bevares; en positiv eller kildebærende række uden valgt run er fortsat en fatal konflikt. En ældre gyldig tuple står, indtil en nyere tuple er fuldt kontrolleret og kan erstatte den samlet efter DMI → Baltic → AMM15 → policyregional DMI → Open-Meteo. Open-Meteo låser ikke rækken til sig selv.
...
RavRadars kildekontrol sammenligner ikke kun den aktuelle kode. Den beviser også den fastlåste offentlige Candidate G-kilde fra et bestemt historisk Git-head. Det gør modelovergangen reproducerbar, men betyder, at workflowet skal hente netop dette historiske sourceobjekt, når GitHub starter med et overfladisk checkout.

118-timerskørslen `34077360903` kørte på den korrekte `main`-commit og bestod selve releasegaten. Den stoppede derefter, fordi det historiske Candidate G-head `49dd4cb454656bdf629e5df760176705e38d2cb0` ikke fandtes i runnerens lokale Git-historik. Fejlen skete før central konfiguration, vejrcacher og leverandører blev åbnet. DMI, Copernicus og Open-Meteo blev derfor ikke prøvet, og ingen vejrcachedata blev ændret. Den efterfølgende røde Open-Meteo-slutlinje var kun en følge af, at fill-trinnet var sprunget over; den beviser ikke en fejl hos Open-Meteo.

4.0.331 henter det eksakte fastlåste sourcehead, når den fulde kildegate faktisk skal køres, og kontrollerer både commit og tree før gaten. Det gælder den almindelige vejrbygning, den manuelle Copernicus-pilot og den store oneoff. Hentningen er read-only og flytter ikke den aktuelle checkout-commit, ændrer ikke cache og skriver ikke til RavRadars beskyttede runtime. En allerede live-verificeret exact-main-kildekontrol kan fortsat genbruges efter de eksisterende regler.

Dette ændrer ikke vejrsystemets logik. Den almindelige kørsel skal fortsat vedligeholde hele cachen, oneoff er kun accelerator, og kildeordenen er fortsat DMI, Baltic, AMM15, regional DMI og Open-Meteo. Før publicering kræves stadig præcis 79.414/79.414 currentpar, én kilde pr. par og nul overlap eller mangler. De foregående højst 48 timers verificerede historik er fortsat rådgivende. Normal workflow er fortsat deaktiveret under den kontrollerede opfyldning.

Status: 4.0.330 blev merged, men nåede ingen vejrruntime og er derfor supersederet af den snævre 4.0.331-rettelse. Ny exact-head-kontrol, merge, frisk main-oneoff, Feggesund 354/354, spatial audit, live kapacitet, fulde produktionsgates, deploy og den særskilte modelaktivering mangler fortsat. Candidate G er offentlig.
...
Open-Meteo har sin egen delte private progresscache for både almindelig drift og oneoff. Hver record bærer sin faktiske hentetid. Ved et nyt target genbruges kun valideret overlap, og cachen checkpointes før første netværkskald samt efter hvert accepteret delresultat. Fra 4.0.333 fjernes succespar straks, og kun den eksakte rest fortsætter i bounded FIFO/BFS. En fejl isoleres binært helt ned til kystdel/time, mens per-work retry, fælles request-/queuecap, deadline og provider-cooldown beskytter driften. Gemt fremgang og raske søskende bevares.
...
Aktuel status: 4.0.333 er merged, og oneoff `34161930631` beviste komplet current-closure med 79.414/79.414, men stoppede korrekt på Feggesunds WAM-dækning før artifact, deploy og modelskift. Den lokale 4.0.334-kandidat gør WAM-readiness til en tidlig, cachebevarende gate; exact-head CI, merge og komplet produktionsruntime mangler. Candidate G er offentlig. Den integrerede scoremodel må først gå online efter 79.414/79.414-vejrclosure, Feggesund 354/354, hydreret spatial audit, live kapacitetsbevis, fuld post-data validering og releasegate, artifact/deploy og den særskilte autoriserede Phase B-cutover. Vejrcacheændringen flytter ingen geometri eller land-/vandpunkter og ændrer ikke scoreformlen.
...
Den regionale DMI-shadow beholder syv dages historik, men kun modelruns, som den aktuelle strenge ledger har valgt, må påvirke den nuværende closure. Efter den første rolloverrettelse kunne en gammel, ikke-valgt prøve stadig stoppe på sin cadence, før systemet nåede at afgøre, at runnet var irrelevant. RavRadar validerer nu prøvens minimale identitet og sorterer derefter ikke-valgte runs fra. De kan hverken levere aktuelle data eller blokere næste fallback. En prøve fra et valgt run skal fortsat bestå cadence, asset-hash, afstand og vektorbevis.

Gennemgangen fandt også en uafhængig enhedsfejl. Open-Meteo ignorerede parameteren velocity_unit=ms og svarede i km/t, som koden kunne behandle som m/s. Requesten bruger nu den dokumenterede wind_speed_unit=ms, og hvert svar skal eksplicit angive GMT, UTC-offset nul, hastighed i m/s og retning i grader. Ukendte enheder stopper før record og artifact.

Generiske live-prober mod leverandøren bekræftede den valgte meteofrance_currents-model, et eksakt 118-timersvindue og batches på 50 punkter. Normal drift og oneoff bruger samme rettede kode. Cachegenerationer, 48-timers mobiliseringshistorik, kildeorden og ekstern cron er uændrede; en frisk main-oneoff skal fortsat bevise den faktiske komplette RavRadar-dækning.

## Gamle regionale modelruns må ikke blokere Open-Meteo – 2026-09-06

Den private regionale DMI-cache beholder syv dages prøver, så nyttig historik ikke forsvinder ved et nyt modelrun. En tidligere prøve kunne imidlertid ligge på samme prognosetime som et aktuelt hul. Den blev derfor fejlagtigt opfattet som en ændret fil i det aktuelle modelrun, og Open-Meteo blev stoppet, før der overhovedet blev sendt en forespørgsel.

RavRadar skelner nu mellem modelruns. En prøve fra et ældre run kan ikke bruges som aktuelle data, men den er heller ikke en konflikt med den nye ledgers filer. Hullet fortsætter derfor til næste tilladte fallback. Hvis filhashen derimod ændres inden for det modelrun, som den aktuelle ledger faktisk har valgt, stopper kæden stadig. Der indføres ingen stale data, interpolation eller lempelse af proveniens.

Fejlloggen kan samtidig vise en kort, fast domænekode, så en ny kontraktfejl ikke kræver endnu en lang blind kørsel. Koden kan ikke indeholde kystdels-id''er, koordinater, rå strømværdier, payloads eller fritekst. Oneoff `34004697179` beviste DMI og Copernicus READY, men ikke komplet data; 1.104 operationelle par stod tilbage før rettelsen. Ny exact-head, merge og en frisk stor main-oneoff afventer.
...
## Historisk: Open-Meteo lukker kun de sidste præcise strømhuller – 2026-09-05

**SUPERSEDERET DELREGEL:** READY-only-mellemgrænsen nedenfor blev erstattet af DEC-0118. DMI/Copernicus-fejl kan nu blive en eksakt, verificeret residual, som næste kilde må forsøge; de kan stadig aldrig blive kildeudtømning eller publiceringsbevis.

RavRadar prøver strøm i denne rækkefølge: DMI, Copernicus Baltic, Copernicus AMM15, den godkendte regionale DMI-vej for otte Limfjordsdele og til sidst Open-Meteo. Historisk blev sidste reserve kun brugt, når de forudgående kilder var fuldt og sikkert afsluttet. Denne READY-only-formulering er ikke længere aktiv.
...
Begge ændringer ligger i den fælles producent, så både engangsopfyldningen og den normale vejrhentning får dem efter merge. Cron skal ikke have nye ordrer. Kun HARMONIE-vind skal genbehandles; gemt strøm, bølger og Copernicus-arbejde nulstilles ikke. Forbrugerne kræver dokumentation for den korrekte vindreference. Modelpakkernes kontrolaftryk følger med i en ny databasemigration; allerede anvendte migrationer omskrives ikke. Scoreformel, model-id og stateversion ændres ikke.

Status: rettelsen og de tilhørende bindinger er måltestet lokalt; GitHub-kontrol, merge og nyt samlet vejrbevis afventer. Den normale kørsel efter engangsopfyldningen genbrugte faktisk alle fire gemte cachefamilier. Den stoppede igen ved Copernicus' kontrollerede arbejdsgrænse og gemte den nye fremgang. Det er ikke et bevis for komplet vejr. Første engangskørsels sikkerhedsrettelse nedenfor er nu merged i PR #251; dens tidligere lokalstatus er historisk. Det fulde slutkrav gælder fortsat alle nødvendige datalag for 210 zoner, 673 kystdele og 118 timer, uden at kræve komplet 48-timershistorik.
...
Databasen kontrollerer selv den eksakte envelope, 673 integrerede dele, 673 READY Candidate G-rollbackdele, fælles target, tider, modelbindinger, continuation-hash og privacyforbud. Selve replaymatematikken og generationshashen beregnes fortsat i JavaScript og kontrolleres også dér; SQL forsøger ikke at genberegne modellen. Ingen stateposter, koordinater, vejrpayloads eller rå U/V returneres i metadataresultatet.

Migration, frisk databaseskema og sikkerhedsinstaller indeholder samme genererede kontrakt. Den lokale målmatrix er grøn. Før state 6 må aktiveres, mangler fortsat 4.0.321 exact-head, komplet 673 × 118, Feggesund 3 × 118, live Supabase før/efter-måling med mindst 30 procent reserve, sikker merge, frisk fuld produktion og offentlig mobil-/desktopkontrol.

## Første modelskift sker i to kontrollerede faser – Phase A merged, Phase B afventer

Candidate G er fortsat den eneste offentlige model. RavRadar merger ikke længere den nye kode og skifter scoremodel i samme automatiske skridt:

1. **Fase A – ny kode, stadig Candidate G:** Den samlede kode kommer på `main`, men produktionen bygger fortsat Candidate G. Hvis den centrale kilde stadig er legacy, føres den gennem den eksisterende sikre bro til den moderne Candidate G-binding på samme head. Fase A må ske før 673 × 118-beviset, så tidsplanen kan opbygge den korrigerede cache på den mergede kode. Push, tidsplan, watchdog og en almindelig manuel vejrkørsel kan ikke aktivere state 6.
2. **Kapacitetskontrol:** På den nye same-head Candidate G-produktion måles Supabase-forbruget før og efter. Sammen med faktisk øvrig egress og lager skal beregningen efterlade mindst 30 procent reserve. En lokal størrelsesmåling eller tekst i et inputfelt er ikke nok.
3. **Fase B – udtrykkeligt modelskift:** Først når data-, release- og kapacitetsgates er grønne, må en særskilt manuel GitHub-kørsel sætte både `ravscore_integrated_first_cutover=true` og den eksakte bekræftelse `EXECUTE-INTEGRATED-RAVSCORE-FIRST-CUTOVER-AFTER-CAPACITY-GATE`. Før vejrhentningen kontrollerer RavRadar den forseglede centrale Fase-A-identitet: current Candidate G på samme kodehead med eksakt binding, manifesthash, datasæt/reference, deployment-id, implementation closure og `sourceHead`. Den faktiske offentlige source, manifest og implementation kontrolleres igen i deployleddet, før den første centrale overgangsskrivning.

Bekræftelsen er kun tilladelse til at udføre operationen; den er ikke et bevis for kapacitet eller datadækning. Forkert eller løsrevet bekræftelse, en gammel/legacy kilde eller et mismatch stopper før modelskiftet. Eksisterende forseglede recoveryplaner bevares. Låsen ændrer ingen RavScore-formel, model-/bundlehash, state, vejrdata, geometri eller land-/vandpunkter.

Tofaselåsen bestod exact-head `33706215425` og er merged gennem PR #246 som `7198b685`. Det afslutter kodegrundlagets Phase A, men ikke modelskiftet: Candidate G er fortsat offentlig, mens 673 × 118, Feggesund, live kapacitet, frisk produktion, særskilt manuel Phase B og offentlig state-6-verifikation stadig mangler.

## Integrated-first med verificeret historikopbygning – Phase A merged, state 6 ikke offentlig

Candidate G er fortsat den eneste offentlige model. Beslutningen er, at state 6 må gå online som én samlet integreret model, når den friske direkte og operationelle prognosekæde er komplet, selv om den ældre historik endnu ikke er fuldt opbygget. Cutover-, warmup-, kalibrerings-, current- og preflightkontrakterne indgår nu i det mergede Phase A-kodegrundlag. Grøn 118-timers datapreflight, live kapacitetsbevis, 4.0.321 exact-head/merge, frisk fuld produktion, særskilt manuel Phase B og offentlig desktop-/mobilkontrol er stadig afventende.

DMI leverede faktisk DKSS-filerne i de seneste isolerede forsøg. Forsinkelsen opstod i RavRadar, fordi samme GRIB-grid blev gjort klar til nearest-søgning igen for hvert kystpunkt, og fordi den fulde cache blev renset, analyseret og skrevet igen efter næsten hvert asset. Producenten gør nu gridet klar én gang pr. GRIB-message og genbruger det sikkert til de øvrige punkter. Det ændrer ikke, hvilket vandpunkt, gridpunkt, lag eller felt der kan vælges, og det udvider ikke 5 km-grænsen.

Copernicus skal stadig kun udfylde de præcise strømpositioner, som mangler efter en grøn DMI-kontrol. Hvis alle resthuller ikke kan hentes i ét forsøg, gemmes kun helt færdige og kontrollerede delpakker. Næste workflowrun fortsætter med resten. Hvert forsøg har en fast grænse på 20 minutter, så GitHub også når at gemme progressionen. Den delvise cache er privat, kan aldrig kaldes komplet og kan ikke sendes ud. Der opfindes ingen historik, og DMI prøves fortsat først.

Den interne processed cache får en ny gridgeneration og bindes til både ecCodes-API'et og Python-bindingens version. Den offentlige griddefinition, faktisk hentede kildehistorik, provenance, state og recovery beholder deres eksisterende identitet. Det er altså en performance- og robusthedsrettelse, ikke en ny strømfortolkning eller en nulstilling af allerede indsamlet historik.

De obligatoriske DKSS-currentfelter U, V og vandstand behandles stadig for hver krævet forecasttime; de valgfrie marine felter følger fortsat den etablerede tretimersrytme. Hvert asset bygges nu isoleret og bliver først en del af den holdbare cache, når det er komplet og valideret. En afbrydelse eller fejl ruller hele det pågældende asset tilbage; den kan ikke efterlade en halv fil, en falsk færdigmarkør eller falsk `DMI_READY`.

Progression gemmes kompakt og atomisk senest efter otte committede assets eller 60 sekunder og altid ved afbrydelse, collectionslut eller fejl. Den tunge slutoprydning og diagnostik køres kun én gang, når producenten faktisk er færdig. DMI er stadig førstevalg, og Copernicus må stadig kun udfylde præcise dokumenterede resthuller efter en grøn DMI-slutkontrol. Tolv dynamiske transaction/checkpointtests, 21 WAM-bootstraptests og den uafhængige slutreview er grønne; frisk GitHub-preflight er fortsat det nødvendige driftsbevis.
...
Currentkæden skelner nu teknisk mellem de to tidsretninger. Den private Copernicus-cache bruger schema 3 og kan kun kaldes `OPERATIONAL_COMPLETE`, når DMI-first-hullerne fra target til +117 er dækket eksakt for alle 673 dele. De foregående 48 timer er rådgivende historik med egne optællinger og hashes og må kun bestå af verificerede, faktisk hentede kildefelter uden syntese. Copernicus-bidrag er fortidige modelfelter, ikke instrumentmålinger. Historikken må gerne være ufuldstændig og give `HISTORY_INCOMPLETE`, men den kan aldrig tælle som operationel dækning eller fyldes kunstigt ud.
...
Den eksakte 118-timers strømakse følger den eksisterende kildeorden celle for celle. I den seneste sikre optælling leverede lokal DMI 72.769 af 79.414 del-/timepositioner. 673 af de 6.645 restpositioner var blot den fælles sidste forecasttime +117, ikke 673 dele uden DMI gennem hele perioden. Efter grøn DMI-terminalkontrol prøves alle eksakte restpositioner først i Copernicus Baltic og derefter AMM15. Et kildebevis pr. par kontrollerer både det valgte produkts eget geografiske område og, før AMM15, et komplet resultatløst Baltic-forsøg eller et eksakt dokumenteret “ikke anvendelig her”; timeout er aldrig udtømning. Kun hvis begge Copernicus-kilder dermed er dokumenteret udtømte for et konkret restpar blandt præcis de otte policybundne Limfjordsdele, må den regionale DMI-vej lukke det med selvstændigt bevis for native data eller et kausalt, højst 1–3 timers derived-state hold. Holdet er kun en kompakt tilstandsmarkør for præcis del, forecasttime, kildetime og alder. Det skaber ingen U/V, fart, retning, gridprojektion eller pil og kan ikke bruges på en nabotime eller i historikken. Slutrevisionen skal vise præcis én kilde pr. celle, ingen overlap og ingen missing i alle 79.414 positioner. De eksisterende land-/vandpunkter og kystnormaler ændres ikke. Target−48..target−1 forbliver rådgivende historik med verificerede, faktisk hentede kildefelter uden syntese; Copernicus-felter er ikke målinger. Ufuldstændig historik fjerner ikke den komplette forecastvisning.

Den private state-6-runtime flytter ikke den tunge vejrcache til Supabase. Preflighten bygger og komprimerer den samme runtime som produktionen, måler kun sikre størrelser og sletter den private midlertidige bundle. Denne dry-run er kun en inkrementel størrelsesgate. Kapacitetsberegningen bruger 60 fulde builds om dagen over 31 dage, to objektlæsninger ved normal produktion, tre på rollbackvejen og mindst 30 procent ubrugt reserve. Den faktiske live egress og øvrige trafik måles før og efter den kontrollerede produktion; ukendt eller for lille reserve stopper modelskiftet.

Ved `HISTORY_INCOMPLETE` viser RavRadar fortsat hele current- og femdøgnsprognosen med den konservative nedre score, øvre grænse, dækning og en tydelig DA/DE/EN-advarsel. Advarslen forsvinder automatisk ved `FULL_HISTORY`. Scoren er altid `calibrationEligible=false`, mens historikken er ufuldstændig. Der gættes ikke, og historik interpoleres, bæres frem eller lånes ikke fra naboer. Feggesunds faste wave-only proxy er en operationel bølgetuple, ikke historik.

Kalibreringslåsen følger samme status hele vejen gennem controller, aktivering, abort, rollback, reconciliation, central hydrering, admin samt ture og observationer. Den kan først blive `true`, når en forseglet og hashbundet offentlig audit beviser 210/673, privacykontrakten og `FULL_HISTORY` for alle aktuelle modes. Tid, første aktivering eller en gammel serverlabel er ikke nok.

Candidate G opbygges samtidig kun privat fra målte fortsættelser. Den private runtime har præcis én Candidate G-rod: enten 673/673 `READY` rollbackruntime eller `BUILDING_MEASURED_ONLY` med evidenspolicy `MEASURED_ONLY`, komplet 673-delsdækning og `activationReady=false`. Warmup er hverken offentlig model, shadow, controllerstatus, automatisk fallback eller rollbackbevis. Manuel Candidate G-rollback er først mulig, når den private runtime reelt er 673/673 `READY`.

Det eksisterende atomiske checkpointschema 4 med `candidate-g-rollback-ready-companion` ændres ikke og må kun bygges, gemmes og publiceres ved READY. Under measured warmup skal hvert af de tre checkpointtrin i stedet være eksplicit og hashbundet `NOT_APPLICABLE_DURING_MEASURED_WARMUP`; et tilfældigt skipped trin eller et ghost proof stopper. Det er dokumentation for, at checkpointet ikke gælder endnu — ikke et skjult readinessbevis.

Hvis RavRadar efter aktivering mangler privat integreret state, kan samme model genstarte fra faktisk målte data og fortsat vise `HISTORY_INCOMPLETE`. Denne state-less recovery er kun tilladt, når runtime/checkpoint faktisk er fraværende eller legitimt udløbet. En tilstedeværende ugyldig eller manipuleret integreret state er fatal og må aldrig behandles som fravær; Candidate G-only state er heller ikke samme-model recovery.

Ingen cold-replay- eller warmupvej må skabe syntetisk historik, interpolation, carry, neutral nulstrøm eller nabolån. Den historiske 40-timers sammenhængende WAM-bro og dens snævre same-run-regel tilhører kun Candidate G-migrationen. Feggesund-undtagelsen gælder alene den konkrete forecasttimes bølgetuple og må aldrig bruges som history/recovery-backfill, current eller statefremskyndelse.
...
PR #242 bestod den fulde GitHub-kildekontrol og blev merged som `29f39cce`. Den næste produktion nåede for første gang gennem Candidate G-attesteringen og videre til DMI/WAM, men stoppede før den offentlige side blev bygget eller udgivet. Årsagen var en privat, endnu ikke aktiv punktkandidat, som blev kørt efter et mislykket DMI-forsøg og dermed kunne afbryde lagringen af det allerede hentede arbejde. Rettelsen lader kun kandidaten køre efter et vellykket DMI-resultat og lader den ikke blokere den offentlige drift. Delvist, reelt DMI/WAM-arbejde gemmes efter alle ikke-annullerede forsøg. Den egentlige WAM-kontrol er stadig streng; hvis den stopper igen, viser workflowet nu kun en kort, sikker fejlkode uden private vejrdata, koordinater eller rå strømvektorer. Candidate G er fortsat offentlig, indtil hele modelskiftet er grønt.

RavRadar kører fortsat Candidate G/4.0.316 offentligt og 0/210 aktiv på grund af sit gamle komplette historikvindue. PR #241 bestod exact-head `33397737159` og blev merged som `a1ce7632`. Den friske produktion `33400836760` passerede den tidligere Højbjerg/bearing-gate, men stoppede derefter sikkert i legacy-kildeattesteringen, før DMI, beskyttede writes, artifact eller Pages. Fejlen var en forældet attestationsfixture med 11 profilfelter; den fastlåste 4.0.316-producent og den aktive offentlige Candidate G-manifestform bruger 20. Den lokale rettelse validerer nu den fulde profil, dens advarsler og bit-for-bit samme profil i manifest og conditions. Den privacy-sikre offentlige source-verifikation, inklusive payload-digests og den fastlåste 53-fils implementation closure, er grøn. Ingen geometri, land-/vandpunkter eller private vejrdata er ændret. 4.0.319/state 6 er endnu ikke offentlig; ny exact-head, merge, frisk produktion og offentlig desktop-/mobilkontrol udestår.

Når kodehovedet flytter sig fra H0 til H1, kan RavRadar vedligeholde den aktive Candidate- eller integrerede model gennem en særskilt, forseglet historisk bro. Kilden, målprofilen, 11-feltsbindingen, manifestet, implementation closure og planen skal passe bit for bit. Først skrives en ventetilstand; efter den eksakte nye side er verificeret, skifter controller og central profil atomisk. Hvis Pages beviseligt aldrig modtog anmodningen, kan den eksakte gamle kilde gendannes. Hvis det er tvetydigt, genudgives i stedet de allerede forseglede målbytes, og en anden jobdel verificerer og afslutter skiftet. Ukendt/tredje hash, blandet observation, ændret plan eller gammel CAS stopper uden modelskift. Almindelig vedligehold kan fortsat kun beholde samme aktuelle modelidentitet.

Den integrerede model skal vise hele current- og femdøgnsprognosen over 118 timer, når den konkrete times strøm-, bølge- og søgeinput er gyldige, også hvis ældre historik mangler. Scoren vises da konservativt med et interval og en tydelig advarsel, som forsvinder automatisk, når historikken er komplet. Hvis et direkte input mangler, er netop den time utilgængelig; RavRadar må ikke gætte, interpolere eller låne fra en nabozone. Spørg RavRadar skal forklare forskellen. Den offentlige tekst skal også forklare enkelt, at nyere bølgeenergi vejer mest, at vægten halveres over fire timer, og at sidste-mile-leddet højst kan dæmpe det allerede eksisterende leveringssignal 15 %. Brugeren skal ikke kende modellens interne forkortelser. De målrettede assistent-/teksttests er lokalt grønne; exact-head-, produktions- og offentlig browserverifikation er stadig åben.

Controlleren har fortsat fire statusser, seks overgangstyper og præcis 30 felter. De historiske broer er ikke nye offentlige modeller, ikke relabeling og ikke syntetisk historik. Geometri, land-/vandpunkter, koordinater og rå strømvektorer ændres ikke eller offentliggøres ikke.

Den endelige integrerede 4.0.320-binding er `a226e7d10f5c9fa94e122c0e4e3dc1367f1d5e44e763593e4568ac8a3ed1b14b`/`3192db304a6e613059cd66d1ae983583c3aaff832293bda978cdc03991bb49c3` over 44 transitive filer og otte deklarerede forbrugere. Candidate G-rollbackbindingen er særskilt `c73dac1b4376005e792580791d84eb79c9370e905a2a7fd0bdee857506a20cf8`/`7c7f2b4950b4ce7a04d560dde15dd93e408e045ca5e9ed4f9be33eac0255e89d` over 56 filer. Exact-head `33577887262` fandt, at Candidate G's tilsigtede `FULL_HISTORY` med `calibrationEligible=false` blev afvist af den nye integrerede calibration-ceiling. Den symmetriske rettelse i fem validatorer samt rollback public-stage 210/673, Candidate-assistent, integrerede public consumers og Edge er lokalt grønne; ny exact-head, slutlig 118-timers evidens, merge, frisk fuld produktion og offentlig browserkontrol afventer. Det aktive 15-minutters kontroljob skal diagnosticere run, gates, deploy og live side før en sikker reparation; det må ikke blindt starte en ny produktion eller oprette en ekstra scheduler eller vagthund.

Det efterfølgende automatiske run `33354263148` publicerede `rr-20260831034128-210` komplet 210/673 uden syntetiske samples.

Normal produktion `33345476979` publicerede `rr-20260831010337-210`, og det tidligere external-watchdog-run `33347230240` publicerede `rr-20260831012407-210`; begge var komplette 210/673, `VERIFIED_ONLY` og med `syntheticSampleCount=0`.
...
Ejeren har samtidig truffet en bindende beslutning for den kommende samlede RavScore-model. Hvis historikken er ufuldstændig, men den konkrete times direkte input er gyldige, skal hele current- og femdøgnsfladen fortsat have en konservativ nedre score med en medfølgende øvre grænse og en tydelig advarsel på dansk, tysk og engelsk. Advarslen står ved score, detaljer, femdøgnsvisning, admin og ekspert og forsvinder automatisk, når historikken igen er komplet. Sådanne resultater er altid `calibrationEligible=false`. Mangler de direkte input, er timen derimod utilgængelig. Dette er implementeret i den lokale state-6-modelkandidat, ikke i Candidate G.

Modelleverancen reducerer lokalt tre systemiske risici: produktionen er opdelt i eksplicitte orchestrator/build/deploy-roller, alle 40 direkte workflowreaders er migreret, terminalstatus er maskinlæsbar og fail-closed, og releasekontraktmetadata er samlet centralt. De role-aware kontrakttests er grønne; exact-head- og produktionsbevis mangler stadig. Den separate forbedring, hvor `validate:source` efter cutover skal samle flere uafhængige testfejl i én kørsel, forbliver en åben P2.

Offentlig 4.0.316 er observeret friskt som datasæt `rr-20260830091913-210` med 210 zoner og 673 kystdele. Candidate G havde dog 0 aktive zoner og 210 `UNAVAILABLE`, fordi den sammenhængende strømhistorik var utilstrækkelig. Det er bevis for den gamle all-or-nothing-regression, ikke for den lokale state-6-model. Se DEC-0112.
...
Da hændelsen blev opdaget, var den offentlige primary mere end otte timer gammel, og den komplette målte recovery var ældre end sin absolutte 72-timersgrænse. RavRadar viste derfor korrekt **“Aktuelle data kunne ikke hentes. Gamle data vises ikke.”** Det var ærligt fail-closed, men det betød også, at brugerne ingen aktuelle eller femdøgnsprognoser kunne se.

Ingen syntetiske eller interpolerede Candidate G-data blev nogensinde anvendt. De historiske read-only inspect-kørsler stoppede før descriptor, apply og mutation. 4.0.315 pensionerer nu operationsinput og -jobs, aktuator, admin-descriptor, rollback/cleanupflade og apply+Pages-attestationen. Det eksisterende historical exact-D1-job bevares for 4.0.311–4.0.314, men 4.0.315 går eksplicit videre med `ready=true` og kan ikke blokeres af rekonstruktionsbevis.

Normal produktion er fortsat udelukkende målt. Manglende historik forbliver manglende og udfyldes ikke. De normale measured-only gap-checkpoints, continuation og senest-komplette recovery bevares under deres eksisterende integritets-, 210/673-, forecast- og aldersgrænser. Defensive trust-, schema- og turkvalitetslæsere bevares også, så ukendt eller historisk markeret evidens fortsat afvises eller klassificeres fail-closed; de kan ikke skabe rekonstrueret state.
...
Candidate G er fortsat den eneste offentlige model. 4.0.333 bestod exact-head-kildegaten og blev merged. Main-oneoff `34161930631` genbrugte cachen og lukkede currentlaget med 79.414/79.414, men stoppede sikkert på Feggesunds WAM-dækning før artifact, deploy og modelskift. 4.0.334's WAM-readiness-, scheduler- og runbundne handoffrettelser er lokalt måltestet og uafhængigt reviewet; exact-head CI, merge, Feggesund 3 × 118, live Supabase-kapacitetsbevis, fuld produktion og offentlig mobil-/desktopkontrol mangler fortsat. State 6 er derfor ikke offentlig. Schema 5 var en aldrig-offentlig kandidat og er kun en eksakt 5→6-migrationskilde.
...
Det offentlige Candidate G-register og det aktuelle aktive register holdes adskilt: kilden beviser de gamle stateKeys, mens den centralt materialiserede aktuelle konfiguration ejer ny produktion. Det flytter ikke geometri, land-/vandpunkter eller kystnormal. Target føres som én kanonisk UTC-time uden parserforskel mellem Node og Python. Ugyldig, manipuleret, reconstructed, fremtidig eller uattesteret state stopper før DMI og før enhver ændring. Genuine cold start må heller ikke maskere, at en tidligere integreret continuation eller et checkpoint allerede er blevet afvist som ugyldigt.

Releasekandidaten bevarer 20/50/30, 0,03/0,15 m/s, +10/-8, 24/48-timers strømhukommelse og 4/48-timers bølgemobilisering. Det sidste nærkystled bruger en kausal energivægtet bølgeapproach med fire timers halveringstid og en ældre hale. DMI-WAM `FROM` roteres én gang +180° til `TOWARD` mod den uændrede kystnormal, og `factor=clamp(1-0.15×W×(1-approach),0.85,1)` dæmper eksisterende supply præcis én gang. Bølger skaber eller øger aldrig supply; højst 7,5 rå totalscorepoint kan fjernes før slutafrunding; vist RavScore kan derfor ændres 8 point. Aktiv retningsmissing fejler lukket. Kun `waveHeightM=0` er eksakt calm og neutral; `wavePeriodS` skal stadig være finit og ikke-negativ. `waveHeightM>0` med `wavePeriodS=0` er `INVALID` og fejler lukket.

Den fysiske levering er fortsat uopløst: `physicalDeliveryResolved=false` og fysisk interval `null`. DDM 2024/v2 er et 50 × 50 m statisk middelgrid med dybde/kilde/opmålingsår, moderne søopmåling og også lavtvandsdata fra satellit/lidar. Det er ikke fravalgt for mangel på lavtvandsdata, men fordi utilstrækkeligt dækkede celler interpoleres, kystlinjen er generaliseret 1:100.000, og produktet ikke opløser dynamiske revler, ripkanaler eller en bølgeopløst surfzone. Det kan være kontekst, men er ikke scoreinput. Rainville 2026 er kun buoyant-object-analogi, og der påstås ingen empirisk højere fundpræcision. Ingen geometri, kystnormal eller land-/vandpunkter flyttes.

Ved ægte cold start bruger `bounded-private-48h-history-cold-replay-v3` de 0–48 private, verificerede timer, der faktisk findes, plus den reelle targettime og registrerer forventede, komplette og ukendte kausale positioner. Scoren er `HISTORY_INCOMPLETE` med konservative bounds — også efter 48/48 og markøren `VERIFIED_CAUSAL_HISTORY_WINDOW`, fordi bølgemobiliseringens ukendte hale først lukkes efter 288 timers kausal recovery. Kortere/gappede forløb mærkes `UNKNOWN_HISTORY_INTERVAL`. Først closure eller en attestert migration/continuation giver `FULL_HISTORY`. Candidate G bruger samme target uden dobbelt recovery-credit og fortsætter eksklusivt fra sit eget faktiske målte replay som privat `BUILDING_MEASURED_ONLY`; den må ikke blandes med en tidligere continuation eller integreret state. Denne warmup blokerer ikke integrated-first-cutoveret, men checkpointtrinene er eksplicit `NOT_APPLICABLE_DURING_MEASURED_WARMUP`, og manuel Candidate G-rollback forbliver låst. Under manuel rollback kan kun en eksakt 673/673 `READY`/`memoryReady` Candidate G-runtime projicere sin egen mode-score som exact full-history med collapsed bounds og 48 timers coverage; non-READY/mismatch stopper rollback, og `calibrationEligible=false` består. Samme-model nøddrift må kun bruge en komplet, atomisk og hashbundet continuation i højst 72 timer eller kortere forecastudløb. Hvis privat integreret state faktisk er fraværende eller legitimt udløbet, må state-less same-model recovery genstarte fra målte data som `HISTORY_INCOMPLETE`; en tilstedeværende ugyldig/manipuleret state er fatal. Derfor gælder: cross-model fallback og interpolation er forbudt.

WAM-bootstrap checkpointes løbende. En eksisterende progressiv DMI-/WAM-cache bevares efter både producersucces og en reel producerfejl, men ikke efter cancellation; næste forsøg skal stadig bestå samtlige run-, grid-, celle-, target-, horisont-, provenance- og releasegates. Push, planlagte, watchdog-/botudløste og manuelle vejrjobs må fortsat vedligeholde den offentlige Candidate G, mens first cutover afventer. Fra en rowless exact legacyprofil vælger de `candidate-legacy-maintenance` og `LEGACY_CANDIDATE_G_REFRESH_BEFORE_INITIAL_CUTOVER`; `legacy-refresh-begin` skriver `CANDIDATE_G_PENDING` med active/source legacy og requested current Candidate, mens legacyprofilen består. `legacy-refresh-complete` eller target-reconcile kræver exact offentlig implementation+210/673, sætter kun current Candidate aktiv/profil, bevarer `initialCutoverRequired=true` og sætter `legacySourceRequired=false`; `legacy-refresh-abort` eller source-reconcile bevarer legacy public/profile og `legacySourceRequired=true`. Legacy-markøren består efter complete gennem senere Candidate→Candidate pre-cutover maintenance med exact current Candidate og fire `null`-returnfelter. Den må kun arves fra valid lineage, aldrig opstå ved relabel; `legacySourceRequired` følger den faktiske sourcebinding og er derfor false under current Candidate trods markerens navn. Den separate `CANDIDATE_G_REFRESH_BEFORE_INITIAL_CUTOVER` bruges efter et sikkert afbrudt integreret first-cutover-forsøg og bevarer `returnPlanSha256`, `integratedReadinessSha256`, `integratedPublicAuditSha256` og `integratedManifestSha256`. Ingen vedligehold må skrive `INTEGRATED_PENDING`, aktivere state 6 eller skabe historik. Kun den særskilte manuelle Fase B må forsøge selve modelskiftet, og en ny direkte rowless cutover må ikke oprettes. Controller-v4 binder source/requested implementation closure i sin præcis 30-feltskontrakt. Fejl bevarer den senest verificerede offentlige Candidate G-kilde; allerede forseglede planer bevares til recovery.

Feggesund/`DK-B05-11` har et vedvarende lokalt bølgehul. Den nye regel er direct-first: findes den komplette lokale DMI-WAM-tuple for en kystdel og time, bruges den altid. Kun når hele tupletten med signifikant bølgehøjde, periode og middelretning mangler, må de samtidige, komplette direkte DMI-tuples fra både `DK-B05-10` og `DK-B05-12` bruges. En delvis lokal tuple, kun én gyldig nabo eller forskellig time/run stopper som `MISSING`.

De to naboer vægtes 50/50 på en energikonsistent måde. Bølgehøjden beregnes som kvadratroden af middelværdien af `Hs²`; perioden og den cirkulære middelretning vægtes med `Hs²`. Retningen forbliver DMI's FROM-retning indtil modellens normale ene rotation. Uenighed klassificeres som `LOW`, `MODERATE` eller `HIGH` ud fra retning, energi og periode, og den værste af de tre bestemmer den viste usikkerhed.

Når en time faktisk bruger proxyen, viser RavRadar en tydelig advarsel på dansk, tysk eller engelsk om, at bølgerne er estimeret fra to samtidige naboområder, fordi lokal DMI-WAM mangler. Advarslen forsvinder automatisk ved direkte lokal input. Alle mode-/zone-/public-scorer, ture og observationer, som bygger på proxytimen, har `calibrationEligible=false` – også hvis historikken ellers er `FULL_HISTORY`. Direkte DMI-timer følger den normale historikregel.

Releasegaten kræver et privacy-sikkert bevis for alle tre dele × 118 timer: præcis 354 udfald som direkte, Feggesund-proxy eller missing; direkte + proxy skal være 354, og missing skal være 0. Der vises ikke koordinater, rå U/V eller private payloads. Proxyen er kun bølger og må aldrig låne strøm, skabe historik, fylde recovery ud eller flytte geometri, land-/vandpunkter eller kystnormal. Den er et forsigtigt ingeniørestimat, ikke en lokal surfzonemodel eller dokumentation for empirisk bedre fundpræcision.

[DMI WAM](https://www.dmi.dk/friedata/dokumentation/data/forecast-data-wave-model-wam) dokumenterer timeoutput, fire runs om dagen, cirka 5,5 døgn og et cirka 1 km `wam_dw`-grid, men ikke wave-current interaction eller varierende tide-/stormvandstand i bølgemodellen. [ECMWF](https://confluence.ecmwf.int/download/attachments/59774192/wave_parameters.pdf?version=1) knytter signifikant bølgehøjde til spektralmoment og energi til `Hs²`. [Copernicus Marine](https://help.marine.copernicus.eu/en/articles/6175153-how-to-describe-wave-height-period-and-direction-parameters) beskriver mean wave direction som en FROM-retning. Kilderne støtter matematikken og retningskonventionen, men ikke lokal rav- eller surfzonepræcision.

Ejeren opgav den planlagte fiktive rekonstruktion af morgenhullet efter de dokumenterede read-only stop og før descriptor, apply, mutation, artifact eller offentliggørelse. De operative GitHub-inputs/job, incidentpolicyen og mutatoren er fjernet, og en negativ gate forhindrer genåbning. Kun konservativ læsning og kvalitetsklassifikation af historiske markører består. DEC-0109 er historisk dokumentation; de følgende 4.0.311–4.0.314-afsnit er revisionsspor og ikke åbne udførelsesplaner.

Den målrettede syntetiske 210/673 inspect-/CAS-/rollback-/cleanup-/checkpointtest og workflowinterlock var grønne, inklusive sparse 2h-hourly, mixed 1/3-hourly, policy-ID-swap, ulovlig 3h/2h, nonintegral cadence og policyhash-CAS. Den daværende plan var proportionale source-/RDKS-/reviewgates, exact-head PR, merge/no-op, nyt exact-main D1 og en ny read-only inspect før et eventuelt descriptorbundet CAS-apply. Planen blev aldrig gennemført og er trukket tilbage af DEC-0111; der må ikke køres nyt inspect eller apply.
...
Den historiske 4.0.314-lås var designet til at forhindre, at releasen overhalede sin egen planlagte rekonstruktion: samme main-commit skulle først have bestået D1, hvorefter inspect skulle have forseglet planen og et apply skulle have brugt den eksakte descriptor. Det uopfyldelige apply+Pages-krav gjorde senere normale produktioner til grønne no-ops. DEC-0111 pensionerede kravet før operationen blev anvendt; normal 4.0.315-produktion må ikke vente på inspect/apply-bevis.
...
Den sikre GitHub-status viste kun exit 1. RavRadar hentede ikke hele jobloggen eller kilderne for at finde årsagen. Diagnostikhotfixet gjorde i stedet kun faste `ONE_TIME_GAP_*`-fejlkoder synlige og skjulte enhver anden fejltekst. En tænkt vellykket inspect skulle kun have vist descriptorens SHA og fire faste, ikke-følsomme optællinger, så et efterfølgende apply kunne bindes uden joblog. PR #230's første kildekontrol fandt en ren testmiljøfejl; testharnessen isolerede normal og Actions-tilstand og bestod hele 210/673-forløbet i begge miljøer. Den daværende plan krævede et nyt final-SHA-D1 og inspect før CAS-apply. DEC-0111 trak planen tilbage før descriptor/apply; intet nyt D1, inspect eller apply må køres for rekonstruktionen. Candidate G's formel, 20/50/30, model-id, measured-only drift, trust og nødvisning er uændrede.
...
Den aldrig anvendte plan foreskrev, at et apply kun skulle have været manuelt på en eksakt descriptor og et uændret hydreret mål, med privat rollback før første mutation og kausal cleanup som senere sikkerhedsvej. Ingen descriptor, mutation eller syntetisk state blev skabt. DEC-0111 trak operationen tilbage; apply, rollback og cleanup må ikke udføres. De defensive cache- og trustkontrakter består, men kan ikke skabe rekonstrueret state.
...
Backendudgivelsen sker på samme eksakte main-head som Pages. Efter kapacitetskontrol og main-kontrol registrerer RavRadar umiddelbart før første Edge-deploy, om installationen allerede bruger D1 eller er helt ny. Eksisterende D1 får nye Edge-funktioner under uændret mode/gammel Worker, derefter en 20-minutters maintenance-lease; mere end 30 minutter afvises, og udløb genåbner D1. Hver Edge-probe stopper efter fem sekunder. Efter dobbelt kontrol og 20-sekunders drain skal mindst ti minutter restere, før secret, Worker-deploy og health køres som én højst syv minutter lang gate. Fejler første Edge-deploy delvist på eksisterende D1, repareres kun fremad i D1. På en helt ny installation genbekræftes main, Supabase-secret genindsættes, Edge deployes eksakt igen og begge grænser kontrolleres dobbelt i Supabase. Fejl før intent ændrer intet recovery-state. Kilden er merged, men den seneste backendkørsel er rød og er derfor endnu ikke et live readinessbevis.

4.0.311-kilden på PR #224-head `4c4699fe` bestod exact-head CI `33263734108` og blev merged som `7c168b00`. Pushkørslen `33263858078` var korrekt grøn no-op uden artifact eller Pages. Backendkørslen `33263892151` modtog HTTP 201 for den atomiske CHECK-transaktion og stoppede derefter i den read-only katalogverifikation, fordi en flad regex ikke accepterede PostgreSQLs semantisk ækvivalente venstreparentesering. Transaktionen har ingen row writes og kan kun være fuldt committed med valideret constraint og comment eller fuldt rullet tilbage; ingen halv constrainttilstand er mulig. Stoppet skete før D1, Edge, Worker, sync, vejr, artifact og Pages.
...
Der findes ingen ekstra offentlig shadowmodel. Hvis 4.0.334 består det samlede DEC-0110/DEC-0112-cutover, bliver `RRS-COASTAL-PROCESS-INTEGRATED-1.1.0`/state `6.0.0` den eneste offentlige model, mens Candidate G kun ligger privat som migrations-/offline-/rollback-orakel. Kandidaten mangler exact-head for den aktuelle release, Feggesund 354/354, live Supabase-bevis, fuld produktion og offentlig desktop-/mobilkontrol. Kun en senere særskilt, manuel og fuldt verificeret hel rollback kan gøre Candidate G til den ene offentlige model igen; den er aldrig en samtidig eller automatisk fallback. Denne lokale dokumentation er ikke i sig selv et produktionsbevis.
...
Ejeren har godkendt offentlig aktivering i 4.0.291. Cloudflare-kontoen er Workers Free / $0 med 10.000 neuroner pr. døgn og fejl efter loftet; betalt overflow er forbudt. Assistentdialogen fortæller på dansk, tysk og engelsk, at den daglige AI-kvote er begrænset for at holde RavRadar gratis, og at kvoten kun gælder Spørg RavRadar uden indflydelse på kort, prognoser, RavScore eller øvrige funktioner. `ravAssistantRemoteEnabled=false` er fortsat den øjeblikkelige rollback. Candidate G 20/50/30, vejr, sortering, konto-/turdata, privatliv, geometri og land-/vandpunkter er uændrede. Se [DEC-0086](docs/rdks/10_DECISIONS/DEC-0086-CENTRAL-PUBLIC-I18N-FIRST-SLICE.md), [DEC-0087](docs/rdks/10_DECISIONS/DEC-0087-FREE-WORKERS-AI-PRODUCTION-CANDIDATES.md) og [DEC-0088](docs/rdks/10_DECISIONS/DEC-0088-PUBLIC-GPT-OSS-ASSISTANT-ACTIVATION.md).

## Årsagstro produktion og robust genopretning – 4.0.289

> **Historisk revisionsspor:** Dette afsnit beskriver Candidate G-driften i 4.0.289–4.0.306. Den aktive integrerede kontrakt står i kapitel 54–56 og DEC-0110; versionsafsnittets daværende 13-timersregel er ikke aktiv efter cutover.

> **Driftspræcisering i 4.0.306:** Candidate G er fortsat den eneste offentlige model. En afbrudt udviklingskørsel efterlod et nyere schema-3-checkpoint, mens den offentlige runtime fortsat var Candidate G/schema 2. Restoren genkender kun denne ene eksakte modelkontekst med samme `stateKey` for alle kystdele. Den genbruger signerede strømevidens og den uændrede mobilisering, men rekonstruerer Candidate G's egne +10/-8-/13-timerstal før filskrivning; den kopierer aldrig vejr, score, rå U/V, koordinater eller private data. Ukendt/blandet kontekst eller en tidsregression ændrer intet. Se DEC-0104.
...
> **Historisk revisionsspor:** Afsnittet bevarer 4.0.286's Candidate G-kontrakt. Den aktive integrerede state-6-recovery og private cold-start-bro står i kapitel 55 og DEC-0110/DEC-0112.
...
Rav-assistenten bruger fortsat den lokale Candidate G-beregning til bedste sted, bedste tidspunkt og konkret score. Den historiske deaktivering fra 4.0.284 er erstattet af den ejer-godkendte 4.0.291-aktivering. Kun det lille dokumenterede offentlige kontekstobjekt må sendes; alle fejl falder tilbage lokalt.
...
Fra 4.0.320 kan RavRadar installeres som en webapp på telefonens hjemmeskærm med egne ikoner og åbning i et selvstændigt vindue. Den eksisterende **Om RavRadar**-side viser trin for trin iPhone/Safari og Android/Chrome på dansk, tysk og engelsk. Installationen starter på den fælles forside, tilføjer ingen tvungen popup og ændrer ikke kravet om internetforbindelse til friske prognoser.
...
## Historisk 4.0.274: Candidate G-only og lokal scoretilgængelighed
...
- Overfladestrøm, vind og den verificerede modelgridstrøm holdes adskilt. Det dybeste tilgængelige modelgridlag er ikke en måling af lokal bundnær strøm, undertow eller ripcirkulation.
...
- En irrelevant myteboks er fjernet, og afsnittet om fralandsvind skelner nu tydeligt mellem vindens virkning på overfladen og den kystnormale modelgridstrøms transportbevis.
...
Ekspertens arbejdsplan, kodekapitel, scenarier og hypoteseregister beskrev den daværende aktive Candidate G med 20/50/30, 48 timers transportvindue, +10/-8-forløbet, 13-timersreglen, waderskurven 6–15 m/s og én bølgeenergistyret mobiliseringstilstand. Gamle 25/40/35-regler var historik; DEC-0072 havde fjernet dem som offentlig rollback. Versionsværktøjet synkroniserer hele webhåndbogen til Supabase-installationsfilen og stopper, hvis kopierne afviger.
...
> **Historisk revisionsspor:** Dette afsnit dokumenterer den offentlige 4.0.269-leverance. Candidate G var den daværende model. Den aktive integrerede kontrakt står i kapitel 54–56; vandstand giver ingen direkte score og kan ikke i sig selv fastslå den lokale sidste-mil-retning.
...
Candidate G var den daværende aktive model med **20 % søgeforhold, 50 % transport mod kysten og 30 % rav i bevægelse**. Afsnittets tidligere globale 25/40/35-reserve var erstattet af DEC-0072: et datahul gjorde kun den konkrete Candidate G-score utilgængelig. 4.0.269 ændrede ingen scoretal, vejrkilder, Supabase-kontrakt, geometri eller land-/vandpunkter. Se DEC-0068 og `docs/research/PUBLIC_SCORE_EXPLANATION_REVIEW_4.0.269.md`.
...
> **Historisk revisionsspor:** Dette afsnit bevarer 4.0.268's daværende Candidate G-forklaring. Grundbogens aktive modeltekst følger nu den integrerede kontrakt i kapitel 54 og har ingen 13-timers helscore-gate.
...
Candidate G blev forklaret til sidst med den daværende aktive vægtning **20 % søgeforhold, 50 % transport og 30 % rav i bevægelse**. Waders var bedst under 6 m/s og faldt til 0 ved 15 m/s. Kraftig udtransport trak transporten ned fra første time og gav nul efter 13 timer. Disse tal var RavRadars testede arbejdsregler, ikke universelle naturgrænser.
...
Efterregistreringen gemmes som én almindelig logisk turpost i det aktive turlager. Den samme post vises i **Mine ture og fund**. Der oprettes ingen særskilt fundpost eller normal dobbeltkopi, og brugeren møder ikke tekniske databaseforklaringer i turloggen. Supabase-tabellen er migrationskilde; dens historiske post-cutover rollbackrolle fra 4.0.287 er afløst af den mergede 4.0.311-kildes énvejs D1-/roll-forward-kontrakt, som 4.0.313 fører frem med strengt afgrænset, no-mutation legacy-genafspilning.
...
## Historisk 4.0.263: Candidate G bruger den aktuelle fælles zonereference
...
## Historisk Candidate G-princip: fast transportvindue uden maskinstart
...
## Historisk 4.0.260: Candidate G's score-neutrale omskifterforberedelse
...
## Historisk 4.0.259: Candidate G føres gennem den centrale pipeline
...
## Historisk Candidate G: strømstyret transporthukommelse
...
## Historisk 4.0.258: Candidate G bruger vindstyret waders-jagtbarhed
...
Rapporten kan ikke ændre produktionen. Gammel mod nuværende måles på de virkelige offentlige scoreposter. A-C afprøves først på et bredt scenariegitter, fordi den offentlige post ikke indeholder hele den rå hændelseshistorik. Før en kandidat kan aktiveres, kræves en særskilt beslutning, fulde regressioner, frisk produktion og relevant browserkontrol.
...
Fra 4.0.236 følger den eksakte time, som readiness-gaten godkendte, med gennem hele den planlagte produktion. Copernicus-fletning, RavScore, beskrivelser og runtime bygges dermed ud fra én sammenhængende time, også når jobbet krydser et timeskifte. Push og bevidst manuel release uden en planlagt readiness-time bruger fortsat den aktuelle tid.

Datasættets eget byggetidspunkt og ID følger stadig den virkelige kørselstid. Den godkendte faglige referencetime gemmes særskilt, så fire kvarterskørsler i samme UTC-time ikke får samme identitet eller fremstår kunstigt gamle.
...
Den tidligere generiske kommando `npm run hydrate:deployed-weather` er pensioneret. En fuld frisk runtime skal komme gennem produktionsworkflowets centrale adminhydrering, private runtime-/checkpointkontrol og nye vejrbygning. Kun første kontrollerede skift fra Candidate G har en eksplicit legacy-bootstrap; den må aldrig bruges som almindelig genvej omkring en dækningsfejl.
...
Det blå vandpunkt er samplinganker for både den viste strømpil og den strøm, som den aktive score må bruge. RavRadar prøver først den nærmeste DMI-vandkolonne med et komplet U/V-par og vælger derefter det dybeste gyldige lag i præcis den kolonne. Op til 3 km foretrækkes, 3–5 km kan accepteres, og over 5 km går kæden videre til de godkendte supplementer. Baltic og AMM15 må højst ligge 5 km væk; de otte udtrykkeligt godkendte Limfjordsproxyer og DEC-0115's sidste Open-Meteo-reserve må ligge op til 15 km væk. Open-Meteo kræver komplet samme-celle speed/direction efter fuldt READY fra de tidligere kilder, gælder kun target..+117, bruges alene som combined-surface-current og er aldrig kalibreringsegnet. Gamle cacher, direkte ForecastEDR-strøm uden fælles kolonne- og lagbevis og andre ikke-godkendte fallbacks lukkes fortsat ude.
...
RavRadar er et beslutningsstøttesystem til ravjagt langs danske kyster. Systemet samler prognoser, lokale kystdata og den forklarlige integrerede RavScore-model. Det skal hjælpe med at vælge sted og tidspunkt, men må aldrig fremstille en høj score som et løfte eller en procentchance for fund. Ekspertviden kan føre til nye hypoteser og senere scoreændringer, men først efter en versionsstyret ændring af den autoritative kode, målrettede tests og den fulde releasekæde.
...
RavRadar bruger fire evidensklasser. De skal fremgå af håndbogen og af beslutningsgrundlaget, når en faglig påstand undersøges som mulig scorelogik.
...
Ekspertobservation | Gentagen praktisk erfaring fra kendt område og jagtform | Lokal prioritering og testhypotese | Automatisk landsdækkende scoreændring
RavRadar-hypotese | Plausibel mekanisme eller arbejdsværdi | Simulering, scenarietest og audit | Skjult produktionslogik uden markering
...
Når ekspertens udsagn strider mod den nuværende kode, skal udsagnet registreres som en ændringshypotese. Først når mekanisme, geografi, betingelser, forventet effekt og test er beskrevet, kan det omsættes til en versionsstyret ændring af den aktive model.
...
Baltisk rav omtales i den relevante kystlitteratur typisk med en materialedensitet omkring 1,05–1,10 g/cm³. Havvandets densitet varierer med saltholdighed og temperatur. Det betyder, at størstedelen er svagt negativt flydende: ravet synker, men den neddykkede vægt er langt mindre end for kvarts med densitet omkring 2,65 g/cm³. Den lille densitetsforskel kan gøre rav følsomt over for vertikale turbulensimpulser, bølgeorbitaler og kontakt med organisk materiale. Variation mellem stykker findes, men den gør ikke rav til en generel positivt flydende overfladetracer.
...
Implementeret i den aktive integrerede scorevej i `js/core/ravscore-integrated.js` og tilstandskæden i `js/core/ravscore-integrated-state-pipeline.js`. `js/core/coastal-process-model.js` er en særskilt historisk procesindikator og ændrer ikke den integrerede score. Der findes ingen partikelstørrelses-, synkehastigheds-, bundskærspændings- eller begravelsesmodel.
...
Den aktive integrerede RavScore har tre numeriske hovedkomponenter: søgeforhold, relativt transportbevis fra verificeret gridstrøm mod kystzonen og rav i bevægelse. Mobiliseringen er én sammenhængende bølgeenergistyret tilstand. RavRadar kender ikke det faktiske ravlager, og tilstedeværelse, koncentration, aflejring og retention er ikke selvstændige scorekomponenter.

Modelkritik: En vægtet sum kan være over nul, selv om det relative transportbevis står på nul. Det er bevidst: nul i dette led betyder, at det rullende strømforløb ikke dokumenterer kystvendt tilførsel, ikke at alt rav er bevist fjernet. Scoren skal derfor læses sammen med delscorerne og den faste usikkerhedsmarkering; den er hverken en fundchance eller bevis for fuld proceskæde.
...
I den historiske 25/40/35-frigivelsesscore gav maksimal bølgehøjde mindst 1,5 m +14 point. En separat forskningsindikator brugte grænserne 1,2 og 2,0 m. De tal er ikke den aktive kontrakt. Den integrerede model bruger i stedet bølgehøjde og periode i energi-proxyen `Hs² × T` og én mobiliseringstilstand, der bygges op med cirka fire timers halveringstid og aftager med cirka 48 timers halveringstid.
...
Det er bevidst, at bølgehøjden optræder to steder, men rollerne må ikke blandes. `Hs² × T` bygger over tid et fysisk mobiliseringssignal for allerede tilgængeligt rav i 30 %-leddet. Den aktuelle bølgehøjde i søgeforhold beskriver i stedet, hvor let metoden er at udføre: især om krusninger og sø gør det sværere at se ved waders, mens strand bruger sin bevarede søgekurve. Søgevejen kan ikke bygge mobilisering eller give transport-/sidste-mile-point. En ru sø kan derfor både sætte materiale i bevægelse og gøre det sværere at finde; det er to forskellige følger, ikke samme positive bølgebidrag talt to gange.
...
Evidens: Generel bølge- og sedimentfysik er veletableret. Modellens fire/48-timers forløb og energi-kurve er testede arbejdsregler, ikke fundkalibrerede naturgrænser.


## 7. Modelgridstrøm: retning, styrke og transportbevis
...
Strømmen projiceres vinkelret på den lokale kyststrækning. Positiv kystnormal gridstrøm er indgående, negativ er udgående, og næsten parallel strøm giver kun en lille komponent. 0,03 m/s er dødzone, og 0,15 m/s tæller som fuld styrke. Grænserne er produkt- og forskningspriorer, ikke naturkonstanter.

Fuld indgående strøm giver +10 point pr. effektiv time, og fuld udgående strøm giver -8 fra første effektive time. De seneste 24 timer vægtes fuldt; ældre evidens dæmpes glat til nul ved 48 timer. Forløbet genafspilles fra en fast nulrand og kan nå nul efter et længere udgående forløb. Den gamle 13-timersregel, som nulstillede hele RavScore, er fjernet. Et transportled på nul betyder manglende positivt gridstrømsbevis i vinduet, ikke dokumenteret tømning af kystens ravlager.

Modeldata repræsenterer en verificeret strøm i en modelgridcelle og må ikke kaldes surfzonens undertow, feederstrøm, langskyststrøm eller ripstrøm. Lodret shear, bølgestrøm, revler, render og lokale hvirvler kan afvige væsentligt. Releasekandidaten lader derfor kun den kausale energivægtede bølgeapproach med fire timers halveringstid og en ældre hale dæmpe det eksisterende supply én gang med højst 15 %; den fysiske sidste levering forbliver eksplicit uopløst.

Ekspertpunkt E-04: Vurder dødzone, fuld styrke, +10/-8 pr. effektiv time og 24/48-timers aldersvægten ved forskellige kysttyper.
...
Implementeret i: `js/core/direction-anchors.js`, `js/core/ravscore-current-supply-memory.js`, `js/core/ravscore-integrated-state-pipeline.js` og `js/core/ravscore-integrated.js`.
...
Den integrerede model giver ikke vindretningen direkte transportpoint og giver heller ikke vind direkte mobiliseringspoint. Gridstrømmen står for det relative transportbevis, mens vindens fysiske virkning på mobilisering kommer gennem de modellerede bølger.
...
Den integrerede model viser vandstand og ændring som nyttig kontekst uden at lægge den ind i 20/50/30-regnestykket. `waterLevelTrendCm3h` er den fremadrettede modelændring fra den viste time til tre timer senere, aldrig en observeret ebbe, flod eller tidevandsfase. Stigende vand kan flytte den aktive kystzone og i nogle forløb føre allerede indgående materiale længere ind, men det beviser ikke indtransport. Faldende vand bestemmer heller ikke strømretningen; det kan falde sammen med verificeret søværts gridstrøm og dermed med en mulig søværts transportvej for noget mobilt rav. Lavere vand kan samtidig blotlægge rav, som allerede er afleveret eller fastholdt på land- eller læsiden af revler, så et mindre område bliver lettere at afsøge end hele havbunden. Det er en søgbarhedsfordel og ikke bevis for, at vandstandsfaldet fysisk har koncentreret ravet. Uden lokal batymetri, revlegeometri og en bølgeopløst surfzonemodel kan RavRadar ikke afgøre, hvilken virkning der dominerer på den enkelte kystdel.

RavRadar laver ikke en ekstra “hele vandsøjlen”-strøm ud fra vandstandens trend og interpolerer den ikke med gridstrømmen. DMI's DKSS beregner et tredimensionalt fysisk havfelt med atmosfærisk forcing og tidevands-sealevel ved åbne rande og leverer selv current-U/V. Copernicus Baltic NEMO leverer tilsvarende fysiske hastighedsfelter, også som særskilte øjeblikkelige og detidede produkter. Modelstrømmen er derfor et samlet modeludfald, ikke bevis for hver lokal proces eller for ens retning i hele vandsøjlen. En ekstra vandstandsregel kunne dobbeltregne korreleret dynamik og ville stadig ikke fortælle fortegnet i surfzonen. Se [DMI's DKSS-dokumentation](https://www.dmi.dk/friedata/dokumentation/data/forecast-data-storm-surge-model-dkss) og [Copernicus' produktbeskrivelse](https://data.marine.copernicus.eu/product/BALTICSEA_ANALYSISFORECAST_PHY_003_006/description).
...
Den samme stigning eller det samme fald kan have forskellig betydning, afhængigt af udgangspunkt, kystprofil, tidevandsfase, bølger og strøm. Den integrerede model bruger derfor ikke vandstand i den aktive score. For waders bruges lavere kendt vandstand og derefter ikke-stigende vand kun til at vælge mellem tidspunkter med præcis samme RavScore; strandvalg bruger det tidligste scorelige tidspunkt.
...
Næsten parallel gridstrøm giver kun en lille kystnormal komponent i den integrerede model. Modellen følger ikke et transportnetværk mellem nabozoner og kan derfor overse vigtig langskyst tilførsel eller bypass. Den foregiver heller ikke, at den målte gridstrøm er den bølgedrevne langskyststrøm inde i surfzonen.
...
Når bølger fører vand ind i surfzonen, skal vandmassen returnere, men processerne må ikke slås sammen. Undertow er den vertikalt fordelte, gennemsnitlige tværkyst-returstrøm under bølgerne. Feeder- og langskyststrøm løber langs stranden og kan samle flow mod en kanal eller fortsætte langs kysten. En ripstrøm er den mere lokaliserede søværts jet gennem en kanal eller langs en grænse. Det betyder, at store indkommende bølger ikke automatisk giver netto indtransport af alle partikler.
...
RavRadar har ingen eksplicit undertow-, feeder-, langskyst- eller ripstrømsmodel. Den verificerede kystnormale gridstrøm kan nedbryde det relative transportbevis fra første effektive udgående time, men den bruges ikke som stedfortræder for surfzonens returvand. Et nul i transportleddet nulstiller ikke hele scoren og beviser ikke, at ravet er væk. Om rav faktisk strander, fanges bag en revle, passerer langs kysten eller føres ud gennem en rende, forbliver en synligt deklareret sidste-mile-usikkerhed.
...
### 11.1 Hvad primærstudierne kan – og ikke kan – støtte

- [Faria m.fl. (2000), DOI 10.1029/2000JC900084](https://doi.org/10.1029/2000JC900084) undersøgte undertow over én revlekyst. Studiet viser, at returstrømmen har en rumlig struktur, og at de største model-/observationsafvigelser lå over revlen. Det støtter ikke, at en grov gridstrøm kan bruges som undertow.
- [Reniers m.fl. (2009), DOI 10.1029/2008JC005153](https://doi.org/10.1029/2008JC005153) fandt i deres felt- og modelopsætning, at surfzoneretention krævede både Stokes-drift og lavfrekvente bevægelser; cirka 20 % af de observerede driftere forlod surfzonen. Forenklede udeladelser gav meget forskellige resultater. Tallet er ikke en dansk rav-landingsandel.
- [Gallop m.fl. (2018), DOI 10.1016/j.margeo.2018.07.015](https://doi.org/10.1016/j.margeo.2018.07.015) viste på en dobbelt revlekyst, at bølgebrydning over revler ændrede ripcirkulation, retention og udveksling ud af surfzonen. Resultatet gør lokal batymetri og brydningsmønster relevant, men leverer ikke en landsregel.
- [MacMahan m.fl. (2010), DOI 10.1016/j.margeo.2009.09.011](https://doi.org/10.1016/j.margeo.2009.09.011) observerede, at ripstrømme kan indgå i recirkulerende hvirvler og tilbageholde driftere frem for blot at eksportere dem direkte til havs.
- [Aagaard m.fl. (1997), DOI 10.1016/S0025-3227(97)00025-X](https://doi.org/10.1016/S0025-3227(97)00025-X) er feltmålinger fra én revlekyst. De fandt en tidevandsafhængig tærskel, hvor lavvande aktiverede kraftig søværts rip- og sedimenttransport, mens den oscillerende transport uden for surfzonen var landværts. Det er evidens for tosidet og stedafhængig procesadfærd – ikke for, at faldende vand altid fører materiale ud.
- [Aagaard, Black og Greenwood (2002), DOI 10.1016/S0025-3227(02)00193-7](https://doi.org/10.1016/S0025-3227(02)00193-7) viste med feltbaseret parameterisering, at nettotransport over revler afhænger af undertow, bølgeskævhed, orbitalhastighed, relativ dybde og bundhældning. Selv højenergiforløb kan derfor ende land- eller søværts.
- [Moulton m.fl. (2017), DOI 10.1002/2016JC012222](https://doi.org/10.1002/2016JC012222) viser, at rip-/undertowfeltet afhænger af lokal revle-/kanalgeometri, bølgebrydning, setup og batymetri. Det gør en grov modelgridstrøm uegnet som proxy for lokal surfzonecirkulation.
- [Haller m.fl. (2002), DOI 10.1029/2001JC000955](https://doi.org/10.1029/2001JC000955) er et laboratorieforsøg på en fast revlestrand med periodiske ripkanaler. Det dokumenterer, at feederstrøm og ripcirkulation afhænger af revle-/kanalmorfologi og bølgebrydning, men er ikke feltbevis for en lavvandsregel.
- [Mouragues m.fl. (2020), DOI 10.1029/2020JC016259](https://doi.org/10.1029/2020JC016259) er et treugers feltstudie på en bestemt revle-/forbjergskyst. Små ændringer i bølger og vandstand ændrede cirkulationen; en deflektions-rip var stærkest omkring lavvande under moderate bølger, mens andre forløb gav landværts strøm eller lokale hvirvler. Det er feltbevis for stedafhængighed, ikke en landsregel.
- [Jalón-Rojas m.fl. (2025), DOI 10.5194/gmd-18-319-2025](https://doi.org/10.5194/gmd-18-319-2025) viste i en bølgeopløst 2DV-model, at en partikels vertikale position og densitet ændrer dens eksponering for landværts Stokes-drift og søværts undertow. Mikropartiklerne er en mekanistisk analogi, ikke ravkalibrering.
- [Lofty m.fl. (2023), DOI 10.1016/j.watres.2023.120329](https://doi.org/10.1016/j.watres.2023.120329) målte 5 mm-rav omkring 1 041 kg/m³ og fulgte det som lavdensitets naturlig partikel i bedload og saltation. Det viser, at rav ikke generelt er en fri overfladetracer; åbent-kanal-forsøget er ikke en dansk surfzonemodel.
- [Chubarenko og Stepanova (2017), DOI 10.1016/j.envpol.2017.01.085](https://doi.org/10.1016/j.envpol.2017.01.085) beskriver baltisk rav omkring 1,05–1,10 g/cm³ som normalt synkende og forbinder den hypotetiske gentagne migration strand↔undersøisk skråning med fælles vind-, bølge-, strøm- og roll-processer. Systematisk feltkalibrering mangler; søværts bevægelse beviser derfor ikke, at alt rav er væk.

Den forsvarlige samlede konklusion er derfor tosidet: Faldende vand bestemmer ikke strømretningen, men kan i nogle lokale revle-/rendesystemer falde sammen med en søværts transportvej for mobilt rav. Lavere vand kan samtidig blotlægge rav, som allerede er afleveret eller fastholdt bag revler eller ved kanter, og dermed gøre et mere afgrænset område lettere at afsøge. Det er ikke bevis for, at vandstandsfaldet fysisk har koncentreret ravet. Søværts bevægelse kan desuden indgå i gentagen migration og mulig senere tilbageførsel; den beviser ikke, at alt rav er væk. Hverken gridstrøm, vandstand eller bølger alene bestemmer sidste-mile-fortegnet. RavRadar mangler lokal batymetri, en bølgeopløst surfzonemodel og ravets lokale partikelstate. Releasekandidaten bruger derfor kun den afgrænsede kausale energivægtede wave-approach med fire timers halveringstid og en ældre hale til at dæmpe allerede eksisterende supply; fysisk levering forbliver uopløst, mens vandstand giver 0 direkte scorepoint.
...
Den integrerede model giver ingen statisk bonus for tang, ålegræs, rev eller lavt vand. Oplysningerne er faglig kontekst og kan senere afprøves mod komplette ture.
...
Den historiske 25/40/35-model gav +3 for tang/ålegræs ved indgående strøm, og en separat forskningsindikator brugte 12 retentionpoint. Hverken Candidate G eller den integrerede efterfølger giver en statisk bonus. Vegetation omtales derfor som faglig kontekst og et muligt fremtidigt kalibreringspunkt, ikke som en aktiv scoreregel.
...
Den historiske 25/40/35-model brugte statiske bonusser for lavt vand, rev, vegetation og vestkyst. Hverken Candidate G eller den integrerede efterfølger bruger disse som scorebonus. Bund, dybde, render, revler og lokal grundegnethed er bevidst udeladt, fordi RavRadar ikke har den landsdækkende lokale batymetri og surfzoneopløsning, der skulle til for at bruge dem sikkert.
...
Den historiske 25/40/35-frigivelsesscore startede på 22 og brugte faste stormtidsbonusser. Den separate procesindikators hændelsesfaser var forskning. Den integrerede model genbruger Candidate G's veldækkede princip om en sammenhængende bølgeenergistyret mobiliseringstilstand: opbygning med cirka fire timers halveringstid og langsom aftrapning med cirka 48 timers halveringstid.

Der er fortsat ingen aktiv, redigerbar landsregel i `rules/national-rules.json` eller `rules/local-rules.json`, som fastholder en høj score efter storm. Hukommelsen ligger i modellens 24/48-timers aldersvægtede strømforløb og dens særskilte mobiliseringstilstand – ikke i en manuel persistence-regel.
...
Kystsystemet har hukommelse: bundprofil, sedimentkoncentration og ravlager ved tidspunkt t afhænger af timerne og dagene før. Den historiske model før Candidate G brugte 24-timers maksimum og tid siden høj energi som en enkel hukommelse. Den integrerede model bruger et deterministisk strømforløb, hvor de første 24 timer vægtes fuldt og evidens derefter falder glat til nul ved 48 timer, plus en særskilt bølgemobiliseringstilstand. Den modellerer fortsat ikke ravlagerets størrelse eller hvor meget et lager allerede er tømt.
...
Efter aflejring kan rav flyttes igen af næste bølge, backwash, faldende vand og tilhørende strøm, vind på stranden, fodtrafik eller ny storm. Faldende vand kan altså både falde sammen med udadgående bevægelse og gøre et tidligere depot bag en revle eller i en opskylslinje synligt. En synlig tanglinje er derfor et øjebliksbillede af en dynamisk proces.

RavRadar modellerer ikke strandingsposition eller sandsynlig højde på stranden. Vandstandsændring er score-neutral kontekst; ved scorelighed kan vandstand kun påvirke waders-valget af tidspunkt. Jagtformen påvirker søgeforholdene, ikke en skjult aflejringsberegning.
...
*Dette afsnit dokumenterer den tidligere 25/40/35-model. Den aktive integrerede kontrakt står i kapitel 18 og 54.*

Fra 4.0.242 vægtede den daværende score jagtbarhed 25 %, transport 40 % og mobilisering 35 %. Afsnittet bevares som historisk revisionsspor. Candidate G erstattede den med 20/50/30; den integrerede model bevarer de vægte og de afprøvede jagtbarhedskurver, men har et nyt fælles model-id, stateformat og en ny transport-/usikkerhedskontrakt.

I den historiske model startede waders-jagtbarhed på 60 og brugte de daværende vind- og bølgetrin. De tal må ikke bruges som beskrivelse af den aktive model. Den integrerede model bevarer Candidate G's fulde waders-jagtbarhed til og med 6 m/s, faldet til 0 ved 15 m/s og bølger som et blødt fradrag på højst 20 procent af et negativt gab. Strandjagt har intet wadersloft.
...
**Historiske bølger i transporten:** I 4.0.241 vurderede den daværende model ikke kun bølgehøjden. En længere bølgeperiode betød mere relativ bølgeenergi, og bølgernes bevægelsesretning blev sammenholdt med den lokale retning fra hav mod land. Effekten kunne højst flytte den historiske transportdel 12 point op eller ned. Manglende periode, retning, højde eller lokal kystretning ændrede ikke denne historiske transportscore. Reglen er erstattet af den afgrænsede DEC-0110-kontrakt i næste kapitel.
...
## 18. Den integrerede RavScore-kandidat

*4.0.334-cutoverkandidatens beregning, trin for trin; den bliver først offentlig ved det samlede, verificerede cutover.*

Den implementerede lokale 4.0.334-cutoverkandidat hedder `RRS-COASTAL-PROCESS-INTEGRATED-1.1.0` og bruger stateformat `6.0.0`, variant `COASTAL-SUPPLY-MOBILISATION-BOUNDED-WAVE-APPROACH-HUNTABILITY-2`, profil `cn-003-015-in10-out8-full24-cos48-gap3-wave4-48-historybounds12d-lastmileewma4-tail40-atten15-v5`, komponentskema `ravscore-components-huntability-delivery-mobilisation-bounds-v5` og forklaringsskema `ravscore-explanation-integrated-bounds-v5`. Beregningen ligger i `js/core/ravscore-integrated.js`, strømtilstanden i `js/core/ravscore-current-supply-memory.js`, mobiliseringen i `js/core/ravscore-wave-mobilisation-state.js`, bølgeapproach i `js/core/ravscore-wave-approach-state.js` og den samlede kæde i `js/core/ravscore-integrated-state-pipeline.js`. Cutover-kontrakten håndhæves af `js/core/ravscore-public-model.js` og `js/core/ravscore-public-runtime-contract.js`. Fase A-appkoden blev exact-head-valideret og merged med Candidate G fortsat offentlig. 4.0.333 bestod sin sourcegate og blev merged; oneoff `34161930631` lukkede currentlaget 79.414/79.414, men stoppede sikkert på Feggesunds WAM-dækning. Indtil 4.0.334 har bestået exact-head, komplet WAM/vejr, kapacitet, produktion og offentlige kontroller, er Candidate G fortsat eneste offentlige model.

Den fælles 11-feltsbinding omfatter også ranking `direction-broad-19-history-tie-v2`, bedste tidspunkt `score-history-water-tie-earliest-v3` og præsentation `score-bands-35-55-75-exceptional90-v1`. 4.0.334 er låst med `modelContractSha256=a226e7d10f5c9fa94e122c0e4e3dc1367f1d5e44e763593e4568ac8a3ed1b14b` og `modelBundleSha256=155fd8f4f9ea59f0dfed01ebe25c5e923e16228db4c9f2cf9cf71415d4047cd9` over 56 kanonisk normaliserede transitive implementeringsfiler og otte deklarerede forbrugere. Den faktiske offentlige browserlukning kontrolleres særskilt over 78 transitive deploymoduler. Bindingen og den fokuserede lokale slutmatrix er grønne; det er ikke i sig selv bevis for offentlig aktivering.

### 18.1 Hovedformel

`grundscore = søgeforhold × 0,20 + levering mod kystzonen × 0,50 + rav i bevægelse × 0,30`

Tilførslen er den aldersvægtede gridstrømsbaserede supply frem mod kystzonen. Det sidste nærkyststykke bruger en kausal energivægtet bølgeapproach med fire timers halveringstid, afledt som `W/N/T` med en ældre hale. DMI-WAM-retning betyder, hvor bølgerne kommer `FROM`, og roteres derfor præcis én gang +180° til `TOWARD` før sammenligning med den uændrede eksisterende kystnormal. `normalAlignment` er det energivægtede normalmoment divideret med aktivitet, `approach=clamp((normalAlignment+0,25)/1,25,0,1)`, `factor=clamp(1-0.15×W×(1-approach),0.85,1)`, og `delivery=supply×factor` beregnes præcis én gang. Bølger kan aldrig skabe eller øge supply, og de kan højst fjerne 7,5 rå RavScore-point før slutafrunding; den viste heltalsscore kan derfor ændres 8 point. Aktiv retningsmissing fejler lukket. Kun `waveHeightM=0` er eksakt calm og neutral; `wavePeriodS` skal stadig være finit og ikke-negativ. `waveHeightM>0` med `wavePeriodS=0` er `INVALID` og fejler lukket.

Faktoren er en forsigtig teknisk proxy, ikke et fysisk landingsinterval. `physicalDeliveryResolved=false`, fysisk interval er `null`, og RavRadar foregiver ikke lokal surfzonepræcision. DDM's officielle 50 m-dybdegrid kan give statisk forskningskontekst, men opløser ikke dynamiske revler, ripkanaler eller surfzoneprocesser og er derfor ikke scoreinput. Rainville m.fl. 2026 målte positivt flydende overfladedriftere, ikke negativt flydende rav med mulig bundkontakt; studiet er alene procesanalogi og aldrig ravkalibrering. Ingen kystnormal, geometri eller land-/vandpunkter flyttes.

Ved waders kan slutscoren ikke overstige søgeforholdene. Ellers afrundes den vægtede sum til 0–100. Der findes ingen helscore-gate ved 13 timers udgående strøm, ingen 65/35-blanding og ingen adaptiv legacyjustering. 15 % er kun den øvre dæmpningsgrænse i det ene delivery-led. Et nul i supply kan derfor godt stå sammen med ikke-nul mobilisering og søgeforhold; det er ikke en påstand om fund eller om et kendt ravlager.
...
Den verificerede gridstrøm vinkelret på den lokale kyst omsættes til en signeret styrke. Under 0,03 m/s er signalet neutralt; ved 0,15 m/s eller mere tæller det fuldt. Fuld indgående strøm giver +10 point pr. effektiv time, og fuld udgående strøm giver -8. Svagere strøm skaleres. Evidens er fuldt vægtet til 24 timer og dæmpes derefter med en glat cosinuskurve til nul ved 48 timer. Genafspilningen starter fra en fast nulrand, kan bruge én reel kadencebro før vinduesgrænsen og accepterer højst tre timers eksplicit hold uden opdigtet bevægelse. Mangler scoretimens direkte strøm, er timen `UNAVAILABLE`. Mangler kun ældre historik, beregner state 6 i stedet en nedre bane med stærkest tilladt udstrømning og en øvre bane med stærkest tilladt indstrømning under den samme kerne; den opfinder ingen måling.

### 18.4 Rav i bevægelse

Bølgehøjde og bølgeperiode omsættes til energi-proxyen `Hs² × T` og derfra en relativ energi-score. Mobiliseringstilstanden bygges gradvist op med cirka fire timers halveringstid og falder med cirka 48 timers halveringstid. Et hul må ikke opfinde mobilisering: state holdes uden ny opbygning, og efter et længere hul gives højst én times ny opbygningskredit ved første ægte prøve. Vind og strøm giver ikke ekstra mobiliseringspoint. Modellen kender ikke størrelsen på et ravlager og skelner ikke sikkert mellem ny frigivelse og genmobilisering.

### 18.5 Søgeforhold

Ved waders giver vind til og med 6 m/s fuld vindscore. Derefter falder den trinvist gennem 7/80, 8/60, 10/35 og 13/10 til 15/0. Bølger kan kun reducere den med 20 procent af det negative gab mellem vind- og bølgekurven. Strandscoren bevarer de eksisterende vind- og bølgekurver og kombinerer det svageste signal med det vægtede gennemsnit. Strandjagt har ikke wadersloftet. Delen beskriver søgeeffektivitet, ikke sikkerhed.

### 18.6 Forklarbarhed og profilvalg

Den offentlige projektion viser de tre komponenter, 20/50/30-vægtene, deres bidrag, den aktuelle profil, supply-/delivery-/mobiliseringsforløbet samt den strukturelle sidste-mile-usikkerhed. Den markerer, at gridstrøm ikke er surfzonens undertow eller ripstrøm, og at scoren ikke er fundprocent. Ufuldstændig historik giver fortsat score og prognose med konservative bounds; kun manglende direkte obligatoriske input gør den konkrete zone, søgemåde og time `UNAVAILABLE`. Før første cutover er Candidate G fortsat den ene offentlige model. Efter et verificeret skift kan hverken Candidate G eller den gamle 25/40/35-model overtage automatisk, og profiler blandes aldrig; Candidate G kan da kun igen blive den ene offentlige model gennem den manuelle, fuldt verificerede hel rollback i kapitel 55.1.

### 18.7 Cold start, nøddrift og evidenstillid

Migrationen `candidate-g-schema2-signed-current-reweight-bounded40h-wave-approach-to-integrated-schema6-v5` genbruger Candidate G's signerede, allerede afledte kystnormale strømstyrker og genvægter dem efter den nye currentkerne. Den læser eller kopierer ikke rå U/V og påstår derfor ikke, at resultatet er identisk med en genberegning fra rå strømvektorer. Wave-approach bygges fra 40 private præ-target-timer i ét sammenhængende DMI WAM-run pr. anvendt collection og med samme modelcelle. Kun en manglende WAM-time mellem native endepunkter højst fire timer fra hinanden må interpoleres, og kun inden for samme run, collection, gitter og celle. Den udeladte ældre EWMA-hale er højst `1/1024`, svarende til højst `0,01171875` konservativt beregnede rå scorepoint før afrunding.

Alle 673 Candidate G-states skal være gyldige schema 2, passe til det uforanderlige kystdelsregister og pege på præcis samme kanoniske targettime. Hvis targetet er blandet, en state er ugyldig eller det sammenhængende WAM-run ikke kan skaffes, stopper skiftet, og Candidate G forbliver offentlig. Der dannes ingen syntetisk eller offentlig historik. En ægte state-6-cold start bruger de 0–48 private, verificerede timepositioner, der faktisk findes, plus den reelle targetrække og forbliver `HISTORY_INCOMPLETE`, indtil 288 timers tail closure eller attestert migration/continuation. Rollback `integrated-schema6-to-candidate-g-schema2-v3` bruger samme targettid uden dobbelt recovery-credit. Checkpoint-only recovery bruger atomisk checkpointschema 4/cache-v2 med 673 schema-6-states og en parret, beskyttet READY Candidate G-companion schema 1 fra samme generation; den må aldrig dannes af incomplete state 6. Den lokale, aldrig-offentlige state-5-kandidat kan kun være eksakt `READY`-migrationskilde gennem `integrated-schema5-ready-point-to-schema6-history-bounds-v1`; aktiv cache og checkpoint er schema 6.

### 18.8 Ufuldstændig historik uden opdigtede data

State 6 har tre eksplicitte scorekvaliteter. `FULL_HISTORY` betyder, at den nedre og øvre beregningsbane er faldet sammen; semantikken kan være fysisk beregnet `EXACT_POINT_SCORE` eller den faste konservative modelclosure `CONSERVATIVE_TAIL_RESET_POINT_SCORE`. Sidstnævnte er kalibreringsegnet modelpolitik, ikke fysisk eksakt state. `HISTORY_INCOMPLETE` betyder, at direkte input i scoretimen er gyldige, men et ældre historikled stadig kan ændre resultatet; RavRadar viser da den konservative nedre score og fører den øvre grænse, spændet, årsagerne og dækningen med. `UNAVAILABLE` betyder, at et direkte obligatorisk input mangler eller er ugyldigt, og scoren er `null`.

Strøm bruger fortsat kun 48 aktive timer. Ukendte ældre intervaller omsluttes med de stærkest tilladte ud- og indgående baner under +10/-8-kernen. Efter 288 timer lukkes scoringens wave-bane til lower-bound-sporet, hvor den størst mulige resterende rå scoreeffekt er `0,46875` point. Efter 40 timer lukkes scoringens last-mile-bane til minimum-factor-sporet med højst `1/1024` udeladt momentandel. `conservativeResetAt` markerer closure, senere huller åbner bounds fra det konservative scoringstrack, og fysisk/rollback point state bevares separat. Disse grænser er modelpolitik, ikke fysisk konfidensinterval.
...
## 21. Fra faglig viden til versionsstyret scoreændring

*En kontrolleret vej fra ekspertudsagn til produktion.*

Det tidligere Regelværksted er taget ud af aktiv administration. Det kunne kun afprøve enkle øjebliksbilleder og kunne ikke sikkert gennemføre den integrerede models to historiktilstande, lokale datagater, aldersvægtning, migration, sidste-mile-usikkerhed, wadersloft og øvrige invariants. En direkte knap fra fri tekst til produktionsscore ville derfor give falsk sikkerhed.

En ændringshypotese skal indeholde: påstand, mekanisme, geografi, jagtform, målbare betingelser, tidsvindue, forventet effekt, evidensklasse, tillid, kilde, testeksempler og modbeviser.

Arbejdsgangen er:

- Registrér observationen eller kommentaren i håndbogsreviewet – uden scoreeffekt.
- Formulér en testbar hypotese med tydelig geografi, jagtform og tidslig mekanisme.
- Omsæt en accepteret hypotese til den autoritative modelkode og en bindende RDKS-beslutning.
- Test positive, negative, grænse- og regressionsscenarier, herunder historik, nul transportbevis, last-mile-usikkerhed, wadersloft og lokal fail-closed.
- Kør kildegate og produktionsgates på PR'ens eksakte head.
- Merge, deploy og verificér den offentlige runtime.
- Evaluer senere mod ture med både fund og nul-fund, før yderligere kalibrering.

De tidligere centrale og lokale regeldokumenter slettes ikke. De bevares som historisk arbejdsmateriale, men indlæses ikke af adminforsiden, publiceres ikke og kan ikke påvirke den offentlige RavScore. `js/core/rule-engine.js` og de gamle regel-JSON-filer er historiske forskningsværktøjer, ikke en aktiv scorevej.
...
## 25. Brugerfeedback, dækningsanalyse og AI
...
Kontoens turlog viser turens oprindelige, uforanderlige modelbinding og status. DTO'en indeholder kun den privacy-sikre eksakte `model_binding`, ikke rå vejrfeatures. Siden udleder aktuelle, historiske og ikke-kalibreringsegnede poster på ny mod det aktive kanoniske modeloverlay og stoler ikke på en gammel serverlabel. Under integreret drift er eksakt integrerede ture aktuelle, mens Candidate G-ture er historiske og ikke egnede. Under en Candidate G-rollback bliver eksakt Candidate G aktuelle, men fortsat `calibration_eligible=false`, mens integrerede ture vises som historiske. Ingen gemt tur ommærkes.

Nye schema-3-ture accepteres kun med RavRadars eksakte 11-feltsbinding for enten den integrerede model eller den forseglede Candidate G-rollback. En integreret tur kan kun være kalibreringsegnet, når faktisk zone og kystdel matcher prognosen; Candidate G er altid ikke-kalibreringsegnet. En ukendt eller forfalsket modelbinding afvises både før submit og i databasen.
...
### Offentlige sprog og Spørg RavRadar – 4.0.291
...
Spørg RavRadar afviser uvedkommende emner og forsøg på at få credentials eller interne oplysninger både i browseren og igen i Edge, før en ekstern model kan kaldes. Bedste sted, bedste tidspunkt og konkret RavScore beregnes af den versionsbundne integrerede model og må ikke opfindes af AI. Konto-/turdata, persondata, præcis position, rå vektorer og interne diagnoser må aldrig sendes til modellen.

Ejeren har valgt og godkendt offentlig aktivering af Cloudflare `@cf/openai/gpt-oss-20b` efter reproducerbare dansk/tysk/engelsk-evals; Gemini bruges kun som intern kvalitetsreference under de aktuelle EØS-vilkår. Server-side Edge håndhæver CORS, inputgrænser, tre rate limits, syv sekunders timeout, struktureret output-/evidensvalidering og lokal fallback. Ingen leverandørcredential findes i browseren. Cloudflare-kontoen er Free / $0 med 10.000 neuroner pr. døgn og uden betalt overflow. Dialogen forklarer den begrænsede dagskvote og den fortsatte lokale funktion på alle tre sprog.
...
Den integrerede model bruger 20 % søgeforhold, 50 % relativt gridstrømsbaseret transportbevis frem mod kystzonen og 30 % rav i bevægelse. Eksperten bør for hvert punkt skrive, om antagelsen virker rigtig, give et konkret eksempel, fortælle hvor i Danmark det gælder og beskrive en observation, der kunne vise, at antagelsen er forkert.
...
E-04 | Transporttilstand | Dødzone ved 0,03 m/s, fuld styrke ved 0,15 m/s, +10/-8 pr. effektiv time, fuld vægt i 24 timer og glat dæmpning til 48 timer | Om grænser, tempo og aldersvægt er rigtige
...
E-06 | Vandstand | Viser fremadrettet 3-timers niveauændring som score-neutral kontekst; bruger kun lavere kendt vand som søgbarhedsprioritet ved scorelighed for waders | Hvornår faldende vand falder sammen med søværts transport, eller lavere vand blotlægger allerede afleveret/fastholdt rav bag revler; ingen fysisk koncentration kan udledes af vandstand alene
...
E-08 | Udadgående strøm | Reducerer relativt gridstrømsbevis fra første effektive time uden at nulstille hele scoren | Hvornår rav forsvinder, lagres nær kysten eller vender tilbage
E-09 | Ledsagemateriale | Giver ikke statiske scorepoint | Hvilke friske felttegn der er mest pålidelige
...
E-12 | Hukommelse | Transport vægtes fuldt 24 timer og dæmpes til 48; mobilisering bruger cirka fire/48 timer | Om opbygning og aftrapning varer rigtigt
...
E-23 | Sidste nærkyststykke | Dæmper eksisterende supply én gang med et afgrænset kausalt energivægtet wave-approach-led med fire timers halveringstid og en ældre hale og markerer fysisk levering som uopløst | Hvilke målbare data der kan skelne stranding, revlefangst, langskyst passage og eksport gennem render
...
Scenario B – høj bølgeenergi nu, gridstrøm væk fra land
Rav kan være sat i bevægelse, mens waders-søgeforholdene falder på grund af vinden. Udadgående gridstrøm reducerer transportbeviset med op til otte point pr. effektiv time og kan bringe komponenten til 0. Hele scoren nulstilles ikke: modellen ved ikke, om et sekundært ravlager stadig ligger bag revler eller i opskyl, og gridstrømmen er ikke en måling af surfzonens returstrømme. Forklaringen skal vise konflikten i stedet for at skjule den.
...
- Chubarenko, I. m.fl. (2017), *Microplastics in sea coastal zone: Lessons learned from the Baltic amber*. Environmental Pollution 224, DOI [10.1016/j.envpol.2017.01.085](https://doi.org/10.1016/j.envpol.2017.01.085). Ravspecifik kilde om mulig gentagen migration mellem strand og undervandsskråning; forfatterne fremhæver, at systematisk ravmonitorering mangler. Den fastsætter ingen dansk tærskel eller universel retningseffekt.

- Aagaard, T., Black, K.P. & Greenwood, B. (2002), *Cross-shore suspended sediment transport in the surf zone: a field-based parameterization*. Marine Geology 185, DOI [10.1016/S0025-3227(02)00193-7](https://doi.org/10.1016/S0025-3227(02)00193-7). Viser land- og søværts nettotransport som funktion af lokal bølge-, strøm-, dybde- og hældningsdynamik; ingen ravfaktor.

- Jalón-Rojas, I. m.fl. (2025), *A wave-resolving two-dimensional vertical Lagrangian approach to model microplastic transport in nearshore waters*. Geoscientific Model Development 18, DOI [10.5194/gmd-18-319-2025](https://doi.org/10.5194/gmd-18-319-2025). Mekanistisk analogi for Stokes-drift, undertow og partikelposition; ikke ravkalibrering.

- Lofty, J. m.fl. (2023), *Microplastic and natural sediment in bed load saltation: Material does not dictate the fate*. Water Research 243, DOI [10.1016/j.watres.2023.120329](https://doi.org/10.1016/j.watres.2023.120329). 5 mm-rav omkring 1 041 kg/m³ blev målt som lavdensitets bedload/saltation i åbent kanalflow; ikke dansk surfzonevalidering.
...
Supplerende spørgsmål til E-01: Definér et realistisk forsøgsprogram for kritisk mobilisering og synkehastighed for repræsentative ravklasser.
...
### 36.1 Periode
Lange bølger påvirker typisk bunden på større dybde og kan give en anden surfzone end korte vindbølger. Den integrerede model bruger derfor både bølgehøjde og periode i den timevise `Hs² × T`-proxy.
...
Lokal vind over kort fetch kan give stejle, korte bølger, mens fjern swell kan ankomme efter at den lokale vind er faldet. Den integrerede model samler den timevise energi-proxy i én mobiliseringstilstand, som bygges med cirka fire timers halveringstid og derefter aftager med cirka 48 timers halveringstid. En kort spids tæller derfor ikke som mange timers vedvarende energi.

### 36.4 Den aktuelle begrænsning
RavRadar bruger ikke hele bølgespektret og modellerer heller ikke lokal refraktion, brydning ved revler eller præcis bundbelastning. Retningen bruges kun i den afgrænsede kausale energivægtede approach-proxy med fire timers halveringstid og en ældre hale, som kan dæmpe allerede eksisterende supply højst 15 % og aldrig øge den. Den må ikke fortolkes som lokal surfzonefysik eller fysisk landingsandel. En større eller lokalt præcis effekt kræver robuste lokale input og hold-out-data.
...
Uddybning af E-11: Angiv hvilke morfologiske observationer en ravjæger realistisk kan registrere, og hvor længe de bør påvirke modellen.
...
Uddybning af E-02: Vurder om en latent lagerfaktor er fagligt meningsfuld, og hvilke observationer der kan opdatere den uden cirkelslutning.
...
Uddybning af E-09 og E-10: Definér en praktisk klassifikation af opskyl, som kan bruges konsistent af ikke-eksperter.


## 40. Dansk regional oceanografi og hvorfor én landsregel er utilstrækkelig

*Nordsø, Skagerrak, Kattegat, Bælter, Øresund og Vadehav har forskellige dynamikker. Den integrerede model bruger fortsat samme grundtærskler i hele landet og lokale kystretninger, fordi den ikke har valideret grundlag for regionale tal.*
...
Stor fetch, kraftig bølgeenergi, stormsurge og markant profilændring gør mobilisering central. Bølgeretning og periode kan være vigtigere end lokal vind i det konkrete øjeblik.

### 40.2 Skagerrak og Kattegat
Komplekse forbindelser mellem Nordsøen og Østersøen, tæthedsstrømme, vindstuvning og lokal kystgeometri kan give forskel mellem overflade- og bundstrøm. Nordjyske østvendte kyster kan få rolige søgeforhold under fralandsvind, mens tidligere eller fjern bølgeenergi stadig har påvirket bunden.
...
### 40.4 Vadehavet
Tidevand, render, vadeflader og hurtig vandstandsændring kan gøre de landsdækkende tærskler mindre præcise. Det er en faglig hypotese, ikke en aktiv særregel. En regional forskel må først indføres, når den kan beskrives målbart og består repræsentative hold-out-tests.

Uddybning af E-19: Beskriv målbare regionale forskelle og hvilke observationer der kan vise, om en landsdækkende tærskel faktisk er utilstrækkelig.
...
--- | --- | --- | ---
H-01 | Bølgehøjde og periode kan beskrive relativ mobilisering af allerede tilgængeligt rav. | `Hs² × T`, cirka fire timers opbygnings- og 48 timers aftrapningshalveringstid. | Komplette ture viser systematisk et andet energi- eller tidsforløb.
H-02 | Den lokale kystnormale gridstrøm er et brugbart relativt signal om tilførsel frem mod kystzonen. | Dødzone 0,03 m/s, fuld styrke 0,15 m/s og fuld 24-timers vægt med glat dæmpning til 48 timer. | Repræsentative fund-/nul-fundforløb eller bedre feltmålinger peger på andre grænser, dybder eller kysttyper.
H-03 | Vedvarende udgående gridstrøm reducerer gradvist det relative tilførselsbevis, men beviser ikke at kystens ravlager er tømt. | Op til -8 point pr. effektiv time; transportkomponenten kan nå 0 uden at nulstille hele RavScore. | Kontrollerede forløb viser en anden styrke/tid, eller lokal surfzoneevidens viser systematisk modsat transport.
...
H-06 | Et komplet 48-timers strømvindue er langt nok til, at maskinens oprindelige startværdi ikke betyder noget. | Fast nulrand, fuld vægt i 24 timer og deterministisk cosinusdæmpning til 48 timer. | Samme komplette vejrforløb giver forskellige sluttilstande eller ældre dokumenteret strøm ændrer resultatet væsentligt.
H-07 | Grove statiske oplysninger om rev, lavt vand, tang og ålegræs er for usikre til automatiske landsbonusser. | Ingen aktive scorepoint fra disse felter. | Et repræsentativt datasæt viser stabil merværdi uden at skabe kendte lokale fejl.
...
H-10 | Offshore bølgeapproach kan afgrænset dæmpe sandsynligheden for sidste levering, men løser ikke surfzone, revler og strandflade. | Kausal energivægtet `W/N/T`-EWMA med fire timers halveringstid og en ældre hale giver `factor=0,85–1,00` og `delivery=supply×factor` én gang; `physicalDeliveryResolved=false` og fysisk interval er `null`. | Lokal dynamisk batymetri/surfzonemodellering eller repræsentativt feltgrundlag giver en validerbar lokal funktion.
...
### 45.2 Ikke-nul score ved udgående gridstrøm
I den integrerede model falder transportbeviset fra første effektive time med udgående strøm og kan nå 0. Hele RavScore nulstilles ikke, fordi modellen hverken observerer ravlageret eller den lokale surfzone og derfor ikke kan bevise, at alt rav er fjernet. Brugerforklaringen skal vise det lave transportled og den strukturelle sidste-mile-usikkerhed; retningskonvention, lokal kystnormal og pilesymbol skal stadig auditeres.
...
Emne | Kandidatfil | Kontrol

Integreret score og 20/50/30 | js/core/ravscore-integrated.js | scripts/test-ravscore-integrated-model.mjs

Gridstrømsforløb 24/48 timer | js/core/ravscore-current-supply-memory.js | scripts/test-ravscore-current-supply-memory.mjs

Bølgemobilisering 4/48 timer | js/core/ravscore-wave-mobilisation-state.js | scripts/test-ravscore-wave-mobilisation-state.mjs

Samlet state, migration og rollback | js/core/ravscore-integrated-state-pipeline.js | scripts/test-ravscore-integrated-state-pipeline.mjs

Offentlig model- og payloadbinding | js/core/ravscore-public-model.js | scripts/test-ravscore-public-model.mjs

Offentlig runtimekontrakt | js/core/ravscore-public-runtime-contract.js | scripts/test-ravscore-public-runtime-contract.mjs

Procesfase uden direkte scorevirkning | js/core/coastal-process-model.js | scripts/test-process-model-4.0.33.mjs

Retningsankre | js/core/direction-anchors.js | scripts/test-direction-anchors.mjs

Brugerfeedback og dækningsanalyse | js/services/learning-analysis.js | scripts/test-feedback-learning.mjs

Ekspertens håndbogsreview | js/services/handbook-review-store.js | scripts/test-handbook-review-archive-4.0.91.mjs
...
Candidate G er fortsat den eneste offentlige scorevej, mens 4.0.319-cutoveret valideres. Efter et sikkert integreret cutover bevares Candidate G-filerne kun til migration, rollbackkontrol, historiske sammenligninger og forskning. `js/core/score-engine.js`, `js/core/rule-engine.js` og gamle regelfiler er ikke samtidige offentlige scoreveje.
...
- DMI WAM- og DKSS-dokumentation. Autoritativ for bølgeretningens `FROM`-semantik, bølge-/vandstandsprodukter og deres modelbegrænsninger; dokumenterer datakilden, ikke ravfysikken eller lokal surfzonelevering.

- Geodatastyrelsen, [Danmarks Dybdemodel 2024/v2](https://gst.dk/ansvarsomraader/soekort-og-marine-data/soeopmaaling-og-dybdedata/danmarks-dybdemodel). Det officielle 50 × 50 m middelgrid fører dybde, kilde og opmålingsår, prioriterer moderne søopmåling og indeholder også 2024-lavtvandsdata fra satellit/lidar. Utilstrækkeligt dækkede celler interpoleres, kystlinjen er generaliseret 1:100.000, og modellen opløser ikke dynamiske revler, aktuelle ripkanaler eller en bølgeopløst surfzone. Derfor er den statisk kontekst, ikke RavScore-input.

- Rainville m.fl. (2026), DOI [10.1029/2025JC022422](https://doi.org/10.1029/2025JC022422). Nærkystdriftere viser, at brydende bølger kan strande flydende objekter; RavRadar bruger kun studiet som buoyant-object-analogi, aldrig som ravkalibrering.

- Faria m.fl. (2000), “The mean undertow profile under a monochromatic wave: measurements and numerical modelling”, Journal of Geophysical Research, DOI [10.1029/2000JC900084](https://doi.org/10.1029/2000JC900084). Viser undertows rumlige struktur over en revlekyst og modelusikkerhed over revlen; kan ikke omsætte RavRadars gridstrøm til lokal undertow.

- Reniers m.fl. (2009), “Surf zone surface retention on a rip-channeled beach”, Journal of Geophysical Research, DOI [10.1029/2008JC005153](https://doi.org/10.1029/2008JC005153). Understøtter, at Stokes-drift, lavfrekvente bevægelser og lokal cirkulation er nødvendige for at forstå retention og udveksling. Studiets cirka 20 % observerede exits er ikke en universel landings- eller eksportandel.

- Gallop m.fl. (2018), “Rip current circulation and surf zone retention on a double barred beach”, Marine Geology, DOI [10.1016/j.margeo.2018.07.015](https://doi.org/10.1016/j.margeo.2018.07.015). Understøtter, at revlebrydning og lokal morfologi kan ændre ripcirkulation, retention og exit.

- MacMahan m.fl. (2010), “Mean Lagrangian flow behavior on an open coast rip-channeled beach: A new perspective”, Marine Geology, DOI [10.1016/j.margeo.2009.09.011](https://doi.org/10.1016/j.margeo.2009.09.011). Viser, at ripstrøm kan recirkulere og tilbageholde flydere frem for at være ren søværts eksport.

- Aagaard, Greenwood & Nielsen (1997), “Mean currents and sediment transport in a rip channel”, Marine Geology 140, DOI [10.1016/S0025-3227(97)00025-X](https://doi.org/10.1016/S0025-3227(97)00025-X). Ét feltstudie knytter lavvande til stærk offshore rip-/sedimenttransport på en revlekyst, samtidig med landværts oscillerende transport uden for surfzonen. Det støtter stedafhængighed, ikke en generel faldende-vand-regel.

- Aagaard, Black & Greenwood (2002), “Cross-shore suspended sediment transport in the surf zone: a field-based parameterization”, Marine Geology 185, DOI [10.1016/S0025-3227(02)00193-7](https://doi.org/10.1016/S0025-3227(02)00193-7). Nettoretningen over revler afhænger af undertow, bølgeskævhed, orbitalhastighed, relativ dybde og bundhældning; kilden giver ingen ravspecifik faktor.

- Jalón-Rojas m.fl. (2025), “A wave-resolving two-dimensional vertical Lagrangian approach to model microplastic transport in nearshore waters”, Geoscientific Model Development 18, DOI [10.5194/gmd-18-319-2025](https://doi.org/10.5194/gmd-18-319-2025). Vertikal position, densitet og stigende/synkende adfærd ændrer Stokes-/undertoweksponering; lavdensitetsplast er analogi, ikke ravkalibrering.

- Lofty m.fl. (2023), “Microplastic and natural sediment in bed load saltation: Material does not dictate the fate”, Water Research 243, DOI [10.1016/j.watres.2023.120329](https://doi.org/10.1016/j.watres.2023.120329). Laboratoriet brugte 5 mm-rav omkring 1 041 kg/m³ som lavdensitets naturlig partikel og målte bedload/saltation. Det afviser en generel fri-overfladetracer-antagelse, men er ikke en marin dansk surfzonevalidering.

- Moulton m.fl. (2017), Journal of Geophysical Research: Oceans, DOI [10.1002/2016JC012222](https://doi.org/10.1002/2016JC012222). Understøtter, at rip-/undertowfeltet afhænger af lokal revle-/kanalgeometri, bølgebrydning, setup og batymetri; RavRadars gridstrøm kan ikke erstatte disse felter.

- Haller m.fl. (2002), Journal of Geophysical Research, DOI [10.1029/2001JC000955](https://doi.org/10.1029/2001JC000955). Laboratorieforsøg på en fast revlestrand med ripkanaler; dokumenterer morfologiafhængig feeder-/ripcirkulation, ikke lavvandsfeltbevis.

- Mouragues m.fl. (2020), “High-Energy Surf Zone Currents and Headland Rips at a Geologically Constrained Mesotidal Beach”, Journal of Geophysical Research: Oceans, DOI [10.1029/2020JC016259](https://doi.org/10.1029/2020JC016259). Treugers feltstudie af bølge-, vandstands- og morfologiafhængige strømregimer; ingen universel lavvandsregel.

- Chubarenko m.fl. (2017), Environmental Pollution 224, DOI [10.1016/j.envpol.2017.01.085](https://doi.org/10.1016/j.envpol.2017.01.085). Fremhæver mangel på systematisk ravmonitorering og opstiller gentagen migration mellem strand og undervandsskråning med mulig tilbageførsel over dage som hypotese.

Kildelisten skal udvides løbende. Hver ny scoreantagelse skal pege på mindst én mekanistisk kilde eller være tydeligt mærket som ekspertobservation eller RavRadar-hypotese. En ændring bliver først aktiv gennem den versionsstyrede model- og releaseproces.
...
- Ejeren vurderer forslaget; en accepteret ændring bliver først aktiv, når RDKS, den autoritative modelkode, de relevante tests og den versionerede release er opdateret og verificeret.
En ekspertkommentar ændrer aldrig håndbogen eller scoremotoren direkte. Den gemmes i Supabase med versionshistorik og kan accepteres, afvises eller omsættes til en kontrolleret kodeændring af ejeren og udviklingsprocessen.
...
Den klassiske stormfortælling er vigtig, men ufuldstændig. Rav kan flyttes gennem gentagne korte cyklusser mellem strand, swashzone, revle, rende, tang og helt lavt vand. **Fagligt** er det nyttigt at skelne mellem et primært lager, der kræver egentlig frigivelse, og et sekundært nærkystlager, hvor rav allerede er hydrodynamisk tilgængeligt. Den aktive model observerer eller klassificerer ikke disse lagre; den bruger den samme mobiliseringstilstand for begge mulige forløb.
...
Den integrerede model har ét mobiliseringsspor. Bølgehøjde og bølgeperiode danner energi-proxyen `Hs² × T`, som opbygges under hændelsen og derefter aftager gradvist med hukommelse. Aktuel vind, gridstrøm, vandstand, rev og vegetation giver ikke ekstra mobiliseringspoint. Gridstrømmen indgår i stedet i den særskilte transportkomponent.

Modellen kan derfor ikke afgøre, om et konkret ravstykke stammer fra en primær frigivelse eller en senere nærkystgenmobilisering. Den gamle procesindikator kan beskrive et hypotetisk forløb, men ændrer ikke den integrerede score.

Ekspertpunkt E-22: Vurder om fremtidige data kan skelne pålideligt mellem primær mobilisering og nærkystgenmobilisering uden at blande transport og mobilisering sammen.

Implementeret i: **js/core/ravscore-integrated.js**, **js/core/ravscore-wave-mobilisation-state.js**, **js/core/ravscore-integrated-state-pipeline.js** og den score-neutrale historiske **js/core/coastal-process-model.js**.
...
## 54. Sådan beregner den integrerede RavScore-kandidat det samlede rav- og søgeindeks

*Den lokale 4.0.319-cutoverkandidats modelkontrakt i almindeligt dansk; Candidate G er stadig offentlig.*

RavRadar vurderer tre forskellige led: om man kan lede effektivt, om den verificerede gridstrøm giver relativ evidens for transport frem mod kystzonen, og om bølger kan have sat allerede tilgængeligt rav i bevægelse. En høj score er et modelindeks – ikke et løfte, en procentchance eller bevis for, at rav har klaret det sidste stykke ind.

### 54.1 Kandidatens vægtning

Den integrerede model bevarer den ejerbesluttede vægtning **20 % søgeforhold, 50 % transport frem mod kystzonen og 30 % rav i bevægelse**. Vægtene er en faglig produktprior og er ikke kalibreret mod et repræsentativt fund-/nul-fundgrundlag. De tre dele holdes adskilt for at mindske dobbeltregning.
...
**Transport frem mod kystzonen** styres af verificeret gridstrøm vinkelret på den lokale kyststrækning. Fuld indgående strøm giver +10 point pr. effektiv time, og fuld udgående strøm giver -8 fra første effektive time. De seneste 24 timer vægtes fuldt; evidens falder glat til nul ved 48 timer. Neutral strøm ændrer ikke forløbet, mens manglende strøm er et hul – ikke et nul. Den tidligere 13-timers helscore-gate findes ikke.

**Rav i bevægelse** styres af bølgehøjde og bølgeperiode gennem `Hs² × T` som ét sammenhængende forløb. Mobiliseringen bygges gradvist op med cirka fire timers halveringstid og falder langsomt bagefter med cirka 48 timers halveringstid. Vind giver ikke direkte mobiliseringspoint, og strømmen regnes kun i transportleddet.

**Det sidste stykke** er forbedret, men ikke erklæret fysisk løst. Modellen bruger en kausal energivægtet bølgeapproach med fire timers halveringstid, afledt som `W/N/T` med en ældre hale. DMI-WAM-retningen er `FROM` og roteres præcis én gang +180° til `TOWARD` mod den uændrede eksisterende kystnormal. `factor=clamp(1-0.15×W×(1-approach),0.85,1)` og `delivery=supply×factor` bruges én gang. Dermed kan bølger aldrig skabe eller øge supply, og den rå totalscore kan højst dæmpes 7,5 point før slutafrunding; den viste heltalsscore kan derfor ændres 8 point. Aktiv retningsmissing fejler lukket. Kun `waveHeightM=0` er eksakt calm og neutral; `wavePeriodS` skal stadig være finit og ikke-negativ. `waveHeightM>0` med `wavePeriodS=0` er `INVALID` og fejler lukket. Bølgeorbitaler, gridstrøm, surfzonens undertow, feeder-/langskyststrøm og ripstrømme er fortsat forskellige processer.

**Vandstand** giver ingen scorepoint. `waterLevelTrendCm3h` er den fremadrettede modelændring fra den viste time til tre timer senere, aldrig en aflæst ebbe, flod eller tidevandsfase. Faldende vand bestemmer derfor ikke strømretningen. RavRadar viser i stedet en score-neutral fælleskontekst: faldende vand samtidig med verificeret udgående, indgående eller langs/for svag kystnormal gridstrøm – eller ukendt/native-hold strøm. Grænsen for langs/for svag er ±0,03 m/s. Lavere vand kan blotlægge allerede afleveret eller fastholdt rav bag revler og gøre et afgrænset område lettere at afsøge; det beviser ikke fysisk koncentration.

Ved præcis scorelighed bruger waders-visningen lavere kendt vandstand og derefter en ikke-stigende fremadrettet 3-timers modelændring som praktisk tidsvalg; strandvisningen vælger det tidligste tidspunkt. Visningen returnerer den eksakte udvælgelsesårsag. Lavere vand er kun en søgbarhedsprioritet mellem samme RavScore, ikke evidens for mere rav og ikke en sikkerhedsvurdering.

DKSS-/NEMO-kæden har ingen direkte dubletterm i RavScore: current-U/V driver transportleddet, mens vandstand har nul scoreeffekt. Der er dog residual korrelation, fordi strøm og vandstand kan dele forcing og dynamik i havmodellerne. En ekstra “vandstand = strøm”-regel ville derfor kunne dobbeltregne korreleret information uden at opløse undertow, feeder-/langskyststrøm eller ripstrøm.

### 54.2 Hukommelse, konservative grænser og fail-closed

Transporten genafspilles fra en fast nulrand over de seneste 48 timers afledte strømevidens. Et komplet vindue gør resultatet uafhængigt af computerens oprindelige startværdi. De otte særskilt godkendte Limfjordsproxyer leverer ægte strømprøver på en native tretimerskadence. Mellem to sådanne prøver kan RavRadar i højst tre timer fastholde den seneste afledte tilstand uden at lægge bevægelse eller evidens til; der vises ingen opdigtet retning, hastighed eller pil. Fremtidige prøver kan aldrig bruges til den aktuelle time.

Hvis scoretimens direkte strøm-, bølge- eller søgeinput mangler eller er ugyldigt, bliver kun den konkrete zone, søgemåde og time `UNAVAILABLE`; der vises ingen erstatningsscore. Hvis de direkte input er gyldige, men den ældre historik er ufuldstændig, viser RavRadar derimod en konservativ `HISTORY_INCOMPLETE`-score: den nedre mulige score vises, den øvre grænse og årsagen følger med, og en tydelig advarsel står ved score, detaljer og femdøgnsvisning. Advarslen forsvinder automatisk, når grænserne falder sammen. Admin og ekspert ser samme status. RavRadar blander ikke model-id, stateformat eller profiler mellem steder, tider og jagtformer.
...
Modellen siger ikke, at den fysiske levering er løst: `physicalDeliveryResolved=false` og fysisk interval er `null`. DDM's officielle 50 m-dybdegrid kan være statisk forsknings-/forklaringskontekst, men har ikke dynamiske revler, ripkanaler eller bølgeopløst surfzone og er derfor ikke scoreinput. Rainville m.fl. 2026 er alene buoyant-object-analogi og ikke ravkalibrering. Kystnormal, geometri og land-/vandpunkter flyttes ikke. Faste oplysninger om rev, lavt vand, tang eller ålegræs skaber heller ikke scorepoint. Modellen observerer ikke ravlager, strandingssted eller fundudfald.

### 54.4 Hvad eksperten især skal kontrollere

Eksperten bør vurdere gridstrømmens retning i forhold til den konkrete kyst, +10/-8-forløbet, 24/48-timers aldersvægten, waders-vindkurven, bølgeenergiens fire/48-timers forløb og den afgrænsede kausale energivægtede bølgeapproach med fire timers halveringstid og en ældre hale. Især skal eksperten udfordre, om DMI `FROM`→`TOWARD`-fortolkningen, kystnormalen og den ensrettede højst 15 % dæmpning giver rimelig mekanisk adfærd uden at blive fortolket som lokal surfzonepræcision. En kommentar bør beskrive kysttype, målbare forhold, forventet virkning, hvor stor forskellen bør være, og hvilken observation der kunne modbevise forslaget.

Modellen er mekanisk regressionstestet og fysisk motiveret og gennemgået. Den må ikke kaldes empirisk mere fundpræcis, før den er valideret på et repræsentativt grundlag med både fund og nul-fund.
...
Et separat beskyttet checkpoint indeholder kun den afledte, kompakte state-6-fortsættelsestilstand inklusive history bounds. Ved første skift fra Candidate G bruger migrationen `candidate-g-schema2-signed-current-reweight-bounded40h-wave-approach-to-integrated-schema6-v5`. Den validerer og genvægter Candidate G's signerede, allerede afledte kystnormale currentevidens uden at læse eller kopiere rå U/V og uden at påstå lighed med en rå genberegning. Wave-approach genopbygges af 40 private præ-target-positioner fra ét sammenhængende DMI WAM-run pr. anvendt collection med same-cell native provenance. Kun et WAM-gap mellem native endepunkter højst fire timer fra hinanden i samme run, collection, gitter og celle må interpoleres; cross-run, cross-cell og tvetydig retning afvises. `1/1024` er øvre grænse for den udeladte EWMA-hale, og `0,01171875` er den konservative øvre rå-scorefejl før afrunding.

Inden acquisition valideres præcis 673 schema-2-states mod det uforanderlige kystdelsregister og deres state keys. Den samme rene recoveryfunktion skal give præcis ét fælles kanonisk target. Mixed target, manglende eller ugyldig state og utilgængeligt coherent WAM-run stopper fail-closed; Candidate G forbliver offentlig. Når en attestert state findes, kan modellen starte uden ny cache. Uden state genafspilles 0–48 faktisk tilgængelige private timer og scoren vises som `HISTORY_INCOMPLETE`; den opfinder aldrig historik, og `FULL_HISTORY` kræver 288-timers closure eller attestert migration/continuation. Den kontrollerede WAM-interpolation er kun en privat bootstrapregel inden for ét dokumenteret run; den gælder ikke 72-timers nøddrift.

Hver continuation-state, checkpointet og den centrale profilselection skal matche den fulde 11-feltsbinding. Candidate G-rollback `integrated-schema6-to-candidate-g-schema2-v3` beregnes fra samme targettid uden dobbelt recovery-credit. Schema 5 var aldrig offentlig og må alene accepteres som eksakt `READY`-migrationskilde med de fastlåste historiske hashes gennem `integrated-schema5-ready-point-to-schema6-history-bounds-v1`; efter migrationen er den ikke cache eller normal recovery. Fremtidige opdateringer af den operationelle checkpointnøgle kopieres ikke til `admin_document_versions`, men alle eksisterende versionsrækker bevares; migration og publicering sletter ingen historik. Candidate G kan kun bruges som én kontrolleret migrations-/rollbackkilde og aldrig som automatisk offentlig nødmodel.

Den tidligere planlagte fiktive udførelse af morgenhullet blev opgivet efter read-only stop og før descriptor, apply, mutation eller offentliggørelse. Den afgrænsede historiske kontrakt bevares i DEC-0109, men er ikke en normal recoveryregel.

Pages-auditten kræver de fire tilladte livefiler, afviser andre live-, admin-, cache- og diagnostikfiler og sammenligner også filfingeraftryk mod den private runtimebundle. Opdelingen ændrer ikke scorer, kortfarver, bedste tidspunkt eller viste vejrdata; den beskytter kontinuitet og privatliv uden at gøre browserstarten tung.

Modelskiftet omfatter også serveren. `20260829010000_ravscore_operational_documents_no_history.sql` etablerer først de private driftsdokumenter og runtimebucket; derefter anvendes `20260829020000_integrated_trip_calibration_binding.sql`. Protected readiness binder begge id'er og skrives først efter samlet migrationsmetadata-, database- og Edge-readback. Efter den skrivefri dry-run genhenter backendworkflowet `origin/main` og kræver, at den stadig er lig `GITHUB_SHA`, umiddelbart før den første eksterne backendskrivning; resten af skriverækken bruger samme validerede checkout og migrationssnapshot. Backend og Edge gøres klar, mens Candidate G stadig er offentlig, og må kun behandle et datasæt under dets eksakte modelbinding. Mangler bindingen eller er den forkert, svarer ny Edge eksakt HTTP `409`, så en gammel klient bruger sin lokale Candidate G frem for et blandet serversvar.

Første modelskift kræver den særskilte manuelle Fase B; et push kan kun gennemføre Fase A med Candidate G fortsat offentlig. Før vejrhentningen skal den forseglede centrale Phase-A-complete Candidate G-identitet passe eksakt. I deployleddet genverificerer RavRadar den faktiske offentlige Candidate G-kilde, manifest og implementation closure, før controlleren skriver `INTEGRATED_PENDING`, mens den centrale profil fortsat er Candidate G. Det integrerede Pages-artifact deployes og kontrolleres for eksakt implementering, 210 zoner og 673 kystdele. Først derefter sætter én beskyttet handling samtidigt status til `INTEGRATED_ACTIVE` og central profil til den integrerede 11-feltsbinding. Efter et afbrudt skift genoptager RavRadar kun, hvis den offentlige manifesthash er det aftalte mål; er den fortsat kilden, aborteres overgangen med kildeprofilen bevaret; er den noget tredje, bliver `PENDING` stående og normal drift stopper. Dermed kan central profil ikke kalde modellen integreret, mens Candidate G stadig er den offentlige side. Assistentens Edge rulles ikke tilbage til en særskilt Candidate G-version.

### 55.1 Operationel hel rollback

En hel rollback efter integreret drift startes manuelt og har id'et `integrated-schema6-to-candidate-g-schema2-v3` og overgangstypen `CANDIDATE_G_ROLLBACK`. Rollbackprojektionen bygges fra samme targettid som den integrerede state uden at give samme time dobbelt recovery-credit. Controlleren `ravscore-operational-model-activation` bruger schema `ravscore-operational-model-activation-v4`, fire statusser, seks overgangstyper og præcis 30 vedvarende felter, inklusive source/requested implementation-closure-hashes. Den observerer den integrerede offentlige kilde, skriver `CANDIDATE_G_PENDING` og bevarer den integrerede centrale profil, mens Candidate G-Pages deployes. Først efter offentlig kontrol af præcis 210 zoner, 673 kystdele og den eksakte Candidate G-implementeringsbinding sætter én beskyttet handling samtidigt `CANDIDATE_G_ACTIVE` og central Candidate G-profil. En senere manuel tilbagevenden bruger `INTEGRATED_RETURN` og `INTEGRATED_PENDING` efter samme mønster.

Efter et afbrudt skift sammenlignes både den offentlige manifesthash og implementation closure med den gemte kilde og det gemte mål. Mål betyder fuld genkontrol og færdiggørelse; kilde betyder abort/rekonsolidering til kildens aktive status; alt andet bliver fail-closed i `PENDING`. Scheduleren kan hverken førstegangsaktivere, rollbacke eller returnere en model. Fra rowless exact legacyprofil er push/scheduler/manuelt vejr reachable gennem `candidate-legacy-maintenance`/`LEGACY_CANDIDATE_G_REFRESH_BEFORE_INITIAL_CUTOVER`; samme marker arves efter current Candidate-complete med exact Candidate-binding og fire `null`-returnfelter, og `legacySourceRequired=false` følger sourcebindingen. Den særskilte `CANDIDATE_G_REFRESH_BEFORE_INITIAL_CUTOVER` tilhører kun en current Candidate-lineage efter et afbrudt integreret first-cutover-forsøg og bevarer de fire return-evidence-hashes; almindelig aktiv drift bruger `CANDIDATE_G_REFRESH`. Ingen marker må skabes ved relabel, og ingen vedligehold må skrive `INTEGRATED_PENDING` eller aktivere state 6. En ny first-cutover-plan kræver current same-head Candidate G og den særskilte manuelle Fase B; direkte rowless legacy→integrated er forbudt, mens allerede forseglede planer fortsat kan reconcileres. Der deployes ingen særskilt Candidate G-assistent-Edge. Assistentens integrerede Edge afviser Candidate G-bindingen med eksakt HTTP `409`, hvorefter klienten bruger de eksisterende deterministiske lokale svar på dansk, tysk eller engelsk. Schema-3-ture og -observationer lagres fortsat under den eksakte Candidate G-binding med `calibration_eligible=false`. Denne local-only adfærd er tilsigtet fail-closed, ikke en skjult dualmodel eller serverbaseret Candidate G-fallback. 4.0.320's Candidate G-rollbackbinding er `modelContractSha256=c73dac1b4376005e792580791d84eb79c9370e905a2a7fd0bdee857506a20cf8` og `modelBundleSha256=7c7f2b4950b4ce7a04d560dde15dd93e408e045ca5e9ed4f9be33eac0255e89d` over 56 transitive filer; begge er regenereret og skal passe eksakt til targetprofil, public stage, audit og releasegate. Dermed kan Candidate G efter en kontrolleret hel rollback være den ene offentlige scoremodel, men aldrig samtidig shadowmodel eller automatisk fallback.
...
### Dokumentation og kalibreringsgrundlag
Dokumentationscenteret åbner Current Truth, implementeringsstatus, aktive krav, kendte problemer, masterlog og håndbogen. Kalibreringssiden er read-only og viser kun, om registrerede ture på sigt kan bruges i en kontrolleret analyse. Den kan ikke ændre Candidate G, den offentlige RavScore eller en lokal scoremodel.
...
## Regelværkstedet er ikke en aktiv scorevej
Det tidligere Regelværksted og dets rettigheder er fjernet fra den aktive administration. Det kunne ikke sikkert afprøve eller håndhæve Candidate G's historik, lokale datagater og bindende invariants og kunne derfor give et misvisende indtryk af, at en enkel tekstregel var klar til produktion.

De eksisterende centrale og lokale regeldokumenter slettes ikke. De bevares som historisk arbejdsmateriale, men admin indlæser dem ikke, produktionsworkflowet publicerer ingen aktiv regelfil, og den offentlige app anvender dem ikke. Alle brugere får den samme versionsbundne Candidate G-model.
...
Denne tilstandsmodel er nu en aktiv del af Candidate G. Den genafspiller de seneste 48 timers dokumenterede mobilisering og transport og påvirker den offentlige RavScore gennem de faste 20/50/30-vægte. Manglende data behandles som et hul; der opfindes ikke neutral strøm eller historik. Den ældre state-shadow-v2-beskrivelse er historik og må ikke bruges som beskrivelse af den aktive scorevej.
...
Dette er et historisk revisionsspor, ikke den aktive arkitektur. I 4.0.113 var tilstandsmodellen endnu en score-neutral skyggeberegning på fire faste referencezoner. Candidate G blev senere den offentlige scoremodel og bruger nu sin egen dokumenterede 48-timers strømtilstand og bølgeenergistyrede mobiliseringstilstand på de aktive kystdele.

Dengang krævede kontrollen verificeret DMI-strøm og `stateModelMode: shadow-v2`. En kompakt loglinje gjorde det muligt at sammenligne varighed, styrke, stabilitet og nærkystpotentiale mellem produktionstimer uden nye manuelle screenshots.
...
## Historisk 4.0.220: rå og verificeret strømhistorik

Dette er et historisk revisionsspor for den første opmåling af rå og DMI-verificeret strømhistorik. Det beskriver ikke den aktuelle aktiveringsgrænse. I 4.0.220 gemte RavRadar op til 72 timers rå vejrprøver, men en gemt prøve var ikke automatisk sikker nok til transport- eller scoreanalyse. Strøm talte kun som verificeret, når øst-/vest- og nord-/sydkomponenten havde et fælles DMI-bevis for samme sted, dybde, modelkørsel og tidspunkt.
...
Aktuelt bruger Candidate G et rullende vindue på op til 48 timers sammenhængende, verificeret og afledt kystnormal strøm. Systemet rekonstruerer ikke fortiden og gentager ikke en gammel værdi for at lukke et hul. Manglende lokalt grundlag giver ingen erstatningsscore.
...
I 4.0.249 beregnede den private nationale shadow-validator A, B og C på samme lokale kontekst som den daværende aktive score. Den brugte 24 timers hændelseshistorik og 72 timers strømforløb, opdelte kandidat B i strøm mod, langs og væk fra kysten og gemte kun dataminimerede forskelle. Dette er et historisk forarbejde til Candidate G, som senere blev offentlig og fortsat er den eneste offentlige model i 4.0.316, og videre til den lokale integrerede releasekandidat; se DEC-0047 og `docs/research/RAVSCORE_PRIVATE_SHADOW_METHOD_2026-08-21.md`.
...
**Kort fortalt:** At alle nødvendige tal findes, betyder ikke automatisk, at de tilhoerer samme vejrmodel. RavRadar maa ikke samle vandstand fra ét DKSS-modelomraade og stroem fra et andet og kalde det én komplet serie.
...
## Historisk Candidate G: score, waders, pil og historik i samme kontrakt
...
Dette afsnit er historik. Candidate G blev offentlig med `20/50/30`, modeafhængige søgeforhold, strømstyret transport og bølgeenergimobilisering; pipeline, forklaringer, daværende rollback, national slutshadow og fulde gates blev gennemført i 4.0.261–4.0.263. Candidate G er fortsat den produktionsverificerede offentlige 4.0.316-model, indtil det integrerede cutover er bevist. Mens integreret er aktiv, er Candidate G et privat migrations-/offline-/rollback-orakel; en senere manuel hel rollback kræver nyt, fuldt verificeret offentligt skift.
...
# Historisk: Candidate G fortsætter kun fra dokumenteret tilstand – 4.0.272
