...
RavRadar kører fortsat Candidate G/4.0.316 offentligt. Nødrollback PR #236 lagde den eksakte Candidate G-tree tilbage, og den afgrænsede retry-hotfix blev senere merged som uændret offentlig head `8c03e25d`. Nyeste offentlige bevis er produktion `33368963614`, afsluttet grønt gennem build, frisk fuld validate, releasegate, protected sync/artifact og Pages. Datasæt `rr-20260831074016-210` (genereret 07:40:16Z og gyldigt til 2026-09-05 03:00Z) er komplet 210 zoner/673 kystdele. Candidate G har aktuelt 0/210 aktive zoner, fordi dens historikhukommelse endnu er ufuldstændig; det er ikke et nyt indsamlingshul og ikke state-6-bevis. PR #238/#239/#240 førte first cutover frem til to sikre pre-DMI/pre-write-stop, `33391418061` og `33393684620`, uden at gøre state 6 offentlig. Den aktuelle restfejl er én aktiv Højbjerg-del, `DK-B04-01` / `dk-b04-01-national-part-03`, hvor bearing `360` er matematisk nord, men ugyldig som kanonisk `[0,360)`-repræsentation; PR #241 normaliserer kun `360→0` uden at ændre geometri, land-/vandpunkter eller kystnormal. Exact-head, merge, frisk produktion og browserkontrol afventer derfor stadig. Den nye samlede model er derfor stadig 4.0.318-kandidat og ikke offentlig.
...
Candidate G er fortsat den eneste offentlige model i den produktionsverificerede appbaseline 4.0.316. `RRS-COASTAL-PROCESS-INTEGRATED-1.1.0` med state `6.0.0` bestod som 4.0.317 PR #235's afsluttende exact-head og blev merged som `a584d1cf`, men mergeproduktion `33333490853` stoppede sikkert, før DMI/cachebyg, beskyttede writes, artifact eller Pages begyndte. Den blev derfor ikke deployet eller offentlig. 4.0.318 er den lokale, endnu ikke produktionsverificerede first-cutover-remediation under DEC-0110/DEC-0112. PR #238/#239/#240 førte den videre til to sikre pre-DMI/pre-write-stop, `33391418061` og `33393684620`, mens Candidate G forblev offentlig. Den aktuelle restfejl er én aktiv Højbjerg-del, `DK-B04-01` / `dk-b04-01-national-part-03`, hvor bearing `360` er matematisk nord, men ugyldig som kanonisk `[0,360)`-repræsentation; PR #241 normaliserer kun `360→0` uden at ændre geometri, land-/vandpunkter eller kystnormal. Schema 5 var en aldrig-offentlig kandidat og er kun en eksakt 5→6-migrationskilde.
