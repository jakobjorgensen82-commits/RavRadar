...
En ny modelgeneration publiceres ikke nødvendigvis med hele femdøgnshorisonten på én gang. RavRadar fastholder derfor den allerede valgte progressive generation, mens den stadig rækker mindst 96 timer frem. En nyere, men endnu kort publikation får ikke lov at nulstille opbygningen. Når den foretrukne generation ikke længere har 96 fremtidige timer, vælges den nyeste generation, som har det. Der kopieres ingen værdier mellem generationer; reglen styrer kun, hvilket dokumenteret DMI-run der behandles.
