import { exceptionalScoreMark, scoreRating } from "./js/core/score-engine.js?v=4.0.314";
import { loadConditions, loadConditionDetails, mergeConditionDetails, loadZones, loadDataManifest } from "./js/services/data-service.js?v=4.0.314";
import { getLocalObservations, submitTripEvidenceObservation, syncPendingObservations } from "./js/services/observation-service.js?v=4.0.314";
import { predictAmberChance } from "./js/core/prediction-engine.js?v=4.0.314";
...
import { loadAdaptiveModel } from "./js/core/adaptive-model.js?v=4.0.314";
