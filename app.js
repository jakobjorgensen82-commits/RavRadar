...
// RavRadar 4.0.45: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"4.0.45"; document.querySelector("#appVersion").textContent=version;
