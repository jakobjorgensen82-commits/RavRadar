import { calculateRavScore, exceptionalScoreMark } from "./js/core/score-engine.js?v=4.0.161";
import { selectBestTimeForDay } from "./js/core/best-time-selector.js?v=4.0.161";
import { loadConditions, loadZones, loadDataManifest } from "./js/services/data-service.js?v=4.0.161";
import { submitObservation, getLocalObservations, syncPendingObservations } from "./js/services/observation-service.js?v=4.0.161";
import { predictAmberChance } from "./js/core/prediction-engine.js?v=4.0.161";
import { consumeAuthCallback } from "./js/services/auth-service.js?v=4.0.161";
import { activeTrip, answerTrip, pendingTripPrompt, resumeTripTracking, startTrip, stopTrip } from "./js/services/trip-service.js?v=4.0.161";
import { createMap, installFlowArrows, refreshZoneStyles, renderZones } from "./js/map/map-view.js?v=4.0.161";
import { bindZoneInfoInteractions, showZoneInfo } from "./js/ui/info-panel.js?v=4.0.161";
import { openAccountDialog } from "./js/ui/account-panel.js?v=4.0.161";
import { openDeveloperDialog } from "./js/ui/developer-panel.js?v=4.0.161";
import { analyzeObservations } from "./js/services/learning-analysis.js?v=4.0.161";
import { askRavRadar, QUICK_QUESTIONS } from "./js/services/rav-assistant.js?v=4.0.161";
import { loadAdaptiveModel } from "./js/core/adaptive-model.js?v=4.0.161";
...
// RavRadar 4.0.161: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"4.0.161"; document.querySelector("#appVersion").textContent=version;
