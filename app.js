...
// RavRadar 3.2.0765432: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.2.0765432"; document.querySelector("#appVersion").textContent=version;
