...
// RavRadar 3.1.7: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.1.7"; document.querySelector("#appVersion").textContent=version;
