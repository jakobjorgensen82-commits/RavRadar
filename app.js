...
// RavRadar 3.1.10: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.1.10"; document.querySelector("#appVersion").textContent=version;
