...
// RavRadar 3.1.1765432: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.1.1765432"; document.querySelector("#appVersion").textContent=version;
