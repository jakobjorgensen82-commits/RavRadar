...
// RavRadar 4.0.27: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"4.0.27"; document.querySelector("#appVersion").textContent=version;
