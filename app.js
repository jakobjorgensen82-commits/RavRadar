import { exceptionalScoreMark, scoreRating } from "./js/core/score-engine.js?v=4.0.275";
import { loadConditions, loadConditionDetails, mergeConditionDetails, loadZones, loadDataManifest } from "./js/services/data-service.js?v=4.0.275";
import { getLocalObservations, submitTripEvidenceObservation, syncPendingObservations } from "./js/services/observation-service.js?v=4.0.275";
import { predictAmberChance } from "./js/core/prediction-engine.js?v=4.0.275";
import { consumeAuthCallback } from "./js/services/auth-service.js?v=4.0.275";
import { createMap, installFlowArrows, refreshZoneStyles, renderZones } from "./js/map/map-view.js?v=4.0.275";
import { projectPublicCoastlines } from "./js/map/public-coast-projection.js?v=4.0.275";
import { bindZoneInfoInteractions, showZoneInfo } from "./js/ui/info-panel.js?v=4.0.275";
import { openAccountDialog } from "./js/ui/account-panel.js?v=4.0.275";
import { openDeveloperDialog } from "./js/ui/developer-panel.js?v=4.0.275";
import { askRavRadar, QUICK_QUESTIONS } from "./js/services/rav-assistant.js?v=4.0.275";
import { loadAdaptiveModel } from "./js/core/adaptive-model.js?v=4.0.275";
import { buildLocalZoneScore, selectLocalBestForDay } from "./js/core/local-zone-score.js?v=4.0.275";
import { addNationalRanking, compareNationalRankingRows } from "./js/core/zone-ranking.js?v=4.0.275";
import { createPublicTripEvidenceRuntime } from './js/services/trip-evidence-runtime.js?v=4.0.275';
...
// RavRadar 4.0.275: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"4.0.275"; document.querySelector("#appVersion").textContent=version;
...
function publicTripEvidenceContext(selection = null) {
  ...
  const versionText = String(globalThis.RAVRADAR_VERSION || document.querySelector('#appVersion')?.textContent || '4.0.275');
  const appVersion = versionText.match(/\d+\.\d+\.\d+/)?.[0] || '4.0.275';
  return {
