...
// RavRadar 3.2.2: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.2.2"; document.querySelector("#appVersion").textContent=version;
