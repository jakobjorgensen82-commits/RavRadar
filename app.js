...
// RavRadar 3.2.1: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.2.1"; document.querySelector("#appVersion").textContent=version;
