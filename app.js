...
// RavRadar 3.1.2: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.1.2"; document.querySelector("#appVersion").textContent=version;
