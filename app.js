...
// RavRadar 3.1.8: versionsmanifest + sikker service-worker-opdatering.
function installAppUpdateFlow() {
  ...
  const version=window.RAVRADAR_VERSION||"3.1.8"; document.querySelector("#appVersion").textContent=version;
