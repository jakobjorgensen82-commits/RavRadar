...
import { initializeUserDataSafety } from "./js/services/storage-safety.js?v=4.0.426";
import { initialiseI18n } from "./js/i18n.js?v=4.0.426";
...
await import("./app.js?v=4.0.426");
appImported = true;
performance.mark?.('ravradar:app-imported');
void import("./js/services/visit-counter.js?v=4.0.426")
