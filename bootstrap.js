...
import { initializeUserDataSafety } from "./js/services/storage-safety.js?v=4.0.494";
import { initialiseI18n } from "./js/i18n.js?v=4.0.494";
import "./js/ui/ranking-copy.js?v=4.0.494";
import "./js/ui/score-prognosis-copy.js?v=4.0.494";
...
await import("./app.js?v=4.0.494");
appImported = true;
performance.mark?.('ravradar:app-imported');
void import("./js/services/visit-counter.js?v=4.0.494")
