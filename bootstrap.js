...
import { initializeUserDataSafety } from "./js/services/storage-safety.js?v=4.0.478";
import { initialiseI18n } from "./js/i18n.js?v=4.0.478";
...
await import("./app.js?v=4.0.478");
appImported = true;
performance.mark?.('ravradar:app-imported');
void import("./js/services/visit-counter.js?v=4.0.478")
