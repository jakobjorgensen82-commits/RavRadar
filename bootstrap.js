...
import { initializeUserDataSafety } from "./js/services/storage-safety.js?v=4.0.495";
import { initialiseI18n } from "./js/i18n.js?v=4.0.495";
import "./js/ui/ranking-copy.js?v=4.0.495";
import "./js/ui/score-prognosis-copy.js?v=4.0.495";
...
await import("./app.js?v=4.0.495");
appImported = true;
performance.mark?.('ravradar:app-imported');
void import("./js/services/visit-counter.js?v=4.0.495")
