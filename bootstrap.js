...
import { initializeUserDataSafety } from "./js/services/storage-safety.js?v=4.0.405";
import { initialiseI18n } from "./js/i18n.js?v=4.0.405";
...
await import("./app.js?v=4.0.405");
appImported = true;
performance.mark?.('ravradar:app-imported');
void import("./js/services/visit-counter.js?v=4.0.405")
