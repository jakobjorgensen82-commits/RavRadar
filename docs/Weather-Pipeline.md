...
Workflowen kører ved minut 17 hver time og kan også startes manuelt. Første autentificerede run `#32129799346` ved 2026-08-18 11:00Z bestod og fandt 39 Baltic- samt fire AMM15-par blandt de 51 DMI-huller, altså et kombineret potentiale på 665/673 før regionalproxy. Ingen af de 43 var `surface-only` i dette run. Hvert renset artifact sammenfatter desuden tid-, grid-, lag-, afstands- og dybdestabilitet på tværs af den rullende cache uden rå U/V. Timeplanen er observationsopsamling, ikke produktionsaktivering.
