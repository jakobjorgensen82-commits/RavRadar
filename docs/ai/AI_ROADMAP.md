...
- 4.0.139-kandidaten implementerer flertidsseriegaten som privat metadata-/hashbevis over produktionens native WAM-/DKSS-parser. Efter CI-review er næste gate separat state-/historikvalidering; score, UI, admin og produktion forbliver uændrede.
