...
- Følg de 75 zoner, som først fik verificeret strøm i den afsluttende genopbygning, gennem et fuldt 72-timers vindue. Artifact #2750 viser 35,1 timers rå historik i alle 210 zoner, men afslørede samtidig, at efterberigelsen kun bevarede verifikationsmærket i `samples24h`. 4.0.217 retter begge vinduer fremadrettet; de 75×0, 125×1 og 10×101 verificerede prøver før rettelsen er baseline og må ikke udfyldes bagudrettet.
...
- Kildeskiftene er nu målt mod almindelige nabotimer. Vandstand er stabil; vind og bølger har større grænsespring; fallbackstrøm afviger cirka 90° i gennemsnit fra DMI ved skift; temperaturens sene DMI→fallback-skift er 3,59 °C i gennemsnit. Næste P1-trin er gentagelse over flere uafhængige kørsler og derefter valg af regressionsgrænser – fortsat uden scoreændring.
...
- Vandtemperatur er komplet i 202/210 zoner, mens de samme otte Limfjordszoner mangler samme 15-timershale. 4.0.213 retter det dokumenterede lagproblem: kun DMI-parameter 80 ved `surface:0` må nu drive den viste havoverfladetemperatur, og lagidentiteten bevares. Næste trin er produktionsbevis og derefter overgangsmåling mod fallback; halen og eventuelt scorebrug er fortsat uændrede/åbne.
