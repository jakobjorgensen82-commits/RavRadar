...
- Næste private dataintegritetstrin er implementeret lokalt: hver fuldført time får et deterministisk fingeraftryk af alle 673 centralt hydrerede vandpunkter. Dubletskip kræver både samme time, samme fingeraftryk og samme recordantal. Flyttede punkter eller en legacycache udløser ny indsamling og samlet erstatning af timen; næste gate er CI-bevis og kontrolleret cachemigration.
