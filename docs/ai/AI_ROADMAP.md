...
- Følg den verificerede strøm gennem et fuldt 72-timers vindue. Artifact #2750 viser 35,1 timers rå historik i alle 210 zoner; 4.0.217 bevarer verifikationsmærket i begge vinduer, og 4.0.218 beskytter den aktuelle serie mod et modelskift udløst alene af et sent halepar. Baseline må ikke udfyldes bagudrettet.
...
- Kildeskiftene er nu målt i tre produktionsdatasæt. Vandstand er stabil; vind, bølger, strøm og temperatur har fortsat større grænsespring end almindelige timer, men størrelsen varierer. 4.0.218 indlæste en ny NSBS-modelcyklus, mens HARMONIE, WAM og Limfjorden endnu ikke giver tilsvarende ny cyklusevidens. Næste P1-trin er derfor nye modelcyklusser pr. komponent før valg af regressionsintervaller – fortsat uden scoreændring.
