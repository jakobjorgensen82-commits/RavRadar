...
- 4.0.141-kandidaten gør UI-gaten maskinlæsbar og privat: én aktiv parent-zone beholder sin RavScore-farvede linje, score, klikmål, tooltip og rangering; delene er kun neutrale stiplede, ikke-interaktive forslag uden score eller “bedste del”. Næste gate efter privat artifact- og produktionsverifikation er central admin-roundtrip/rollback.
