...
- #2043 reducerede med dette filter åklynger til 489 og overdense zoner til én kendt partitionskonflikt. #2050 verificerede 755 private multipart-kystdele uden forbindelsesgeometri og lokalitetsflag på 25 zoner/28 dele. 4.0.151 giver balancerede officielle stednavnekandidater til alle 755 dele; næste trin er evidensbaseret lokal opdeling og navnebeslutning, ikke automatisk omdøbning.
