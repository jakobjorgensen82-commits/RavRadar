...
- Vandtemperatur er ligeledes komplet i 202/210 zoner, mens de samme otte Limfjordszoner mangler samme 15-timershale. Feltet vises og historikgemmes, men bruges ikke af aktiv RavScore/state. DMI-temperaturens vertikale niveau er ikke bevaret som komponentidentitet, mens fallbacken er havoverfladetemperatur; dokumentér derfor DKSS-laget og overlapkvaliteten før ethvert haledesign eller scorebrug.
