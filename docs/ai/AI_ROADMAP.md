...
- Samme private rotation måler nu afstanden til nærmeste eksakte fælles U/V-kolonne, også uden for den aktive 5 km-grænse, men gemmer ingen fjerne strømværdier. Den beskyttede ejeroversigt skal skelne et lille optisk 5–8 km-grænsetilfælde fra et strukturelt modelhul over 8 km og fra en pipelinefejl inden for 5 km. Punkter flyttes aldrig automatisk, og modelhuller må ikke “løses” ved at flytte et fysisk korrekt kystpunkt flere kilometer.
...
- #2853–#2855 beviser semantik v2 med 187/210 verificerede hovedzoner, 596/673 lokale dele og nul kendt pil/grid-mismatch blandt verificerede poster. De resterende poster er `null` uden pil. #2859 beviste LRU-gabet; #2863 bootstrap-hentede tre marine replayfiler/29,8 MB og voksede 58→73 dele, mens #2864 genbrugte dem med nul download og voksede 73→88 dele. Begge flyttede cursoren 15 og bevarede privat/score-neutral isolation. Forskningsrotationen er derfor CI-verificeret. Den uændrede geografiske gate stopper fortsat deploy, så 4.0.229 må ikke kaldes produktionsverificeret.
