...
- Kildeskiftene er nu målt i tre produktionsdatasæt. Vandstand er stabil; vind, bølger, strøm og temperatur har fortsat større grænsespring end almindelige timer, men størrelsen varierer. 4.0.217 og 4.0.218 ligger kun 37 minutter fra hinanden, så næste P1-trin er flere uafhængige forecastcyklusser før valg af komponentvise regressionsintervaller – fortsat uden scoreændring.
