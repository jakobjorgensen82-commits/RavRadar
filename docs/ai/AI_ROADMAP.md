...
- #1982 ortofotoverificerede 4.0.136-hårnålsrettelsen, og #1981 produktionsverificerede hele releasekæden. 4.0.137-kandidaten implementerer næste private gate direkte mod native WAM-/DKSS-GRIB med produktionslogikken; CI-artifactreview mangler. Det er validering, ikke sampling eller aktivering.
