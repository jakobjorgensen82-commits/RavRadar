...
- **Resterende kystarbejde:** De seks hovedzoner uden godkendt præcisionsforløb bruger fortsat deres sikre gamle hovedlinje. Admin kan flytte eksisterende verificerede kystdele mellem hovedzoner og slette en zone, men kan endnu ikke selv tegne en helt ny præcis kystdel eller forlænge ind i et område, som ikke allerede findes som en verificeret del. Nye/ændrede dele kræver fortsat geometri-, overlap-, land-/vandpunkt-, DMI- og offentlig runtimekontrol.
