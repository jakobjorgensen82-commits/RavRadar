...
- #1959 verificerede 4.0.133 med 72 private forslag, officielle fjord-/norpolygoner, ni zonekort og reviewgate; #1958 verificerede den fulde produktionskæde. #1964 produktionsverificerede 4.0.134, og privat pilot #1967 verificerede Blåvand som to dele omkring det officielle hukpunkt med 15-meters landsideforskydning, punktpar og score-neutrale høfter. 4.0.135-kandidaten etablerer tre private officielle ortofoto-overlays; næste gate er CI-fetch og visuelt review, derefter DMI-grid, ikke aktivering.
