...
- Et roterende privat forskningslag genbruger eksisterende DKSS-GRIB ved 0, 5 og 15 km søværts og bevarer flere lag i højst 168 timer. Rotationens næste 15 kystdele behandles også på almindelige kørsler med uændret model ved isoleret genlæsning af allerede cachede GRIB-filer. Ved 15-minutters cadence besøges alle 673 dele på 45 kørsler, cirka 11 timer og 15 minutter. Det påvirker hverken RavScore eller offentlig runtime og udløser ingen ekstra DMI-download.
