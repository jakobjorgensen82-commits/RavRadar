...
- 4.0.138-kandidaten implementerer dette design som en maskinlæsbar privat shadow-kontrakt: stabile partserie-ID'er, egne provenancekrav, separate historiknøgler og eksplicit isolation fra parent-score, public runtime og admin-write. Efter CI-review følger en privat flertidsserie-gate; ingen aktivering.
