...
- #2853–#2855 beviser semantik v2 med 187/210 verificerede hovedzoner, 596/673 lokale dele og nul kendt pil/grid-mismatch blandt verificerede poster. De resterende poster er `null` uden pil. #2859 beviste, at første replayforsøg ikke fandt en tidsrelevant marine råfil, fordi den fælles 4 GB-LRU ikke prioriterede forskningsreplay. DMI's aktuelle objekt-URL er efterkontrolleret som stabil; cache-ID-normalisering er kun ekstra robusthed. Manifest, marine retention og bootstrap afventer frisk CI. Den uændrede geografiske gate stopper fortsat deploy, så 4.0.229 må ikke kaldes produktionsverificeret.
