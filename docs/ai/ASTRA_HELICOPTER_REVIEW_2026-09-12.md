...
Første PR #281-sourcegate `34680013012` bestod releasegaten og stoppede senere på en stale statisk WAM-test for de gamle direkte exitlinjer. Test-only-opfølgningen følger terminalhelperen og er grøn 63/63; produktionsdesignet ovenfor er uændret. Den nye branch-head skal have en ny exact-head-gate.
