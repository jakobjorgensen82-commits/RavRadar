...
- PR #106 bestod exact-head `32652894729`, blev merged som `23fa89ed`, og produktion `32652970105` bestod frisk data, fuld validering, releasegate og Pages. Live `rr-20260823165645-210` er 4.0.264 på 210/673. Konto-/loginforklaring, direkte tur uden GPS/rute og offentlig tekst er browserkontrolleret. Den fulde 420/2.100/673-audit er grøn efter en lokal testrettelse fra den gamle etiket `3-timers trend` til den viste almindelige etiket `Vandstandsændring på 3 timer`; branch `codex/fix-live-browser-audit` skal føre denne auditrettelse til main.
