...
- **Aktuel 4.0.263-kandidat:** DEC-0062 retter profilgatens referencescope. Memory-/warmup-aktivering bedømmes ved den nærmeste fælles aktuelle scoretid pr. zone; senere prognosegaps må ikke retroaktivt slå den aktuelle Candidate G fra.
...
- Hele femdøgnets Candidate G-scorecoverage kræves fortsat. Målrettede tests og samlet lokal source-/RDKS-/releasegate er grønne; exact-head, frisk 4.0.263-produktion, aktiv 210/673-shadow og fuld browserkontrol afventer ved dette checkpoint.
