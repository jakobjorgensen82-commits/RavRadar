...
- Måltests, 4.0.323 docs/version/RDKS, bundles, migration og den fulde releasegate er grønne. Source-wrapperen fandt bagefter kun en stale namespace-reference i Copernicus range-checkeren; énlinjerettelsen og måltesten er grøn. Ejeren stoppede lokal fuld gentagelse for at spare tid. Næste: commit/push → én fuld GitHub exact-head → merge → genmål safe fetched/missing og rapportér → start ejerautoriseret stor main-oneoff → følg til terminalt resultat.
