...
- Første schedule-run #32134686185 var grønt ved 12:00Z, men havde kun én rå tid, fordi 11:00Z-cachen var LRU-fortrængt. Cacheforbruget var cirka 10,2 GB med flere 2,5 GB DMI-cacher. Implementér/push den nye credentialfri restore-only keepalive hvert tiende minut, verificér dens cachehit, og genhent derefter 11:00Z via det citerede `sample_time`-input. En rå artifactløsning er forkastet, fordi repoet er offentligt.
