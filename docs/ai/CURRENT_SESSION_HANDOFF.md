...
- Ny lokal kandidat binder hver Copernicus-time til et deterministisk SHA-256-fingeraftryk af alle aktuelle centralt hydrerede vandpunkter og et eksakt recordantal. Samme time med flyttet punkt, legacycache eller ufuldstændigt manifest hentes igen og erstattes samlet. Målrettede tests er grønne; commit/push og central cachemigration mangler.
