...
- Næste sikre rækkefølge: afslut målrettede dokumentationsgates → push samlet remediation til PR #235 → ny exact-head → merge → frisk fuld produktion/releasegate/artifact/Pages → Feggesund 3 × 118 → offentlig 210/673/current/fem døgn/desktop/mobil. Ingen påstand om empirisk bedre fundpræcision.
