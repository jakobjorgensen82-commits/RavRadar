...
- Lokale bundle-hashes er nu integrated `978415fd2b0a739b80b71c78134a79101113481817212811644b24262b6ddbd9` og Candidate G-rollback `4ccc2081982677aadbb47a5ee7d6f2b99fdcb7e42113e73029d5c60323a5ee96`.
- Candidate G er fortsat offentlig. Den opdaterede exact-head-, merge-, friske 4.0.318-produktions- og offentlige desktop-/mobilbrowserkæde udestår fortsat og må ikke overclaims.
...
- 118h `HISTORY_INCOMPLETE` vs timevis direct-missing `UNAVAILABLE` er bindende. Outcome-v2 og P2 Spørg RavRadar/DA-DE-EN plain language er lokalt slutgrønne. Orchestrator/build/deploy-rollen, 40 reader-migrationer, workflow-action-contracts, public-integrated 210/673 + 78 browsermoduler, profil/cutover og 8-consumer-binding er grønne; ingen P0/P1-reviewfund. Assistentens state-6-fixture er nu i `validate:source`. Integrated slutbinding er `778db7aa3946f925607a8304daa42ed17dd30294e4a51bf6d895d7293e84c4e7`/`978415fd2b0a739b80b71c78134a79101113481817212811644b24262b6ddbd9` over 43 filer/8 consumers; Candidate G-rollback er `c73dac1b4376005e792580791d84eb79c9370e905a2a7fd0bdee857506a20cf8`/`4ccc2081982677aadbb47a5ee7d6f2b99fdcb7e42113e73029d5c60323a5ee96` over 55 filer. Derefter fuld sourcegate, exact-head, merge, frisk state-6-produktion, Feggesund 3 × 118 og offentlig desktop/mobil.
...
## AKTUELT MODELHANDOFF – 4.0.318 first-cutover-hærdning; Candidate G er fortsat offentlig
...
- Root cause var treleddet: migration-only-resolveren afviste legitim warmup; historisk source-state og nyere active registry var ikke separeret; Node `.000Z` matchede ikke Python-parserens UTC-format. 4.0.318 retter alle tre samlet under DEC-0113.
...
- Åbent: afslut målrettede aggregate/hydration/recovery/rollback/DMI/workflowtests og RDKS, bevar den regenererede endelige modelbinding, luk 4.0.318/geodatabevis, egen exact-head/merge, frisk fuld produktion/releasegate/artifact/Pages, Feggesund 3 × 118 og offentlig 210/673/current/fem døgn/desktop/mobil. Ingen empirisk bedre fundpræcision må påstås.
...
- Historisk 4.0.317-bevis: den daværende proportionale matrix var grøn. Det er ikke et aktuelt 4.0.318-slutbevis efter historical/recovery/outcome/P2-deltaet.
...
> **Historikregel:** Alle sektioner mærket **HISTORISK** er kun revisionsspor og må ikke læses som aktuelle driftsordrer. Den aldrig anvendte DEC-0109-operation er trukket tilbage af DEC-0111; intet nyt reconstruction-D1, inspect, apply, rollback eller cleanup må udføres. 4.0.318-handoffet øverst styrer modelarbejdet; 4.0.316-afsnittet nedenfor er den offentlige produktionsbaseline.
