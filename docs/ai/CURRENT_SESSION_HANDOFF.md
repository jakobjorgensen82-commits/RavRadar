...
- **Provider/cache:** DMI/Copernicus/Open-Meteo salvages per proof-enhed; control plane/topidentitet/target/registry er fatal. Nyeste verificerede tuple vinder atomisk efter DMI → Baltic → AMM15 → policyregional DMI → Open-Meteo; fallback kildelåser ikke.
