...
- Målrettede kontrakt-, observation-, turlog-, versions- og syntakstests er grønne. Første PR exact-head `32658093582` stoppede før merge på et efterladt 4.0.264-versionsmærke i Candidate G-profilomskifteren. Anden exact-head `32658348688` bekræftede versionsrettelsen og hele kontoindberetningen, men fandt to manglende, allerede vedtagne forklaringssætninger i webhåndbogen. Webhåndbogen er synkroniseret; ny exact-head og produktion udestår. En rigtig autentificeret indsendelse skal senere udføres bevidst af ejeren, fordi den opretter en virkelig række.
