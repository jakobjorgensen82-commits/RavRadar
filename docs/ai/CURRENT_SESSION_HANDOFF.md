...
- Næste sikre rækkefølge: afslut dokumentationsgates → PR exact-head → merge → frisk fuld produktion/releasegate/artifact/Pages → Feggesund 3 × 118 → offentlig 210/673/current/fem døgn/desktop/mobil. Ingen påstand om empirisk bedre fundpræcision.
