...
- Produktionsrun `#32158041877`/support `#3127` bestod derefter hele kæden med 622 DMI + 43 Copernicus + 8 regionalproxy = 673/673, fuld validering, releasegate, Supabase, Pages-artifact og deploy. Datasæt `rr-20260818160548-210` er live; `public-conditions.json` matcher manifestet byte- og SHA-256-præcist (`aa05a23795a4a1b232ef30274746acaad373fb9512572c1a8d4ec2b1d5e67ca3`). Den offentlige syvdøgnshistorik har ved første release 1.915 poster, 633 dele og syv tider; credentials er ikke med.
