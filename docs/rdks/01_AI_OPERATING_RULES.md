...
- Kør den releasegate, som ændringen kræver. Normal frisk produktion følger DEC-0184s 52 artifactkontroller, tre version-/modelbindingskontroller og hårde runtime-/privacy-/artifact-/deploytrin. Fuld historisk validate/releasegate bruges målrettet eller periodisk, ikke automatisk efter hver vejrindsamling.
