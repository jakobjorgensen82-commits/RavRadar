...
- Resterende gates: samlet remediationpush → ny PR #235 exact-head → merge → frisk fuld produktion/releasegate/artifact/Pages → Feggesund 3 × 118 → offentlig 210/673/current/fem døgn/desktop/mobil. Candidate G forbliver eneste offentlige model indtil da.
