...
- #2855 afdækkede, at cursoren ikke gik videre på `unchanged-valid`. Første replayforsøg #2859 beviste yderligere, at den fælles 4 GB-LRU ikke havde bevaret en tidsrelevant marine replayfil: cursor 90, 491 prøver/58 dele, nul replayassets. DMI's aktuelle STAC-href er efterkontrolleret som stabil. Den lokale efterrettelse bruger privat manifest, prioriteret marine retention, objektsti-baseret cache-ID som fremtidssikring og en begrænset bootstrap på højst én fil pr. modelområde/tre pr. kørsel. Behandlingen er fortsat isoleret fra offentlig output og score. Frisk CI skal bevise cursor- og delvækst.
...
1. Følg den første CI-kørsel med stabil cacheidentitet/retention/bootstrap og kræv `rotationAdvancedThisRun=true`, mindst ét `cachedReplayAssetsThisRun`, `reason=completed` og flere end 58 dækkede dele. Første kørsel må have højst tre bootstrapdownloads; næste uændrede kørsel skal genbruge den bevarede fil med nul bootstrapdownload.
