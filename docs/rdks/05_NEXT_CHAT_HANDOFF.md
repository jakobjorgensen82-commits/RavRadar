...
**Aktuel appversion:** 4.0.156 (national native DMI-gridgate lokalt implementeret; afventer privat CI)
...
1. Kør og artifact-verificer 4.0.156's native DMI-grid/proveniens for 774 valgte vandpunkter og begge normalalternativer for de ni blokerede dele.
