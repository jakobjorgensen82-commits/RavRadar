...
**Aktuel appversion:** 4.0.155 (774/783 private punktpar; ni fail-closed til native DMI-gridreview)
...
1. CI-verificer 4.0.155's 774 punktpar og de ni blokerede dele på det friske nationale artifact.
2. Kør native DMI-grid/proveniens for alle foreslåede vandpunkter og begge normalalternativer for de ni blokerede dele.
