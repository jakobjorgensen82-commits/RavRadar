...
- Bevar ekstern cron som primær dispatcher og eksisterende GitHub schedules som reserve; ændr ikke cadence. Den målrettede lokale matrix er grøn. Run `33986893042` nåede alle kode-/kontrakttests, men releasegaten fejlede alene på manglende `CHANGELOG-4.0.324.md`; changelog/status-only-opfølgningscommitten er lokalt målvalideret. Ejeren har 2026-09-05 eksplicit beordret admin-merge uden ny exact-head. 4.0.324 må derfor ikke kaldes exact-head-grøn. Efter admin-merge: mål safe fetched/missing, verificér bootstrap/runtime og fuld produktionsgate, start én stor main-oneoff og overvåg candidate-save, promotion, fallbackclosure og normal catch-up. Komplet 210/673/118 er fortsat åbent.
