...
**Status:** IMPLEMENTERET OG FULDT KILDEVALIDERET LOKALT; exact-head, frisk produktion, shadow og browserkontrol afventer
...
4. DEC-0060's ejeraccepterede pre-public opvarmning må kun bruge `WINDOW_INCOMPLETE`, altså et kort, men ellers sammenhængende vindue. `LATEST_SAMPLE_MISSING`, `WINDOW_HAS_MISSING_EVIDENCE` og `WINDOW_HAS_TIME_GAP` er ikke opvarmning og udløser global rollback til legacy.
...
P0 er først produktionslukket, når 4.0.262 har bestået:
...
- Ingen geometri, land-/vandpunkter, bund-/dybdemodel, private caches, artifact eller protected-dirty-data ændres. Geodatafiler må kun få versionsfeltet 4.0.262.
