...
8. Deploy må ikke overskrive godkendte centrale ekspertændringer i håndbogen. Den officielle kilde og den centrale håndbog trevejsflettes mod sidste kildebaseline. Ved den første overgang, hvor den lagrede baseline endnu ikke findes, må den sidste centralt synkroniserede 4.0.269-kilde fra den uforanderlige commit `fc13fb5ab326d8824ca55235ac454ac230e3db3e` kun bruges som baseline, når dens SHA-256 matcher det tidligere beskyttede manifest. Committen blev produktionsgrøn i `32706573863`; kan den ikke hentes eller verificeres, stopper synkroniseringen sikkert.
...
- PR #124 bestod exact-head `32726897134`, blev merged som `fd7bc868`, og produktion `32727025187` bestod alle øvrige gates. Hashkontrollen stoppede før deploy og beviste, at den første 4.0.269-merge ikke var den sidste centralt synkroniserede håndbog; dokumentationsmerge `fc13fb5a` er den korrekte immutable baseline.
