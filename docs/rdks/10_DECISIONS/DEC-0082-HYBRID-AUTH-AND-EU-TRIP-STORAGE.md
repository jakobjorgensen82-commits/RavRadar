...
**Status:** Ejerbesluttet, implementeret og produktionsverificeret i 4.0.287. Auth-, HMAC-, EU-, shard-, dataminimerings- og kapacitetsdelene gælder fortsat. DEC-0109's 4.0.311-protokol er exact-head-valideret og merged via PR #224, men er ikke backend-/live-/offentligt verificeret: run `33263892151` stoppede efter den atomiske Supabase-CHECK-migration og før D1/Edge på en katalogverifierfejl. Lokal 4.0.312 er den eneste tilladte roll-forward; offentlig produktionssandhed er fortsat 4.0.310. Driftspræciseringen af 27. august 2026 gør Supabase-PAT'et behovsstyret i stedet for kalenderroteret.
...
## DEC-0109-tillæg – 4.0.311-protokol med lokal 4.0.312-roll-forward

Dette tillæg ændrer ikke DEC-0082's identitets- eller dataplacering. Det hærder den tværgående storagekontrakt, som 4.0.311-kandidaten kræver:
...
5. Den samme aktuelle `origin/main` genbekræftes umiddelbart før hver ekstern skrivefamilie. Første Pages-build med denne kontrakt skal være 4.0.312 og må kun bygges efter et eksakt-head-bundet succesbevis fra D1-kæden; et manglende bevis giver no-op uden artifact/deploy. Trust-/tripprotokollens kompatibilitetsgrænse forbliver 4.0.311.

Alle fem punkter blev exact-head-valideret på PR #224 (`33263734108`/`99129959870`) og merged som `7c168b00af535415117c968a8c021a493b083137`. Push `33263858078` var korrekt no-op. Backend `33263892151`/`99130384780` modtog HTTP 201 for den atomiske CHECK-transaktion, men fejlede den efterfølgende katalogverifier før D1/Edge/Worker/sync; constraintsituationen er enten fuldt committed/valideret/kommenteret eller fuldt rullet tilbage. PostgreSQL kan have scannet rækker internt under `VALIDATE`, men ingen observationspayload blev hentet til runneren eller logget, og der skete ingen rækkemutation. 4.0.312's strukturelle deparser-tolerante verifier, fulde lokale source/release/RDKS/håndbog/version og geodatakontrol er grønne; PR exact-head, merge, backendgenkørsel og offentlig verifikation mangler.
