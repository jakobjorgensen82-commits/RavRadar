...
**Status:** Ejerbesluttet, implementeret og produktionsverificeret i 4.0.287. Auth-, HMAC-, EU-, shard-, dataminimerings- og kapacitetsdelene gælder fortsat. DEC-0109's 4.0.311-protokol er merged; 4.0.312 bestod PR #225 og blev merged som `a5ece10d`, men backend `33266229687` fejlede legacy-replay under sync og er ikke readiness. Lokal 4.0.313 er den eneste tilladte roll-forward; offentlig produktionssandhed er fortsat 4.0.310. Driftspræciseringen af 27. august 2026 gør Supabase-PAT'et behovsstyret i stedet for kalenderroteret.
...
De fem grundpunkter blev exact-head-valideret på PR #224. 4.0.312 bestod derefter PR #225 exact-head `33266087776`/job `99136292810`, blev merged som `a5ece10d`, og push `33266184326` var korrekt no-op. Backend `33266229687`/`99136669571` nåede D1/Edge/Worker, men fejlede idempotent sync. 4.0.313's migration-only legacykompatibilitet fjerner kun kendte nullblade efter streng stored schema/privacy, kræver eksakt non-null/core/ejer/id/shard og bevarer row/hash/registry byteidentisk. Målrettede syntetiske tests er grønne; exact-head, helt grøn backend og offentlig verifikation mangler.
