...
- **Status:** Aktiv lokal 4.0.320-releasekandidat, numerisk udvidet til state 6 af DEC-0112 og operationelt præciseret af DEC-0114 samt tillægget 2026-09-03 nedenfor. Tofaselåsen er lokalt implementeret og måltestet, men ikke commit'et, pushet, exact-head-verificeret, merged eller live. Fase A skal først merge koden med Candidate G fortsat offentlig; 673 × 118, Feggesund, Supabase-kapacitet, særskilt manuel Fase B, frisk produktion og offentlig desktop-/mobilverifikation mangler. Candidate G/4.0.316 er fortsat eneste offentlige model
- **Dato:** 2026-08-29
- **Ejer:** RavRadar
...
Implementeringen findes kun lokalt i 4.0.320-worktreeet. Den er ikke commit'et, pushet, merged, aktiveret eller offentligt verificeret. Candidate G er fortsat offentlig. Ændringen ligger uden for begge RavScore-bundles; model-/kontrakthashes, geometri og land-/vandpunkter er uændrede.
