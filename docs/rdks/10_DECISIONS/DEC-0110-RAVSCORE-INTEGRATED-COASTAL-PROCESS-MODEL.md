...
- **Status:** Aktiv lokal 4.0.319-releasekandidat, numerisk udvidet til state 6 af DEC-0112 og operationelt præciseret af DEC-0114. Integrated-first measured warmup, checkpoint-N/A, state-less recovery, schema-3-currentseal og kalibreringslås er lokalt implementeret og måltestet; exact-head, 118-timers data-preflight, merge, frisk produktion, Feggesund 3 × 118 samt offentlig desktop-/mobilverifikation mangler. Candidate G/4.0.316 er fortsat eneste offentlige model
- **Dato:** 2026-08-29
- **Ejer:** RavRadar
