...
- **Status:** Aktiv lokal 4.0.318-releasekandidat, numerisk udvidet til state 6 af DEC-0112. Målrettede controller-/historical-maintenance-/recovery-/workflowtests er grønne; fuld slut-sourcegate, kandidatens exact-head, merge, frisk produktion, Feggesund 3 × 118 samt offentlig desktop-/mobilverifikation mangler. Candidate G/4.0.316 er fortsat eneste offentlige model
- **Dato:** 2026-08-29
- **Ejer:** RavRadar
