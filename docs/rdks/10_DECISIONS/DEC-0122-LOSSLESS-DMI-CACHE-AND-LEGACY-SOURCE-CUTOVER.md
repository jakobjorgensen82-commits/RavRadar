...
4. DMI-dokumentet lagres tabsfrit med tre deduplikerede source-tabeller og strenge referencer. Den logiske schema-2-visning rekonstrueres identisk. Legacy-JSON kan læses på en afgrænset migrationsvej; nye writes er atomiske og kompakte. Alle Python- og Node-læsere bruger den fælles codec, mens bytebaserede integritetshashes fortsat hashes over den faktisk lagrede fil.
