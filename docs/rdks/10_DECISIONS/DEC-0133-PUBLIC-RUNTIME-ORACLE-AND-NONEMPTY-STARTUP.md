...
PR #288's første head `debb745f` bestod releasegate samt model-, runtime- og migrationskontrollerne i sourcegate `34736227522`, men stoppede efterfølgende på en manglende identisk Supabase-installationskopi af den opdaterede webhåndbog. Det var en dokumentationspakningsfejl, ikke en score- eller runtimefejl. Kopien er synkroniseret med projektets eksisterende script, aktive model-/continuationbindinger er ajourført i webhåndbogen, og de to direkte håndbogstests er grønne. Den nye head kræver en ny exact-head-gate.
