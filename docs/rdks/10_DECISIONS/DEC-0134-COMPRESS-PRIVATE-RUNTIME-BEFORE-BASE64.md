...
Fortsættelsen er en engangskontrakt for exact `34738698219`/attempt 1/`099b70a8…` og target `2026-09-12T08:00:00Z`. GitHub skal live bekræfte de otte grønne sluttrin, fejlen præcis ved kapacitetsmålingen og at ingen artifact/handoff blev dannet. Kun de fire fastlåste DMI-, regionale, Copernicus- og Open-Meteo-cacher må gendannes. Den fulde 210/673-audit og alle providerproducenter er forbudt i fortsættelsesjobbet; den flygtige closure/private runtime må genskabes, fordi den gamle runner er slettet. Kapacitetsmåling og handoff springes ikke over. Jobbet kan ikke cutte over eller deploye; den efterfølgende consumer beholder alle fulde gates.
