...
- **REQ-STATION-003 – IMPLEMENTERET I 4.0.95:** Adminoverride erstatter automatik, når override kan levere efter de valgte krav. Admin viser de faktiske afstandsvægte for de valgte stationer og skelner mellem automatisk valg, administratorvalg, begge valg og udfasede stationer.
