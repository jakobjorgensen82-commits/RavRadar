...
- **REQ-GEO-031 – AKTIV PRODUKTBESLUTNING / MARGIN AFVENTER SHADOW-DATA:** Dækningsforklaringen må ikke være krakilsk. Små forskelle, eksplicit eksempel 78 mod 75, behandles som praktisk hele zonen uden delopdeling. Kun en væsentlig, fagligt valideret forskel udløser navngiven delvis dækning; 5 point er foreløbig kun en justerbar reviewprototype.
