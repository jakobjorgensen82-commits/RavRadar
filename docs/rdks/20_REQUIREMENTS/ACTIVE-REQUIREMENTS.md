...
- **REQ-GEO-047 – RETTET LOKALT I 4.0.157 / AFVENTER PRIVAT CI:** Alle valgte vandpunkter og begge alternativer for blokerede dele skal testes på de relevante aktuelle native WAM-/DKSS-modelområder ud fra centralt hydreret `coastType`, med produktionens nearest-valid-regler og fælles fysisk current-U/V-celle. Et tvivlstilfælde må kun løses automatisk, når præcis ét alternativ består; ellers forbliver det blokeret. Rapporten må ikke indeholde rå vejrserier eller aktivere runtime.
