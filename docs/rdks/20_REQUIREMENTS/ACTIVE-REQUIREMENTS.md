...
- **REQ-GEO-065 – IMPLEMENTERET LOKALT I 4.0.206 / AFVENTER FULD PRIVAT CI:** Den private fallbackslutkontrol skal kunne starte på en ren runner og efter en tidligere aktivering. Den skal selv oprette alle outputmapper, bruge centralt aktive naborester når oprindelige ID'er er erstattet, bevare eksisterende validerede land-/vandpunkter og afledt retning eksakt samt stoppe ved manglende retning. Kandidatbundet ekstern evidens, DMI, overlap, ejerskab, erstatning og artifacts skal fortsat bestå før ejerreview.
