...
- **REQ-GEO-051 – IMPLEMENTERET / 4.0.166 AFVENTER CI:** En lokal del må ikke indgå i shadow-score uden egen native HARMONIE-vindserie. Wind-U/V skal komme fra samme fysiske celle ved mindst to forecasttrin, ligge inden for eksisterende kysttypeafstand og bære fuld provenance. Fire native celler prøves først for alle; udvidet søgning må kun genkøre faktiske gab. Parentfallback, interpolation og råværdier i artifact er forbudt.
