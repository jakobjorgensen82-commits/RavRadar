...
- **REQ-GEO-047 – IMPLEMENTERET LOKALT I 4.0.156 / AFVENTER PRIVAT CI:** Alle valgte vandpunkter og begge alternativer for blokerede dele skal testes samlet på aktuelle native WAM- og DKSS-celler med produktionens nearest-valid-regler og fælles fysisk current-U/V-celle. Et tvivlstilfælde må kun løses automatisk, når præcis ét alternativ består; ellers forbliver det blokeret. Rapporten må ikke indeholde rå vejrserier eller aktivere runtime.
