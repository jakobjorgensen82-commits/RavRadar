...
- **REQ-GEO-043 – IMPLEMENTERET LOKALT I 4.0.151 / AFVENTER PRIVAT CI:** Officielle stednavnekandidater skal hentes for de faktiske nationale kystdele via den nøglefri officielle kilde og den central-hydrerede fliseplan. Hver del skal få balanceret direkte kyst-, bebyggelses-, havne- og øvrig kontekst med ID, status og afstand; kandidatloft og aggregerede summer valideres. `proposedName`, automatisk omdøbning og aktivering skal forblive falske/null.
