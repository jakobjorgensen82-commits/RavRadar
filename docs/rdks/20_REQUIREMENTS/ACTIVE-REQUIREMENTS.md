...
- **REQ-GEO-041 – IMPLEMENTERET LOKALT I 4.0.149 / AFVENTER PRIVAT CI:** Maskeret national topologi skal grupperes til private kystdele uden nogen konstrueret forbindelseslinje. Alle 208 zoner skal have entydig status; del-ID'er skal være stabile, navne må ikke opfindes, og punkter/sampling/state/score/aktivering skal forblive falske.
