...
- **REQ-GEO-032 – AKTIV NATIONAL BESTILLING / IKKE ENDNU AKTIVERINGSKLAR:** Kystgeometri-v2, stedbaserede lokale delnavne, lokale datapunkter og dækningsvisning skal bygges for hele Danmark, ikke som en permanent Blåvand-specialløsning. National offentlig aktivering kræver fortsat genereret og valideret central-admin-hydreret geometri, topologi, navne, DMI/proveniens, state, UI, rollback og releasebevis for den nationale bestand.
