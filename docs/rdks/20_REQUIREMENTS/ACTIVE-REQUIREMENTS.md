...
- **REQ-GEO-039 – IMPLEMENTERET LOKALT I 4.0.147 / AFVENTER PRIVAT CI:** En zone med flere end 20 målte åmundingsklynger må ikke få åmasker anvendt; den skal markeres oversegmenteret. Artifactet skal indeholde en aggregeret profil af scalar-egenskaber og højst 200 geometri-frie diagnostiske inputposter, så den nationale regel kan skærpes evidensbaseret.
