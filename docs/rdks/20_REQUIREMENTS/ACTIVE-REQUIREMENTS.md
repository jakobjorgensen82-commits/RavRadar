...
- **REQ-GEO-051 – IMPLEMENTERET LOKALT I 4.0.163 / AFVENTER PRIVAT CI:** En lokal del må ikke indgå i shadow-score uden egen native HARMONIE-vindserie. Wind-U/V skal komme fra samme fysiske celle ved mindst to forecasttrin og bære provider, collection, modelrun, native tid og gridpunkt. Parentfallback, interpolation og råværdier i artifact er forbudt.
