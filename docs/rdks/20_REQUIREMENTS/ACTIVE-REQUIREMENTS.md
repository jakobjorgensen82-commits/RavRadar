...
- **REQ-GEO-047 – PRÆCISERET LOKALT I 4.0.158 / AFVENTER PRIVAT CI:** Alle vandkandidater testes på relevante native WAM-/DKSS-modelområder ud fra central `coastType`. Mindst én komplet havmodelfamilie er tilstrækkeligt vand/gridbevis; fuld vejrdækning kræver begge familier, og mangler må aldrig blive nul. Et tvivlstilfælde løses kun ved præcis ét gyldigt alternativ. Rapporten må ikke indeholde rå vejrserier eller aktivere runtime.
