...
- **REQ-SCOPE-001 – BINDENDE, DEC-0036:** Det aktive kystarbejde må kun ændre `DK-B07-19`, `DK-B08-12`, `DK-B08-18`, `DK-B08-19`, `DK-B10-14` og `DK-B10-16` samt det direkte nødvendige adminforløb for trækbar kyststreg, automatisk følgende zoneafgrænsning, viskelæder og samlet data-/punktkontrakt. Landsdækkende genopbygning eller ændring af fungerende geometri kræver en ny, udtrykkelig ejerbeslutning før kode eller CI-kørsel.
