...
- **REQ-GEO-046 – IMPLEMENTERET LOKALT I 4.0.155 / AFVENTER PRIVAT CI:** Et lokalt land-/vandpunktpar må kun foreslås, når et officielt landvidne og et officielt Farvand-vidne eller zonens centralt hydrerede marinepunkt beviser modsatte sider af den lokale kystnormal. Tvivl skal give null-punkter, maskinlæsbar blokering og to neutrale normalalternativer til efterfølgende native DMI-gridreview. Sampling, state, score og aktivering forbliver falsk.
