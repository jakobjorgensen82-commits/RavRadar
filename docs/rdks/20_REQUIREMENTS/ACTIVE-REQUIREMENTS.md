...
- **REQ-GEO-051 – IMPLEMENTERET / #2164 FANDT HARBO ODDE-CELLEGAB / 4.0.165 AFVENTER CI:** En lokal del må ikke indgå i shadow-score uden egen native HARMONIE-vindserie. Wind-U/V skal komme fra samme fysiske celle ved mindst to forecasttrin, ligge inden for eksisterende kysttypeafstand og bære provider, collection, modelrun, native tid og gridpunkt. Den private gate må udvide native kandidatsøgning, når fire nærmeste celler er missing, men parentfallback, interpolation og råværdier i artifact er forbudt.
