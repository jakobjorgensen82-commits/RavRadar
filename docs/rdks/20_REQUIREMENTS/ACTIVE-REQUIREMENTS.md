...
- **REQ-CURRENT-FIELD-SHADOW-001 – AKTIV:** Privat forskningsopsamling må højst bevare 168 timer, genbruge eksisterende DKSS-GRIB, holde rå vektorer ude af offentlig runtime og være teknisk markeret `scoreImpact=false`. Den geografiske 15-delsrotation skal også kunne gå videre på et uændret modelrun ved isoleret genlæsning af allerede cachede, tidsrelevante GRIB-filer; den må ikke downloade ekstra eller skrive offentlig zonecache.
