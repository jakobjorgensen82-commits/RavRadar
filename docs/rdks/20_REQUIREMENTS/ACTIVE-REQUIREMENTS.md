...
- **REQ-GEO-016 – IMPLEMENTERET LOKALT / AFVENTER CI-PILOT:** GeoDanmark hentes kun i et særskilt manuelt valgt, privat og score-neutralt workflowjob. Jobbet skal hydrere central admingeometri/tombstones før fetch, læse `DATAFORDELER_API_KEY` kun fra GitHub Secrets, aldrig skrive nøgle eller request-URL med nøgle til filer/logs/artifacts og må ikke have Pages-skriverettigheder.
