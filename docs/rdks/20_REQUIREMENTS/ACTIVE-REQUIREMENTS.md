...
- **REQ-GEO-037 – IMPLEMENTERET LOKALT I 4.0.145 / AFVENTER PRIVAT CI:** Det private nationale job skal bevare det fulde råartifact og samtidig udgive plan, manifest og 208-zone-QA som et særskilt kompakt privat artifact, så efterfølgende audit ikke kræver download af hele råpakken.
