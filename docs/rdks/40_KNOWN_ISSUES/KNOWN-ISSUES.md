...
- **ISSUE-COASTAL-PART-HISTORY-COLLISION – BLOKERET I 4.0.140-KANDIDAT / AFVENTER CI:** Produktionens historik slås op ved zone-ID. Direkte delintegration kunne derfor genbruge parent- eller nabodelens samples. Den private replaygate kræver unikke `historyKey`-nøgler og afviser parent-genbrug/krydslæsning; ingen state er aktiveret.
