...
- **ISSUE-MULTI-ANCHOR-SAMPLING-GAP – AKTIV / PUNKTGATE 4.0.155:** Admin og scoreforklaring understøtter flere lokale retningsankre, men den almindelige vejrproduktion bygger fortsat primært én zoneserie. 774/783 private punktpar har modsat-side-evidens; ni er blokeret til DMI-review. Ingen må markedsføres som forskellig lokal vind/strøm, før native sampling og provenance er implementeret pr. kystdel.
