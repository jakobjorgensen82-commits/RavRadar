...
- **ISSUE-MULTI-ANCHOR-SAMPLING-GAP – AKTIV / DMI-GRIDGATE 4.0.156:** Admin og scoreforklaring understøtter flere lokale retningsankre, men den almindelige vejrproduktion bygger fortsat primært én zoneserie. 774/783 private punktpar er CI-verificeret; ni er blokeret. Den nationale native DMI-gridgate afventer privat CI. Ingen må markedsføres som forskellig lokal vind/strøm, før sampling og provenance er implementeret pr. kystdel.
