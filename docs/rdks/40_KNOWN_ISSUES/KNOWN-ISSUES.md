...
- **ISSUE-EIGHT-LIMFJORD-REGIONAL-PROXIES – AKTIV KANDIDAT IMPLEMENTERET / LIVEBEVIS MANGLER:** De otte eksplicitte dele må efter DEC-0041 bruge nærmeste eksakte `dkss_lf`-par op til 15 km. Kandidaten validerer uændret ejerpunkt, collection, celle, lag, tid og afstand, publicerer den credentialfri U/V-post og sætter pilen på den faktiske proxycelle. Isolationstest består; frisk 8/8-runtime, samlet 673/673 og direkte livekontrol mangler.
