...
- **ISSUE-CANDIDATE-G-FRESH-SCORE-DISTRIBUTION – ÅBEN EJERGENNEMGANG:** Den produktionsverificerede score-neutrale shadow ligger i gennemsnit 16,582 point lavere for waders og 22,379 point lavere for strand end aktiv score; 1.127/1.346 evalueringer skifter scorebånd. Transportgennemsnittet er 4,242 og mobilisering 13,747 efter ni timers naturlig state. Det er ikke en mekanisk fejl, men effekten skal forstås og accepteres særskilt før aktivering.
