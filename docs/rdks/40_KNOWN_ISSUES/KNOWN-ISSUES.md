...
- **ISSUE-BLAAVAND-DETAIL-PHYSICAL-VALIDATION – AKTIV OG GATED:** 4.0.134 dokumenterer fysisk GeoDanmark-reference, officiel hukopdeling, 15-meters landside og modsatte punktretninger mod centralt verificerede ankre. 4.0.135-kandidaten kan hente gratis officielt 2025-ortofoto og danne tre private zoom-17-overlays, men CI-adgang og visuelt artifactreview mangler. Det er endnu ikke et bestået ortofoto- eller DMI-havcellebevis. Ingen detailgeometri eller punktkandidat må aktiveres før disse kontroller og admin-roundtrip er gennemført.
