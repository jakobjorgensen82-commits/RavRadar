...
- **ISSUE-PUBLIC-COAST-RESIDUAL-OWNER-CORRECTIONS – OVERLAP RETTET / AFVENTER NY DMI-CI:** Den symmetriske overlapgate fandt og fjernede 11 additive dubletdele, som den tidligere ensidige kontrol overså. Slutkandidaten har 643 dele, nul tværzoneoverlap, nul uafklarede relevante huller og punktpar til 643/643 dele. Den endelige 39-punktsbestand afventer ny DMI-gridkontrol; #31531318575 gælder den erstattede før-deduplikerede bestand.
