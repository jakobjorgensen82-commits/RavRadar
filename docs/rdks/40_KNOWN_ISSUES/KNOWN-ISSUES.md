...
- **ISSUE-CURRENT-FIELD-ROTATION-STALLED-ON-UNCHANGED-MODEL – LØST OG CI-BEVIST:** #2855/#2859 stod ved cursor 90, 491 prøver/58 dele og nul replayassets, fordi fælles 4 GB-LRU manglede en tidsrelevant marine fil. Manifest og prioriteret retention er nu bevist i #2863/#2864: først tre bootstrapfiler/29,8 MB og vækst til 73 dele, dernæst genbrug med nul download og vækst til 88 dele/cursor 120. Begge runs behandlede tre komplette U/V-assets, var `reason=completed`, score-neutrale og ikke-offentlige. Fortsat 168-timers drift overvåges almindeligt; den separate geografiske produktionsgate er stadig åben.
