...
- **ISSUE-HYDRATOR-LEGACY-ENTRYPOINT – RETTET I OPFØLGNING / PRODUKTIONSBEVIS MANGLER:** Produktion `32759180937` gennemførte selve Candidate G-recoveryen, men den fulde gate krævede stadig tekstligt `active_zone_ids()`. Den gamle nul-argument-indgang er bevaret som wrapper omkring den nye testbare rodvariant. Målrettet gammel og ny hydreringstest består; ny exact-head og produktion mangler.
