...
- **ISSUE-GEODANMARK-FIRST-CI-PILOT – DATA VERIFICERET / KOMPLETHED AFVENTER:** #1931 hentede alle syv ønskede aktuelle lag i tre områder med korrekt isolation og maskering. Flere maskelag ramte præcis 10.000 features, og upload-actionen medtog som standard ikke den skjulte rå arbejdsmappe. 4.0.128 tilføjer WFS-pagination, komplethedsmetadata, sikker maksimumgrænse og eksplicit privat upload af skjulte råfiler. Forslagsgenerering afventer grøn genkørsel og komplethedskontrol.
- **ISSUE-GEOMETRY-PILOT-CONCURRENCY – LOKALT LØST / AFVENTER CI:** #1933 blev annulleret som ventende, da rutinekørsel #1934 overtog den fælles concurrency-køs eneste pending-plads. 4.0.129 giver pilot og vejr hver sin gruppe; en nyere pilot kan stadig erstatte en ældre pilot.
