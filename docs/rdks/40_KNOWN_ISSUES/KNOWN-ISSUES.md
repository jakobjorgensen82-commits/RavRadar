...
- **ISSUE-MULTI-ANCHOR-SAMPLING-GAP – AKTIV / DMI-GRIDGATE 4.0.157:** 774/783 private punktpar er CI-verificeret; ni er blokeret. #2118 afslørede og stoppede en forkert fælles `unknown` modelklassifikation. Den coastType-korrekte nationale native DMI-gridgate afventer privat CI. Ingen må markedsføres som forskellig lokal vind/strøm, før sampling og provenance er implementeret pr. kystdel.
