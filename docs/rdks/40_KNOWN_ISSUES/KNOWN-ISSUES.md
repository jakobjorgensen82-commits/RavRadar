...
- **ISSUE-NATIONAL-STATE-MISSING-CURRENT – AKTIV / 4 DELE:** Fire WAM-only dele har ingen komplet DKSS-currentfamilie og kan derfor ikke få lokal `shadow-v2`-state. De skal vises som manglende state og må ikke få parentfallback eller nulstrøm.
