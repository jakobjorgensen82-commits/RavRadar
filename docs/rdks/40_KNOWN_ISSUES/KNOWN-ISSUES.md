...
- **ISSUE-NATIONAL-COASTAL-PART-FRAGMENTATION – PRIVAT GATE VERIFICERET I #2050 / OPDELING AKTIV:** 755 dele blev dannet i 194 zoner uden forbindelsesgeometri. 25 zoner/28 dele er lokalitetsflagget; Læsø når 52–55 km/57–88 fragmenter. De må ikke behandles som lokale vejrområder og er fail-closed til eksplicit lokal opdeling. `DK-B10-10` er fortsat blokeret med 31 dele.
