...
- **ISSUE-GITHUB-SCHEDULE-COPERNICUS-HOUR-RACE – PRODUKTIONSVERIFICERET LØST I 4.0.234 / CRON-BEKRÆFTELSE AFVENTER:** cron-job.org startede produktion ved hel time samtidig med ny Copernicus-indsamling og gav et sikkert 630/673-stop. GitHub-planen er forskudt til 14/29/44/59, piloten til minut 6, og en manglende aktuel time udsætter planlagt produktion uden artifact/deploy. `#32244914347`/`#3210` bestod som naturligt schedule-event, og `#32245473213`/`#3211` beviste sikkert skip ved manglende time. Ejeren er bedt om at deaktivere cron-job.org; faktisk deaktivering og næste native kørsel uden dublet skal bekræftes.

- **ISSUE-PUBLIC-LOCAL-PRESENTATION-SPLIT – RETTET LOKALT I 4.0.235 / PRODUKTIONSBEVIS AFVENTER:** Chromium-auditten fandt, at zonepanelet blandede hovedzonens vejr med lokal score og valgte femdøgnstid ad en anden vej end den nationale prognose. 4.0.235 fører nu én lokal del/tid/vejrpost gennem score, tekst, debug og metrikker, genbruger samme `selectLocalBestForDay` og mærker samlet hovedzonefallback eksplicit. En ny regression består for 210 zoner, 673 dele, begge jagtformer og 2.100 femdøgnsvisninger. Ingen land-/vandpunkter, U/V, pilceller, kilder eller scoreformel er ændret. Første pushrun `#32248949564`/`#3215` stoppede fail-closed før deploy på en efterladt 4.0.234-workflow-User-Agent; versionskæden er rettet og en ny central 673/673-kørsel samt direkte livebrowser afventer.
