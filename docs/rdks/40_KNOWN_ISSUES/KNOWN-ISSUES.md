...
- **ISSUE-NATIONAL-SOURCE-SEQUENTIAL-SCALING – LØST I #2029:** 4.0.143-planen gav 101 fliser og 707 sekventielle lagrequests uden afslutning efter mere end ti minutter. #2029 hentede samme omfang med højst fire samtidige fliser på ca. 5:15 og afsluttede hele validator-/QA-/artifactjobbet på 7:45.
- **ISSUE-NATIONAL-RAW-ARTIFACT-DOWNLOAD-SCALE – RETTET LOKALT I 4.0.145 / AFVENTER CI:** #2029's private råartifact er 413 MB komprimeret og for langsomt til gentagen lokal QA-download. 4.0.145 bevarer råbeviset, men uploader også plan, manifest og begge 208-zone-QA-filer separat.
- **ISSUE-NATIONAL-GEOMETRY-SOURCE-ACQUISITION – PRIVAT CI-VERIFICERET I #2029:** Den central-hydrerede nationale kæde bestod med 208 zoner, 101 fliser, komplette eksponerede lag, deduplikering, credentialgate og rumligt indekseret QA. Næste åbne led er national ravstrand-/topologigenerering og konfliktreview.
