...
- **ISSUE-BLAAVAND-DETAIL-PHYSICAL-VALIDATION – AKTIV OG GATED / ORTOFOTO NO-GO:** #1974 verificerede gratis officielt 2025-ortofoto og tre private zoom-17-overlays. Nord- og sydøststrækningerne passer overordnet, men ved selve Blåvands Huk følger den fysiske kilde en indadgående sandtange-/laguneløkke, som ikke uden videre er RavRadars relevante søgbare strandlinje. Løkken skal rettes privat og genkontrolleres før DMI-havcellegaten. Ingen detailgeometri eller punktkandidat må aktiveres før disse kontroller og admin-roundtrip er gennemført.
- **ISSUE-BLAAVAND-HUK-HAIRPIN – LOKALT RETTET I 4.0.136 / AFVENTER ORTOFOTO:** Kandidaten måler den afviste rute/chord-ratio, bevarer det søværts apex og genforener kysten efter den indadgående detur. Lokal #1974-regeneration fjerner 242,0 m detur uden at ændre 15-metersoffset, punktsampling eller score. Kun et nyt officielt ortofotoartifact kan lukke issue.
