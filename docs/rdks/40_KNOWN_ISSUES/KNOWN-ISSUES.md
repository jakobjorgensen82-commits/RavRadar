...
- **ISSUE-SIX-ZONE-NATIVE-DMI-PROOF – AFVENTER PRIVAT CI:** Lokal geometri-, ejerskabs-, punkt- og overlapkontrol er grøn. De 12 nye dele i Langeland syd/Bagenkop, Lolland vest/Albuen og Fejø/Femø må ikke aktiveres, før det særskilte, ikke-deployende seks-zoneworkflow har godkendt vandpunkterne på DMI's native grid.
...
- **ISSUE-REPOSITORY-VS-CENTRAL-ZONE-COUNT – OPDATERET I 4.0.186:** Read-only v2-audit fandt historisk 209 repositoryzoner mod 208 centralt aktive efter administratorsletning. De tre senere godkendte Vadehavszoner giver nu 211 centralt aktive zoner. National planlægning bruger fortsat central hydration/tombstones og kræver eksplicit 211 ved indgangen samt identisk bestand gennem resten af kildekæden; slettede zoner må ikke genoplives.
