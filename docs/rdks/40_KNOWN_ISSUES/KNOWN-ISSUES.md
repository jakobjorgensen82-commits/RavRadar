...
- **ISSUE-COPERNICUS-CURRENT-PILOT – AUTENTIFICERET OG FLERTIDSCACHEVERIFICERET / MANGLENDE-TIME-DISPATCH AFVENTER:** Piloten har bevist 39 Baltic + 4 AMM15 blandt de 51 DMI-huller. `#32146584311` udvidede den private cache til 2.516 records ved 11–14 UTC uden grid-/lagskift eller supportlæk. GitHubs native schedule er forsinket/ustabilt, så keepalive bruger `workflow_run: requested` fra det eksternt startede produktionsworkflow. Første automatiske heartbeat `#32146699458` ramte den nye cache og sprang korrekt dubletdispatch over. Den minimale dispatchret og nul cache-save/artifact/deploy er regressionsbeskyttet. Central manglende-time-dispatch og naturligt syvdøgnsvindue mangler; offentlig runtime og score er uændret.
