...
- **ISSUE-NATIONAL-PART-SERIES-NOT-YET-SAMPLED – AKTIV / GATE 4.0.160:** De 774 private dele har isolerede serie-/historikidentiteter, og den nationale flertrinsvalidator er implementeret lokalt. Faktiske serier er endnu ikke CI-verificeret; parent-zonerne er fortsat eneste runtime-sandhed.
...
- **ISSUE-NATIONAL-MULTI-STEP-PARTS-SCOPE – LØST LOKALT I 4.0.161:** #2142 fandt, at `parts_by_id` ikke var defineret i flertrinsvalidatorens live-`run()`. Opslaget er flyttet til korrekt scope og collection-routing er dækket af regression; afventer privat CI.
