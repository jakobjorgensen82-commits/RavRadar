...
## 4.0.314 – singleton-afteranker er lokalt rettet; rekonstruktionen er endnu ikke udført
...
- **ISSUE-CANDIDATE-G-AFTER-EVIDENCE-COUNT – RODÅRSAG BEVIST / LOKAL 4.0.314-RETTELSE GRØN:** Read-only inspect `33269849748` stoppede, fordi en fælles minimum-to-gate afviste det ene legitime målte højreanker på native 3-timersdele. 4.0.314 tillader det kun i `AFTER` og kun efter uafhængigt cadence- og statebevis; globale singletoner er fortsat forbudt.
...
- **ISSUE-RECOVERY-4.0.314-OVERTAKE – LOKALT LUKKET / AFVENTER EXACT-HEAD:** 4.0.314 kræver både exact-D1 og, for normal `none`-produktion, et exact-head succesbevis for apply-steppet og Pages-jobbet. Inspect/apply kan køre efter D1; manglende eller malformed Actions-metadata giver grøn no-op. 4.0.315 er bevidst ulåst.
- **ISSUE-TRIP-D1-EXACT-HEAD-4.0.314 – ÅBEN DRIFTSGATE:** Det grønne 4.0.313-run beviser live backend, men kan ikke attestere den nye 4.0.314-SHA. Hele idempotente D1-kæde skal bestå igen efter merge.
