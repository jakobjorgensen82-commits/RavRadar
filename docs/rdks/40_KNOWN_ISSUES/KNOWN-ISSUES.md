...
- **ISSUE-COPERNICUS-CURRENT-PILOT – LIVE-INTEGRATION IMPLEMENTERET LOKALT / CENTRAL VERIFIKATION MANGLER:** Piloten har bevist 39 Baltic + 4 AMM15 blandt de 51 DMI-huller og en geometri-bundet flertidscache uden grid-/lagskift eller credentiallæk. Kandidaten bygger nu credentialfri online U/V-historik, fletter DMI-first på eksakt tid, bruger den faktiske celle til pile/score og har versionsstyret DMI-only rollback. Åbent er frisk central 673/673, fuld releasekæde, direkte livekontrol og den efterfølgende naturlige syvdøgnseftermåling.

- **ISSUE-EIGHT-LIMFJORD-REGIONAL-PROXIES – 8/8 CACHEBEVIS / RETTET LIVE-ANKERKONTRAKT AFVENTER CI:** De otte eksplicitte dele må efter DEC-0041 bruge nærmeste eksakte `dkss_lf`-par op til 15 km. `#32156725504`/support `#3125` viste 40 prøver fordelt på alle otte, men livebyggeren afviste dem, fordi den forventede et `approvedSamplingPoint`-felt, som shadow-ankeret ikke gemmer. Kandidaten validerer nu de kanoniske identitetsfelter samt celle, lag, tid og afstand. Frisk 8/8-runtime, samlet 673/673 og direkte livekontrol mangler.
...
- **ISSUE-CURRENT-SPATIAL-COVERAGE-AFTER-SEMANTICS-V2 – LIVE-KANDIDAT IMPLEMENTERET / CENTRAL FULDDÆKNINGSGATE ÅBEN:** #2875/#2876 var historiske deltrin i V3-genopbygningen. Efter central punkthydrering viser #3094 622/673 aktive DMI-dækkede kystdele. Ejerbeslutningen tillader nu den validerede, credentialfri liveprojektion: Copernicus kan udfylde 43 af de 51 DMI-huller, og de sidste otte bruger den afgrænsede Limfjordsallowlist. Første normale deploy kræver stadig alle 673 med kildekorrekt provenance; gaten er ikke længere 640. `dmi-only-rollback` kan deaktivere supplementet uden at hævde fuld strømdækning.
