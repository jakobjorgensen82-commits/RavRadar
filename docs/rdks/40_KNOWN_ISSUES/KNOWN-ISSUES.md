...
- **ISSUE-CURRENT-SPATIAL-COVERAGE-AFTER-SEMANTICS-V2 – ÅBEN EJER-/PUNKTGATE:** #2853–#2855 gentager 187/210 verificerede hovedzoner og 596/673 verificerede lokale kystdele. De 23/77 rester har intet fælles DMI-U/V-punkt inden for 5 km og er sikkert `null` uden pil; verificerede poster har ingen kendt pil/grid-fejl. Den strenge gate er ikke ændret. Punktreviewlisten og det uforanderlige #2855-snapshot findes i `CURRENT-COVERAGE-4.0.229.md`.
...
- **ISSUE-CURRENT-FIELD-ROTATION-STALLED-ON-UNCHANGED-MODEL – RETTET IGEN LOKALT / AFVENTER CI:** #2855 beholdt 491 prøver og 58 dele, fordi cursoren kun gik videre ved nye marineassets. #2859 beholdt samme prøver/dele og cursor 90 med nul replayassets: den fælles 4 GB-LRU havde ingen tidsrelevant marine replayfil tilbage. DMI's aktuelle STAC-href er stabil og var ikke rodårsagen. Den nye rettelse bruger manifest og prioriteret marine retention; objektsti-baseret cache-ID beskytter kun mod eventuelle fremtidige querycredentials. Hvis en gammel/tømt cache mangler en aktuel fil, må replayet bootstrap-hente højst én pr. modelområde/tre pr. kørsel af restkapaciteten; kun private mål og scratch-output behandles. CI skal bevise vækst og efterfølgende genbrug uden bootstrap.
