...
- **ISSUE-RAVSCORE-1.1-RELEASE-CLOSURE – ÅBEN P0:** `RRS-COASTAL-PROCESS-INTEGRATED-1.1.0`/state `6.0.0` er samlet lokalt under DEC-0110/DEC-0112, men er ikke exact-head-valideret, merged, produktionsbygget eller offentligt desktop-/mobilverificeret. Candidate G forbliver eneste offentlige model; schema 5 er kun den aldrig-offentlige, eksakte 5→6-migrationskilde.
...
- **ISSUE-RAVSCORE-DUAL-HASH-RUNTIME-BINDING – LØST LOKALT / BINDING FASTLÅST / RELEASEBEVIS ÅBENT:** DEC-0110 kræver både `modelContractSha256` for parameterkontrakten og `modelBundleSha256` for den transitive implementeringslukning. Begge følger nu den fulde 11-feltsbinding gennem generator, state, payloads, checkpoints, privat bundle, ture/observationer, central profil, Edge og releasegates og afvises særskilt ved mismatch. Den aktive binding er `778db7aa3946f925607a8304daa42ed17dd30294e4a51bf6d895d7293e84c4e7`/`74bfc42bb008f6743f374fc35201d3ea6f81f6e360c99873541fed83eeadcbae` over 43 filer; exact-head-, produktions- og offentlig kontrol udestår.
...
- **ISSUE-RAVSCORE-CANDIDATE-G-OPERATIONAL-ROLLBACK – LØST LOKALT / AKTIV PRODUKTIONSGATE:** Den varme Candidate G-projektion ligger kun privat som `ravScoreCandidateGRollback`. Controlleren `ravscore-operational-model-activation` bruger schema `ravscore-operational-model-activation-v3` og durable source/requested-manifest-reconciliation for `INTEGRATED_PENDING`, `CANDIDATE_G_PENDING` og begge aktive statusser. Central source-profil bevares under Pages-target; targetprofilen skifter først atomisk med `ACTIVE` efter eksakt offentlig implementation+210/673. Targethash completer, sourcehash aborterer/rekonsoliderer, og tredje hash forbliver fail-closed. Rollback/return er manual-only; scheduler må kun refreshe allerede aktiv Candidate G. Der deployes ingen særskilt Candidate G-assistent-Edge: den integrerede Edge svarer eksakt `409`, klienten bruger deterministiske lokale DA/DE/EN-svar, og schema-3-ture lagres Candidate G-bundet med `calibration_eligible=false`. Den separate Candidate G-binding er `modelContractSha256=c73dac1b4376005e792580791d84eb79c9370e905a2a7fd0bdee857506a20cf8` og 54-filers `modelBundleSha256=fd3f7e70ec3706818c153c26140ae592e4f0ad2acc6c157183984689f74a2207`. Full rollback-orakel gennem bundle/runtime/stage/trip/assistant/Pages og workflowgaten er grønne; PR exact-head, central readback, deploy, offentlig verifikation og produktions-fault-injection er stadig åbne.
