...
- **ISSUE-CANDIDATE-G-TRANSPORT-INITIAL-STATE-AND-DECAY – SEMANTIK AFGJORT / PIPELINEKOBLING ÅBEN:** Neutral og missing giver intet passivt tab. Potentiale og igangværende effektive udtransporttimer føres videre som kompakt afledt tilstand; ny kørselsgrænse må ikke nulstille forløbet. Model og tests understøtter nu eksakt fortsættelse, men den centrale pipeline-/rollbackkobling er endnu ikke offentliggjort. 24/48-halvering og fail-closed start 0 bevares kun som følsomhed og cold-start-reference.
- **ISSUE-CANDIDATE-G-PUBLIC-ACTIVATION – EJERRETNING VALGT / TEKNISK PAKKE ÅBEN:** Ejeren ønsker den bedste samlede kandidat ført til offentlig brug, og DEC-0056 samler nu `RESEARCH-3` som anbefalet helhed. Manglende repræsentative ture bevares som tydeligt oplyst modelusikkerhed, ikke en umulig før-aktiveringsgate. Offentlig kobling kræver stadig central persistens af begge tilstande, frisk fallback-kompatibel national shadow, offentlig forklaring, rollback og fulde produktgates. Indtil da er varianten diagnostic-only.
...
- **ISSUE-CANDIDATE-G-MOBILISATION-PIPELINE-STATE – ÅBEN FØR OFFENTLIG KOBLING:** Den kompakte afledte mobiliseringstilstand fortsætter eksakt i en opdelt syntetisk kørsel. Central persistens, freshness, national shadow, forklaring og rollback skal stadig implementeres og valideres sammen med transporttilstanden før offentlig scoreændring.

## 4.0.257 Candidate G national scoreinputcoverage

- **ISSUE-CANDIDATE-G-DYNAMIC-SCORE-INPUT-COVERAGE – GAMMEL RESTRIKTIV SHADOW AFGRENSET / FRISK SLUTSHADOW ÅBEN:** Exact-merge-shadow `32580774128` scorede kun de 243 dele, som opfyldte den daværende snævre native-DKSS-testkontrakt. De øvrige 430 var ikke bevis for manglende almindelig vejrdækning og skal ikke hentes som et nyt datasæt til modellen. Den aktuelle produktionskæde har 673/673 dokumenterede strømidentiteter via DMI, Copernicus eller godkendt proxy. Før offentlig Candidate G-kobling kræves en frisk national shadow mod den endelige, fallback-kompatible inputkontrakt; ingen værdier må nuludfyldes, nabokopieres eller løses ved punktflytning.
