...
- **ISSUE-CURRENT-SPATIAL-COVERAGE-AFTER-SEMANTICS-V2 – ÅBEN EJER-/PUNKTGATE:** #2853–#2869 gentager 187/210 verificerede hovedzoner og 596/673 verificerede lokale kystdele. De 23/77 rester har intet fælles DMI-U/V-punkt inden for 5 km og er sikkert `null` uden pil; verificerede poster har ingen kendt pil/grid-fejl. #2869 beviser den private coverage-audit uden fjerne værdier: 11 målte mangler fordeler sig på 2 nær-tærskel 5–6 km, 4 modelhuller 6–8 km og 5 strukturelle huller over 8 km; 66 afventer rotation. Punktreviewlisten og #2855-snapshotet findes i `CURRENT-COVERAGE-4.0.229.md`.
