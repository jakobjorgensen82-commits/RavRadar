...
- **ISSUE-LIVE-AUDIT-WATER-TREND-LABEL – LØST LOKALT / AFVENTER EXACT-HEAD:** Den første 4.0.264-liveaudit talte 2.520 gentagelser af én forældet testlabel. Feltet var korrekt beregnet og vist som `Vandstandsændring på 3 timer`, men auditten søgte `3-timers trend`. Med labelen rettet består live 420/2.100/673 med nul øvrige kontrol-, konsol-, side- eller HTTP-fejl.
