...
- **ISSUE-HANDBOOK-DEPLOY-OVERWRITE – TRE SIKRE STOP BEVIST / ENDELIG HOTFIX AFVENTER:** Produktion `32721891349` stoppede ved manglende baseline, og `32724616331` stoppede ved den bevidst slanke Pages-pakke. PR #124 bestod exact-head `32726897134`, blev merged som `fd7bc868`, og produktion `32727025187` bestod alle øvrige gates, men stoppede ved hashkontrollen. Det beviste, at manifestet svarer til den sidste centralt synkroniserede 4.0.269-kilde på uforanderlig commit `fc13fb5ab326d8824ca55235ac454ac230e3db3e` fra grøn produktion `32706573863`; kun denne kilde må accepteres, og kun ved SHA-256-match.
