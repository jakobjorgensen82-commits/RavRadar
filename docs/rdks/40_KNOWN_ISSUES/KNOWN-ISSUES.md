...
- **ISSUE-NATIONAL-PART-WIND-NOT-YET-VERIFIED – #2157 TIDSBUDGET LØST / #2164 HARBO ODDE-CELLEGAB / 4.0.165 AFVENTER CI:** #2164 nåede resultatvalideringen inden for det større budget, men Harbo Odde havde ingen fælles gyldig wind-U/V blandt fire nærmeste HARMONIE-celler. 4.0.165 søger 32 native kandidater kun i privat gate og håndhæver fortsat samme celle og eksisterende afstandsgrænse.
