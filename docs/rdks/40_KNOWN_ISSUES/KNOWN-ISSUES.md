...
- **ISSUE-CANDIDATE-G-ACTUAL-RUNTIME-GATE-FAILURE-3619 – ÅBEN / SIKKERT STOP:** PR #157 og merge `2f2fd148` var exact-head-grønne. Produktion `32995888183` byggede frisk runtime, men den nye faktiske shadowgate afviste den før Supabase-sync, artifact og Pages. Den offentlige sorte 4.0.285-side blev ikke erstattet. Første gateversion loggede kun exitkode; den næste kandidat logger derfor kun sikre fejlkoder og summerede optællinger til rodårsagsanalyse.
...
- **ISSUE-4.0.286-PRODUCTION-CLOSURE – ÅBEN:** Første exact-head/merge er grøn, men produktion `32995888183` stoppede korrekt i den nye runtimegate. Sikker diagnose, ny exact-head, fuld frisk produktion og positiv offentlig aktuel-ranglistekontrol udestår.
