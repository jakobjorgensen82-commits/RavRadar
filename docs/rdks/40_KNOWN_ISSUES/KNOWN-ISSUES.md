...
- **ISSUE-COASTAL-PART-UI-ACTIVE-ZONE-AMBIGUITY – LOKALT KONTRAKTBLOKERET I 4.0.141 / AFVENTER PRIVAT CI:** To delkonturer kunne fejlagtigt opfattes som to aktive eller rangerede zoner og skjule parentens RavScore-farvede linje. Den private UI-gate kræver én aktiv parent, neutral stiplet “ikke aktiv”-visning og forbyder delscore, scorefarve, “bedste del” og interaktion. Offentlig integration er fortsat lukket.
