...
- **ISSUE-CANDIDATE-G-ACTIVATION-CONFIG-ROUNDTRIP – ÅBEN:** Den fremtidige aktiveringskonfiguration skal kunne gemmes og genlæses centralt med eksakt profil- og evidensbinding. 4.0.260 hardcoder kun den score-neutrale legacydefault og gennemfører ikke central aktivering.
...
- **ISSUE-CANDIDATE-G-TRANSPORT-INITIAL-STATE-AND-DECAY – NATURLIG FORTSÆTTELSE BEVIST / LANG HORISONT UKALIBRERET:** Neutral og missing giver intet passivt tab. DEC-0057 fører potentiale og igangværende effektive udtransporttimer videre centralt ved `currentReferenceAt`, og same-time-rekørsel tæller ikke dobbelt. Seneste naturlige runtime accepterer 673/673 tidligere tilstande, nulstiller 0 og dokumenterer 9/9 timers alder. Ejeren accepterer nattens forløb som praktisk evidens, ikke som et 48-timersbevis eller fundkalibrering.
- **ISSUE-CANDIDATE-G-FRESH-SCORE-DISTRIBUTION – RODÅRSAG AFGRÆNSET / ÅBEN EJERBESLUTNING:** Den produktionsverificerede score-neutrale shadow ligger i gennemsnit 16,582 point lavere for waders og 22,379 point lavere for strand end aktiv score; 1.127/1.346 evalueringer skifter scorebånd. 493/673 transporttilstande er 0 uden én eneste udløst udtransportgate. Den eksisterende 65–117-timers strømhistorik kan ikke bestemme den ukendte startreserve under reglen uden passivt neutralt tab: kun 6/633 dele er uafhængige af start 0 kontra 100, og 607/633 bevarer mindst 50 points forskel. Neutral startprior 50 anbefales, men kræver ejerbeslutning og ny versionsbinding.
- **ISSUE-CANDIDATE-G-PUBLIC-ACTIVATION – TEKNISK OMSKIFTER BEVIST / AKTIVERING LUKKET:** Ejeren ønsker den bedste samlede kandidat ført til offentlig brug, og `RESEARCH-3` er den anbefalede helhed. DEC-0058/4.0.260 er fuldt produktionsverificeret med global rollback, men vælger fortsat offentlig `25/40/35`. Central admin-roundtrip, en ny versionsbundet aktiveringsændring, frisk aktiveringsshadow og særskilt ejer-gennemgang af scorefordelingen udestår. Manglende repræsentative ture bevares som modelusikkerhed og senere efterkalibrering.
