...
- **ISSUE-BLAAVAND-DETAIL-PHYSICAL-VALIDATION – ORTOFOTO LØST / DMI-GRID GATED:** #1982 godkendte den rettede private linje mod officielt 2025-ortofoto. 4.0.137-kandidaten kontrollerer nu begge vandpunkter direkte mod aktuelle WAM-/DKSS-gridmasker. Gridgaten er først løst efter privat CI- og artifactreview; gyldige celler er ikke i sig selv tilladelse til selvstændig sampling, admin-roundtrip eller aktivering.
- **ISSUE-BLAAVAND-INDEPENDENT-WEATHER-SERIES – AKTIV:** To geografisk forskellige vandpunkter kan på DMI's relativt grove kystgrid ramme samme fysiske celle for en eller flere komponenter. Rapporten skal derfor angive uafhængighed pr. komponent; samme celle må ikke fremstilles som to forskellige lokale vejrmålinger.
