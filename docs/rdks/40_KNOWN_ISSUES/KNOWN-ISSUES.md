...
- **ISSUE-HANDBOOK-DEPLOY-OVERWRITE – SIKKERT STOP BEVIST / HOTFIX AFVENTER:** Produktion `32721891349` stoppede før deploy, fordi den centralt ændrede håndbog manglede en lagret baseline ved første migrering. Hotfixet bruger kun den tidligere offentlige håndbog som startbaseline, når dens SHA-256 matcher det tidligere beskyttede manifest; hentefejl eller afvigelse stopper fortsat sikkert.
