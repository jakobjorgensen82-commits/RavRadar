...
- **ISSUE-GITHUB-SCHEDULE-COPERNICUS-HOUR-RACE – 4.0.236-KANDIDAT / CENTRAL EFTERKONTROL AFVENTER:** 4.0.234 løste produktionens start samtidig med indsamlingen, men `#32249924919`/`#3217` afdækkede en anden timegrænse: readiness godkendte 11:00 kl. 11:59, mens bygningen efter kl. 12 valgte 12:00 og stoppede sikkert ved 630/673 før release/deploy. 4.0.236 eksporterer readiness-timen og låser hele planlagte build til den samme eksakte UTC-time. Regressionen er grøn; central schedule-/produktionsverifikation og faktisk deaktivering af cron-job.org afventer. 673/673 er ikke sænket.
