...
- **ISSUE-CURRENT-SPATIAL-COVERAGE-AFTER-SEMANTICS-V2 – ÅBEN EJER-/PUNKTGATE, PROGRESSIV V3-GENOPBYGNING:** #2875/#2876 har genopbygget IDW og NSBS og nået 182/210 hovedzoner samt 574/673 lokale dele. Havknude er rettet, men Limfjord parser v18 mangler, og den private audit har endnu kun besøgt 120 dele. Blandt 99 aktuelle lokale mangler er 59 endnu ikke besøgt; de målte mangler fordeler sig på fem ved 5–6 km, fem ved 6–8 km, 23 over 8 km, tre uden observeret U/V og fire inden for 5 km, som skal genmåles efter fuld modelrotation. Gaten forbliver 640.
