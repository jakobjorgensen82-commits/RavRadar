...
- **ISSUE-COPERNICUS-CURRENT-PILOT – AUTENTIFICERET OG FLERTIDSCACHEVERIFICERET / EKSTERNT HEARTBEAT AFVENTER CI:** Piloten har bevist 39 Baltic + 4 AMM15 blandt de 51 DMI-huller og 1.887 private records ved 11/12/13 UTC uden grid-/lagskift eller supportlæk. GitHubs aktive native schedule leverede kun ét forsinket event og sprang efterfølgende timer over. Keepalive bruger derfor nu `workflow_run: requested` fra det allerede eksternt startede produktionsworkflow, tjekker read-only om aktuel UTC-time findes og dispatcher ellers den eksisterende private pilot. Den minimale dispatchret og nul cache-save/artifact/deploy er regressionsbeskyttet. Automatisk central heartbeat/dispatch og naturligt syvdøgnsvindue mangler; offentlig runtime og score er uændret.

- **ISSUE-EIGHT-LIMFJORD-REGIONAL-PROXIES – PRIVAT COLLECTOR LOKALT IMPLEMENTERET / IKKE AKTIVERET:** Hanklit, Harbo Odde, Knudeklinter, Stenerodde, Aggersborgrimme, Løgstør, Petersborg og `DK-B05-20` må efter DEC-0041 bruge nærmeste eksakte `dkss_lf`-par op til 15 km. 4.0.232-kandidaten gemmer deres faktiske U/V i den private 168-timers cache og udleder en råvektorfri supportreport. Den målte spændvidde er 5,416–12,110 km. Målrettede isolationstests og policytest mod #3079 består; frisk DMI-/cacheevidens samt aktiv pil-, score- og produktionsvalidering mangler.
...
- **ISSUE-CURRENT-DEEPEST-LAYER-MOVED-SPATIALLY – CI-VERIFICERET I 4.0.229 / AFVENTER DEPLOY:** Parseren valgte tidligere det dybeste lag globalt og kunne lade et 12–24 km fjernt dybdepunkt slå den nærmeste vandkolonne. #2846 beviste den rumligt-først rettede parser, men afdækkede, at forecast-/auditkæden fejlagtigt antog ét fast lag for hele tidsserien. Lag vælges nu pr. native tid, interpolation over lag-/celleskift afvises, og pilen bruger den viste times egen celle. #2853–#2855 beviser semantik v2 og nul kendt pil/grid-mismatch for verificerede poster; deploy afventer den separate geografiske dækningsgate.

- **ISSUE-CURRENT-SPATIAL-COVERAGE-AFTER-SEMANTICS-V2 – ÅBEN FULDDÆKNINGSGATE, PRIVATE SUPPLERENDE KILDER UNDER BEVIS:** #2875/#2876 var historiske deltrin i V3-genopbygningen. Efter central punkthydrering viser #3094 622/673 aktive DMI-dækkede kystdele. Copernicus-piloten har potentiale til 43 af de 51 huller, og de sidste otte er den afgrænsede Limfjordsallowlist, men ingen af de private kilder er endnu aktiveret. Nye releases kræver nu alle 673 med kildekorrekt proveniens; gaten er ikke længere 640.

- **ISSUE-CENTRAL-COASTAL-POINTS-BUILT-AFTER-DMI – CI-VERIFICERET I 4.0.229 / AFVENTER DEPLOY:** Workflowet byggede hidtil kystdelskontrakten efter DMI-bulksteppet. Centralt flyttede punkter kunne derfor blive samplet på gamle koordinater og senere afvist af runtime. Kontrakten bygges nu før DMI; cache genbruges kun for uændrede samplingpunkter, så en enkelt flytning ikke nulstiller hele Danmark. #2846-artifactreplay fandt 101 sådanne ændrede dele, og #2853–#2855 beviser den selektive genopbygning og sikre `missing`-adfærd; deploy afventer den separate geografiske dækningsgate.
...
- **ISSUE-CURRENT-FIELD-ROTATION-STALLED-ON-UNCHANGED-MODEL – LØST OG CI-BEVIST:** #2855/#2859 stod ved cursor 90, 491 prøver/58 dele og nul replayassets, fordi fælles 4 GB-LRU manglede en tidsrelevant marine fil. Manifest og prioriteret retention er bevist i #2863/#2864, og #2866 fortsatte med tre cachede replayassets til cursor 150, 667 prøver og 118 dele. Kæden er score-neutral og ikke-offentlig. Fortsat 168-timers drift overvåges almindeligt; den separate geografiske produktionsgate er stadig åben.
...
- **ISSUE-SUPABASE-RUNTIME-DIAGNOSTICS-STATEMENT-TIMEOUT – SNÆVER RETRY VIRKER, MEN DRIFTSFEJLEN KAN GENTAGE SIG:** #2814 forsøg 1 ramte HTTP 500/PostgreSQL `57014` under den cirka 17,7 MB store `runtime-diagnostics`-upsert; uændret forsøg 2 lykkedes. Requesteren genprøver kun eksakt `500/57014` én gang og stopper fortsat ved gentagelse eller andre fejl. #31905211459/#2816 bestod hele produktionskæden, men #2830 forsøg 2 ramte timeout både oprindeligt og ved den tilladte genprøvning efter beståede faglige gates. Det er korrekt fail-closed, men den underliggende Supabase-varians overvåges fortsat.
