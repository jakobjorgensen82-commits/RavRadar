...
- **ISSUE-BLAAVAND-DETAIL-PHYSICAL-VALIDATION – AKTIV OG GATED:** 4.0.134 kan dokumentere fysisk GeoDanmark-reference, officiel hukopdeling, 15-meters landside og modsatte punktretninger mod centralt verificerede ankre. Det er endnu ikke et ortofoto- eller DMI-havcellebevis. Ingen detailgeometri eller punktkandidat må aktiveres før disse kontroller og admin-roundtrip er gennemført.
