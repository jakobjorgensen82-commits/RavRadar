...
- **ISSUE-CANDIDATE-G-TRANSPORT-ZERO-VS-TOTAL-SCORE-ZERO – EJERBESLUTNING KRÆVES:** DEC-0055's 13-timersbund gælder det interne transportpotentiale. Den låste syntetiske revision giver transport 0, men samlet Candidate G cirka 35, fordi jagtbarhed og mobilisering fortsat bidrager. Hvis "helt i bund" skal betyde samlet RavScore 0, kræver det en særskilt eksplicit gate, produktforklaring og regressionstest. Ingen sådan gate er godkendt eller implementeret.
