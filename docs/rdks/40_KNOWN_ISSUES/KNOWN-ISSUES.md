...
- **ISSUE-4.0.316-ROLLBACK-BROWSER-VERIFICATION – PRODUKTION GRØN / ÅBEN VISUEL KONTROL:** PR #236, exact-head `33342157517`, post-merge `33342219152` og første recoverybevis `33345476979`/`rr-20260831010337-210` består. Seneste external-watchdog-`workflow_dispatch` `33347230240` publicerede `rr-20260831012407-210` komplet 210/673 med `VERIFIED_ONLY`, nul syntetiske samples og ærlig Candidate G 0/210 aktiv på grund af historikmemory; offentlig visuel desktop-/mobilkontrol er stadig åben.
- **ISSUE-PRODUCTION-TRANSIENT-503-RETRY – SIKRE STOP / HOTFIX UNDER FÆRDIGGØRELSE:** `33343469247` og `33344823000` stoppede i build/prepare på en forbigående HTTP 503; deploy var skipped, og live Candidate G blev ikke ændret. En snæver bounded-retry-hotfix færdiggøres uden at lempe fail-closed-resultatet. PR- og commit-id er endnu åbne.
...
- **ISSUE-RAVSCORE-DUAL-HASH-RUNTIME-BINDING – LØST LOKALT / BINDING FASTLÅST / RELEASEBEVIS ÅBENT:** DEC-0110 kræver både `modelContractSha256` for parameterkontrakten og `modelBundleSha256` for den transitive implementeringslukning. Begge følger nu den fulde 11-feltsbinding gennem generator, state, payloads, checkpoints, privat bundle, ture/observationer, central profil, Edge og releasegates og afvises særskilt ved mismatch. Den aktive binding er `778db7aa3946f925607a8304daa42ed17dd30294e4a51bf6d895d7293e84c4e7`/`093199540ed877c5cb94e16a7f640cb18814103adfc6dc22912d59f8e9eab061` over 43 filer og syv deklarerede forbrugere; exact-head-, produktions- og offentlig kontrol udestår.
