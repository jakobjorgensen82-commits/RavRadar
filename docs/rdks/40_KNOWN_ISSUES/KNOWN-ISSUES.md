...
- **ISSUE-CURRENT-SCALAR-MODEL-BLOCKED-NEAREST-UV – LOKALT RETTET I 4.0.230 / AFVENTER PRODUKTION:** #2872 fandt Havknudes eksakte fælles NSBS-U/V-kolonne 2,804 km fra vandpunktet, mens offentlig runtime var `missing`. Ét globalt `marineSelection` lod et IDW-skalarpunkt 5,131 km væk med bedre kysttypeprioritet blokere strømmen. Strøm vælges nu pr. native tid på tværs af alle DKSS-collections uafhængigt af vandstand/temperatur, med semantik-v3-invalidering og en regression baseret på de målte produktionspunkter. Afventer frisk parser-v18-produktion og fulde gates.
...
- **ISSUE-CURRENT-SPATIAL-COVERAGE-AFTER-SEMANTICS-V2 – ÅBEN EJER-/PUNKTGATE, KORRIGERET AF #2872:** Offentlig v2-dækning er 187/210 hovedzoner og 596/673 lokale kystdele, men alle 77 lokale mangler må ikke længere kaldes geografiske. Af 36 besøgte mangler har én (Havknude) et gyldigt punkt inden for 5 km og var en pipelinefejl; fire ligger ved 5–6 km, fem ved 6–8 km, 23 over 8 km og tre havde intet observeret fælles U/V. 41 afventer rotation. 4.0.230 skal genmåle offentlig dækning med den rettede tvær-collection-semantik; punktreviewlisten og evidensen findes i `CURRENT-COVERAGE-4.0.229.md`.
...
- **ISSUE-LOCAL-PARTS-EXCLUDED-FROM-DMI-COVERAGE – KODEKÆDE PRODUKTIONSVERIFICERET / NY PAKKE AFVENTER DÆKNING:** Schedulerens dækning blev afsluttet ud fra hovedzonerne alene. #31764453987 bestod frisk data, fuld validering, releasegate og deploy med rettelsen. Den nye 673-dels pakke skal nu opbygge mindst 95 % lokal U/V-cache i efterfølgende kørsler.
