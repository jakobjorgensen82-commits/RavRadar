...
- **ISSUE-CANDIDATE-G-TRANSPORT-ZERO-VS-TOTAL-SCORE-ZERO – LØST SCORE-NEUTRALT:** Ejeren har valgt en eksplicit slutscoregate i den interne `RESEARCH-2`-revision. Når faktisk kraftig udtransport har udtømt transportpotentialet, bliver Candidate G 0, mens mobilisering og jagtbarhed fortsat beregnes og kan forklares. Gaten kræver historikmarkøren for faktisk udtransport og udløses ikke af start 0, missing, neutral strøm eller svag modstrøm. Offentlig RavScore er ikke aktiveret eller ændret.
