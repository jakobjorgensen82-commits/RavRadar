...
- **ISSUE-COASTAL-PART-ADMIN-ROLLBACK – LOKALT KONTRAKTBLOKERET I 4.0.142 / AFVENTER PRIVAT CI:** En test af fremtidig adminlagring må ikke skrive Blåvand-forslaget ind i de autoritative runtime-dokumenter eller efterlade en probe. Den isolerede gate kræver tempnøgle, verificeret sletning og uændrede payload-hash/versioner.
