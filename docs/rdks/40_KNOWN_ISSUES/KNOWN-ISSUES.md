...
- **ISSUE-LIMFJORD-UV-SEARCH-RADIUS – RETTET LOKALT EFTER #1738:** Scheduler-hotfixen virkede og kørte `dkss_lf`, men tre aktive Limfjordszoner manglede stadig bulkgrundlag, fordi den faktiske marine kandidatsøgning stoppede før den eksisterende 24-km acceptgrænse. Limfjordssøgningen undersøger nu flere kandidater og bredere prober uden at hæve 24-km-grænsen eller svække kravet om fælles fysisk U/V-gitterpunkt. Afventer CI/produktion.
