...
- **ISSUE-CURRENT-SPATIAL-COVERAGE-AFTER-SEMANTICS-V2 – ÅBEN EJER-/PUNKTGATE:** #2853–#2866 gentager 187/210 verificerede hovedzoner og 596/673 verificerede lokale kystdele. De 23/77 rester har intet fælles DMI-U/V-punkt inden for 5 km og er sikkert `null` uden pil; verificerede poster har ingen kendt pil/grid-fejl. Den strenge gate er ikke ændret. Den private coverage-audit måler nu nærmeste eksakte kolonne uden at gemme fjerne værdier og skal skelne optisk 5–8 km-review fra >8 km-modelhul; første centrale artifactbevis afventes. Punktreviewlisten og #2855-snapshotet findes i `CURRENT-COVERAGE-4.0.229.md`.
