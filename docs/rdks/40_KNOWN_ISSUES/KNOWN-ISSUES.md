...
- **ISSUE-HARMONIE-PARTIAL-RUN-RESET – RETTET LOKALT EFTER #1783:** #1783 bekræftede filtreringen af to udløbne trin og behandlede aktuelle 23–01 UTC, men skiftede samtidig fra den progressive 18 UTC-generation til en ny 21 UTC-generation med kun 11 valgte forecasttrin. Med tre store assets pr. kørsel kunne femdøgnscachen derfor blive nulstillet hurtigere end den blev opbygget. Run-valget fastholder nu den foretrukne progressive generation, så længe den stadig rækker mindst 96 timer frem; ellers vælges den nyeste generation med mindst 96 fremtidige timer. En ufuldstændig nyeste publikation udskydes og logges eksplicit. Afventer frisk produktion.
