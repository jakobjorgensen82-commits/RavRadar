...
- **ISSUE-CURRENT-FIELD-ROTATION-STALLED-ON-UNCHANGED-MODEL – RETTET LOKALT / AFVENTER CI:** #2855 beholdt 491 prøver og 58 dele, fordi cursoren kun gik videre, når et nyt marineasset blev behandlet. Det ville gøre en national rotation længere end syvdøgnsretentionen. Almindelige runs kan nu genlæse højst fem tidsrelevante, allerede cachede GRIB-assets pr. tilgængeligt modelområde for kun de næste 15 private dele. Ingen ekstra download eller offentlig mutation er mulig; CI skal bevise faktisk cursor- og delvækst.
