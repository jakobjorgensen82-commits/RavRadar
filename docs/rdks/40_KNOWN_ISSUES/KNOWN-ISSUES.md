...
- **ISSUE-PUBLIC-COAST-RESIDUAL-OWNER-CORRECTIONS – UDFØRT PRIVAT / AFVENTER LILLE VISUEL KONTROL:** Ejerens autoritative eksport `(4)` indeholder alle otte afgørelser. Seks rettede/bevarede kandidater vises i `KYSTZONER-RETTELSER-KONTROL.html`; de svenske Ålsgårde/Helsingør-data og småø-kandidaten ved Fejø/Femø er forkastet. Eksisterende hovedzoner er ikke slettet. Ingen offentlig aktivering er sket.
- **ISSUE-PUBLIC-COAST-WADDEN-MAINLAND-GAP – EJERRETTET PRIVAT / AFVENTER KORREKTIONSKONTROL:** Den tidligere ejerskabsmodel manglede den ravrelevante fastlandskyst fra Emmerlev mod Esbjerg. Efter deduplikering mod den eksisterende Emmerlev-kyst er forslaget 81,883 km i tre hovedzoner uden runtime-overlap. Rømødæmningen og økyster er udeladt. To ejerbestemte broer på samlet 4.671,4 meter forbinder den fragmenterede digekyst og springer Ribe Å over; de er dokumenterede undtagelser fra den direkte GeoDanmark-linje og kræver visuel korrektionskontrol.
