...
- **ISSUE-CANDIDATE-G-CURRENT-MISSING-EVIDENCE – SEPARAT / OVERVÅGES:** Otte kystdele har ved den aktuelle fælles reference `WINDOW_HAS_MISSING_EVIDENCE`. De samme otte huller fandtes allerede i den sunde recoverykilde før den globale nulstilling. Profilgaten vælger derfor ærligt den samlede 25/40/35-reserve, indtil frisk tilladt evidens igen gør den aktuelle Candidate G-reference sammenhængende. Det er ikke et nyt scorekollaps, og der må ikke opfindes data eller blandes profiler for at skjule det.
