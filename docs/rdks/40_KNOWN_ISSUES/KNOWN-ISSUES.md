...
- **ISSUE-RAVSCORE-PUBLIC-AUDIT-OUTPUT-PARENT – LØST LOKALT / AFVENTER EXACT-HEAD:** Første produktion `33206467775` byggede den friske runtime, men stoppede før deploy, fordi runtimeauditens rapportsti lå under en endnu ikke oprettet arbejdsmappe. Auditens faglige gate er ikke lempet. Kandidaten opretter nu kun forældermappen rekursivt, og self-testen skriver/læser en nested rapport i systemets temp-mappe.
- **ISSUE-RAVSCORE-FIRST-RELEASE-STATE-REUSE – IMPLEMENTERET / AFVENTER NY PRODUKTION:** Modellen må ikke kræve flere dages ny historik efter aktivering. Produktionskæden genbruger verificeret historik, DMI/Copernicus-cache og kompatibel kompakt state eller replayer de allerede hentede prøver til schema 3. Første produktion beviste, at checkpoint og caches blev hydreret; ny kørsel skal stadig bevise 673/673 scoreklar runtime og fulde gates.
...
- **ISSUE-RAVSCORE-DELIVERY-DEPENDENCY – LØST I RELEASEKANDIDAT / AFVENTER LIVE:** Candidate G's gentagne `delivery = transportPotential × factor` er erstattet. Supply tælles præcis én gang, supply og mobilisering kobles som nødvendige led, og bølgeretning kan kun reducere bounded nærkyststøtte. Målrettede ablationer er grønne; frisk national runtime afventer.
- **ISSUE-RAVSCORE-OWNER-PRIORS – REDUCERET OG SYNLIG:** 20/50/30, +10/-8 og den kategoriske 13-timers gate er erstattet. Strømgrænserne, 6,578813/8,312951-timers supply-respons, 4/48-timers mobilisering, højst 20 % nærkystreduktion og højst 10 jagtbarhedspoint ved kraftigt faldende vand er fortsat dokumenterede versionspriorer, ikke fundkalibrerede naturkonstanter.
- **ISSUE-RAVSCORE-FALLING-WATER-LOCALITY – KENDT, BOUNDED BEGRÆNSNING:** Faldende vand kan føre noget rav væk fra inderste strand og samle det bag revle/i rende, men RavRadar observerer ikke den lokale form. Effekten er derfor begrænset til søgefokus/jagtbarhed og må aldrig udlægges som påvist revle/rende, ekstra strømvektor eller tab ud over surfzonen.
...
- **ISSUE-CANDIDATE-G-FINAL-WEIGHTS – HISTORISK / ERSTATTET AF DEC-0103:** `20/50/30` var den gældende Candidate G-produktprior, men er ikke del af `RRS-COASTAL-CAUSAL-CHAIN-1`. Den nye model kobler supply og mobilisering som nødvendige led og anvender bounded nærkyststøtte og jagtbarhed bagefter. Ingen af modellerne er fundkalibreret; repræsentative ture kan senere begrunde en særskilt kalibreringsbeslutning, men kan ikke genaktivere Candidate G som offentlig fallback.
