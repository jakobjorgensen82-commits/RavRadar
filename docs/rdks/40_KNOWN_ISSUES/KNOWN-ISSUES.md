...
- **ISSUE-CANDIDATE-G-ACTIVE-PROJECTION – PRODUKTIONSVERIFICERET / SLUTKONTROL AFVENTER:** Den globale 4.0.261-profil kræver fortsat beregnelige Candidate G-resultater for alle nødvendige rækker og begge jagtformer. Én manglende projektion skal vælge legacy for hele datasættet. PR #97/exact-head `32636378576`, merge `0f7a9d5f`, produktion `32636433944` og live `rr-20260823112726-210` beviser aktiv 210/673-projektion med 1.346/1.346 offentlige scorer identiske med Candidate G. Auditkontraktrettelse og browserkontrol udestår.
...
- **ISSUE-CANDIDATE-G-SHADOW-NOT-READY-STATUS – RODÅRSAG BEVIST / RETTELSE UNDER GATE:** Shadow `32637022498` bestod 210/673, 1.346 scoreidentiteter, rekonstruktion og dataminimering, men afviste 8 legitime `WINDOW_HAS_MISSING_EVIDENCE`-tilstande. Statekontrakten definerer fire lovlige ikke-ready-statusser: `LATEST_SAMPLE_MISSING`, `WINDOW_HAS_MISSING_EVIDENCE`, `WINDOW_INCOMPLETE` og `WINDOW_HAS_TIME_GAP`. Auditen skal acceptere dem kun ved `memoryReady=false`, fortsat kræve `READY` ved moden memory og genkøres grønt før slutkontrollen lukkes.
