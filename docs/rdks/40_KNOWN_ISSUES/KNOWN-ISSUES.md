...
## 4.0.314 – ny inspect afgrænser den ærlige før-primary; datahullet fortsat åbent
...
- **ISSUE-CANDIDATE-G-MORNING-GAP-20260829 – FORTSAT ÅBEN:** PR #230 blev merged som `228725ea`, D1-genkørsel `33277510537` er grøn, men inspect `33277738135` stoppede før descriptor med `ONE_TIME_GAP_BEFORE_NOT_UNIFORMLY_READY`. Ingen apply eller mutation er sket. Offentlig drift forbliver 4.0.310-nøddrift, indtil ny CAS-bundet inspect/apply, frisk produktion og offentlig verifikation er grøn.
...
- **ISSUE-TRIP-D1-EXACT-MAIN-4.0.314 – BEVIST PÅ `228725ea` / SKAL GENTAGES EFTER BEFORE-GATE-MERGE:** Første D1 `33277253662` stoppede efter Edge på en forbigående 503, mens hele fail-closed roll-forward bestod. Den idempotente genkørsel `33277510537` er helt grøn. Ny source-SHA kræver igen eget D1 før inspect.
...
- **ISSUE-CANDIDATE-G-MORNING-GAP-20260829 – HISTORISK CHECKPOINT, AFLØST AF DEN AKTUELLE 4.0.314-POST OVENFOR:** Redningsproduktionen gendannede komplette aktuelle data, men offentlig primary stod ved 0/673 `READY`, 673 `WINDOW_INCOMPLETE` og 5–12/48 timer. 4.0.312 blev merged, men backend fejlede den senere migrationssynk; inspect/apply blev derfor ikke kørt. Den målte komplette nødvisning forblev den sikre vej.
