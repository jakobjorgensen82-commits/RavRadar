...
- **ISSUE-GITHUB-NATIVE-SCHEDULE-DELIVERY – DRIFTSHOLD OPHÆVET / EJERHANDLING AFVENTER:** GitHub havde et midlertidigt leveringshul, men naturlige events er igen leveret og grønne for produktion `#32262008874`, Copernicus-pilot `#32262250342` og cachebevaring `#32262276171`. Repositoryets schedules og runnerkæde er dermed bevist for alle tre workflows. RavRadar-jobbene i cron-job.org kan nu deaktiveres; kun ejerens faktiske deaktivering og bekræftelse er åben.
