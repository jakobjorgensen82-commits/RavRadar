...
- **ISSUE-NATIONAL-COASTAL-PART-FRAGMENTATION – MÅLT I #2047 / GATE SKÆRPET I 4.0.150:** 755 dele blev dannet i 194 zoner uden forbindelsesgeometri. 23 dele er over 20 km, 14 har over 20 fragmenter, og Læsø når 52–55 km/57–88 fragmenter. De må ikke behandles som lokale vejrområder; 4.0.150 markerer dem fail-closed til eksplicit lokal opdeling. `DK-B10-10` er fortsat blokeret med 31 dele.
