...
- **ISSUE-OPEN-METEO-LOCKED-HOUR-WINDOW - PRODUKTIONSDELDÆKNING GRØN / NATURLIGT TIMESKIFTEBEVIS ÅBENT:** Samme artifact har lukket alle seks #3246-bølgehuller til 118 timer uden kortere hale eller ændret DMI-first-kildeorden. Push-buildet blev dog inden for UTC-time 07. Schedule `#32347036227` beviste efterfølgende korrekt fail-closed skip uden artifact, da time 08 manglede; pilot #72 gjorde timen klar. En naturlig fuld bygning, der faktisk krydser næste UTC-grænse, mangler fortsat.
