...
- **ISSUE-NATIONAL-PART-WIND-NOT-YET-VERIFIED – AKTIV / 4.0.163:** Delseriernes marine komponenter og state er valideret, men lokal HARMONIE-vind skal CI-verificeres for alle 774 dele før shadow-score. Parent-vind må ikke skjule et lokalt vindgab.
