...
- **ISSUE-PUBLIC-COAST-MUST-COMBINE-PARENT-ZONES-AND-PRECISE-SHORE – RETTET LOKALT I 4.0.182 / AFVENTER PRODUKTION:** Den godkendte løsning beholder 212 forståelige hovedzoner, men tegner 206 af dem med de præcise kystdele. De 643 interne dele giver ingen offentlige ticks, tooltips eller farveskift. Kandidaten har nul tværzoneoverlap og nul uafklarede relevante huller; seks zoner bruger fortsat sikker legacy-fallback. Fuld release og onlinekontrol mangler.
