...
- **ISSUE-CANDIDATE-G-PROFILE-SWITCH – IMPLEMENTERET SCORE-NEUTRALT / LEVERANCEBEVIS ÅBENT:** DEC-0058 vælger fortsat `RRS-CURRENT-B0-4.0.247` som ønsket, aktiv og rollbackprofil. Candidate G kan kun vælges samlet efter komplet dækning, frisk slutshadow og særskilt ejerbeslutning; manglende eller ukendt konfiguration falder fail-closed tilbage globalt. Lokal kildegate, exact-head, fuld produktion, frisk slutshadow og browserkontrol udestår for 4.0.260.
...
- **ISSUE-CANDIDATE-G-TRANSPORT-INITIAL-STATE-AND-DECAY – NATURLIG FORTSÆTTELSE BEVIST / LANG HORISONT UKALIBRERET:** Neutral og missing giver intet passivt tab. DEC-0057 fører potentiale og igangværende effektive udtransporttimer videre centralt ved `currentReferenceAt`, og same-time-rekørsel tæller ikke dobbelt. Seneste naturlige runtime accepterer 673/673 tidligere tilstande, nulstiller 0 og dokumenterer 6/6 timers alder. Ejeren accepterer det som praktisk evidens, ikke som et 48-timersbevis eller fundkalibrering.
- **ISSUE-CANDIDATE-G-PUBLIC-ACTIVATION – OMSKIFTER FORBEREDT / AKTIVERING LUKKET:** Ejeren ønsker den bedste samlede kandidat ført til offentlig brug, og `RESEARCH-3` er den anbefalede helhed. DEC-0058/4.0.260 implementerer en global versionsbundet omskifter med testet rollback, men vælger fortsat offentlig `25/40/35`. Exact-head, fuld produktion, frisk slutshadow, browsergates, central admin-roundtrip og særskilt ejer-gennemgang udestår. Manglende repræsentative ture bevares som modelusikkerhed og senere efterkalibrering.
