...
- **ISSUE-BLAAVAND-INDEPENDENT-WEATHER-SERIES – GRIDAFKLARET / PRIVAT FLERTIDSGATE I 4.0.139-KANDIDAT:** #1987 viser forskellige celler for alle seks kontrollerede komponentfelter. 4.0.139 kræver nu flere komplette native trin med delbundet provenance og nul krydsmerge. Faktisk CI-artifact, separat state/historik, UI og admin-roundtrip er fortsat åbne.
