...
- **ISSUE-CREDENTIAL-EXPIRY-NOTIFICATION – PRODUKTIONSVERIFICERET LØST:** Begge Cloudflare-tokens er uden kalenderudløb, Supabase-PAT-rotationen bestod ende-til-ende i `33024408547` før gammel tilbagekaldelse, og audit `33024621109` er grøn. Det minimale workflow har kun `issues: write`, ingen secrets og ingen deployadgang. PR #169/exact-head `33025102301`, merge `1e402834` og manuel main-prøve `33025289153` er grønne; prøven oprettede korrekt ingen issue før 60-dagesgrænsen.
