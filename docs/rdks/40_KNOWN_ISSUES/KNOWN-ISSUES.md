...
- **ISSUE-NATIONAL-COASTAL-PART-FRAGMENTATION – AKTIV MÅLING I 4.0.149:** Maskeret topologi kan indeholde mange fysiske fragmenter. 4.0.149 grupperer nærhed som multipart uden forbindelsesgeometri og blokerer zoner over 25 dele til fragmenteringsreview; faktisk national delmængde skal auditeres privat.
