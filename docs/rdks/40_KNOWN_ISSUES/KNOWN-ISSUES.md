...
- **ISSUE-VISIBLE-RANKING-MISMATCH – MERGET / AFVENTER NY PRODUKTION:** DEC-0049 sorterede efter en skjult støttebreddekorrektion, men viste bedste kyststræknings RavScore. Det kunne placere det synlige 68 under 63 og 86 under 81. Lotterikorrektionen bevares; toplisterne viser nu i stedet den afrundede områdescore, de faktisk sorterer efter.
- **ISSUE-ADMIN-COASTLINE-STATUS-FALSE-RED – MERGET / AFVENTER NY PRODUKTION:** Den første adminoversigt kontrollerede fire centrale dokumenter, mens lagertabellen viste fem. `coastline-overrides` kunne derfor se fejlagtigt utilgængelig ud. Standardkontrollen omfatter nu alle fem.
- **ISSUE-HANDBOOK-CURRENT-HISTORY-DRIFT – MERGET / AFVENTER NY PRODUKTION:** Ældre Candidate G-kandidater stod enkelte steder uden tydelig historisk mærkning, og Supabase-installationsfilen indeholdt en forældet håndbogskopi. Begge håndbøger er rettet, og versionsværktøjet synkroniserer nu hele installationskopien.
- **ISSUE-HANDBOOK-DEPLOY-OVERWRITE – TO SIKRE STOP BEVIST / ENDELIG HOTFIX AFVENTER:** Produktion `32721891349` stoppede før deploy, fordi den centralt ændrede håndbog manglede en lagret baseline ved første migrering. PR #123 bestod exact-head `32724526697` og blev merged som `00f59456`; produktion `32724616331` bestod alle øvrige gates, men stoppede før deploy, fordi den slanke Pages-pakke ikke indeholder kildefilen. Den endelige hotfix bruger kun 4.0.269-kilden på den uforanderlige commit `d745e0ba4ad88dde91c308a9ad9810797f951c91`, og kun ved SHA-256-match mod det tidligere beskyttede manifest.
