...
- **ISSUE-CANDIDATE-G-TRANSPORT-INITIAL-STATE-AND-DECAY – CENTRAL KOBLING IMPLEMENTERET / MODNING ÅBEN:** Neutral og missing giver intet passivt tab. DEC-0057/4.0.259-kandidaten fører potentiale og igangværende effektive udtransporttimer videre centralt ved `currentReferenceAt`, og same-time-rekørsel tæller ikke dobbelt. Første produktion starter fail-closed på 0 og må ikke beskrives som modnet 48-timershistorik. Exact-head, produktion og naturlig state-alder udestår.
- **ISSUE-CANDIDATE-G-PUBLIC-ACTIVATION – EJERRETNING VALGT / DIAGNOSTISK PAKKE IMPLEMENTERET:** Ejeren ønsker den bedste samlede kandidat ført til offentlig brug, og `RESEARCH-3` er den anbefalede helhed. 4.0.259-kandidaten implementerer central tilstand, offentlig diagnostic-only-score, fallback-kompatibel shadow og score-neutral rollback. Aktiv omskifter, modnet slutshadow, central admin-roundtrip for aktiveringskonfigurationen og fulde produkt-/browsergates udestår. Manglende repræsentative ture bevares som tydelig modelusikkerhed og senere efterkalibrering.
...
- **ISSUE-CANDIDATE-G-MOBILISATION-PIPELINE-STATE – IMPLEMENTERET I 4.0.259-KANDIDAT / EKSTERNT BEVIS ÅBENT:** Den kompakte afledte mobiliseringstilstand fortsætter eksakt centralt sammen med transporttilstanden. Missing og same-time holder; ændret kontekst nulstiller. Exact-head, fuld produktion, naturlig state-alder og frisk public shadow mangler som leverancebevis før aktiv scoreændring.

## 4.0.257 Candidate G national scoreinputcoverage

- **ISSUE-CANDIDATE-G-DYNAMIC-SCORE-INPUT-COVERAGE – FALLBACK-KONTRAKT IMPLEMENTERET / FRISK KØRSEL ÅBEN:** Exact-merge-shadow `32580774128` scorede kun de 243 dele i en snæver native-DKSS-testkontrakt; de øvrige 430 var ikke almindelige vejrhuller. DEC-0057/4.0.259 auditerer i stedet den producerede DMI/Copernicus/proxy-runtime og kræver 210/673 uden nuludfyldning, nabokopiering eller punktflytning. Self-test er grøn; frisk kørsel på post-merge-runtime udestår.
