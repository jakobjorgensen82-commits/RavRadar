...
- **ISSUE-CURRENT-COMMON-HOUR-COVERAGE – LOKALT RETTET I 4.0.237 / PRODUKTIONSBEVIS AFVENTER:** 4.0.236 beviste 673/673 verificerede delrecords, men udvælgeren valgte hver dels nærmeste gyldige tid uafhængigt og kunne derefter vælge en nærmere `uncertain` zonerække til visningen. Den sikre liveaudit fandt en komplet fælles række i alle 210 zoner, men kun 642/673 dele stod allerede på deres zones nærmeste komplette time. 4.0.237 publicerer `currentReferenceAt` pr. zone og låser delscore, tekst, debug, vejr og pile til den eksakte række. 100 %-kravet, DMI → Baltic → AMM15 → otte allowlistede proxyer og afstandsgrænserne er uændrede. Luk først issue efter frisk central 673/673- og liveverifikation.
