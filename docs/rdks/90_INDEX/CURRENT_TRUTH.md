...
- 4.0.149 er produktionsverificeret i #2046. Privat #2047 dannede 755 fysiske multipart-reviewdele i 194 af 208 zoner uden opdigtede forbindelser, navne, punkter eller runtimeaktivering. 54 zoner er planlagte konflikter, 11 mangler bevaret kilde, og `DK-B10-10` har 31 dele. Artifactauditen fandt desuden 23 dele over 20 km og 14 med over 20 fragmenter; 4.0.150 blokerer derfor for grove dele til lokalitetsreview før navne og punkter.
