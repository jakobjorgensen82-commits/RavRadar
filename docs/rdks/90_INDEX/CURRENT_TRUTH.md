...
- De to P1-rettelser og den målrettede lokale matrix er grønne. GitHub exact-head-run `33986893042` nåede alle kode- og kontrakttests, men releasegaten fejlede alene på den manglende rootfil `CHANGELOG-4.0.324.md`. Changelog/status-only-opfølgningscommitten er lokalt målvalideret. Ejeren har 2026-09-05 eksplicit beordret admin-merge uden at afvente en ny exact-head; 4.0.324 får derfor ikke et grønt exact-head-bevis og må ikke kaldes exact-head-grøn. Merge, active-bootstrap/runtime, fuld produktionsgate og komplet 210/673/118 er åbne. Candidate G er fortsat offentlig.
