...
- #2114/#2115 verificerede 4.0.155 i produktion og privat nationalt: præcis 783 dele, 774 sikre punktpar og ni fail-closed dele fra den aktuelle centrale admin-geometri. 4.0.156 tilføjer lokalt en national native DMI-gridgate for de 774 valgte vandpunkter og 18 normalalternativer; ingen sampling er aktiveret.
