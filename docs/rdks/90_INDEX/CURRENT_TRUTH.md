...
- 4.0.140-kandidaten validerer separat state-/historikisolation som privat replay. Hver del bruger egen `historyKey` gennem den eksisterende score-neutrale `shadow-v2`-funktion; delt nøgle, parent-genbrug, krydslæsning eller scorepåvirkning stopper gaten. Rå current-U/V bruges kun i en midlertidig ikke-uploadet fil, der slettes efter replay.
...
- Ingen Blåvand-geometri eller punkter er produktionsgodkendt. Ortofotogaten er bestået i #1982, DMI-gridgaten i #1987, identitets-/isolationskontrakten i #1992 og flertidsserie-/proveniensgaten i #1997. 4.0.140-kandidatens private state-/historik-replay er næste uafsluttede gate. De øvrige otte zoner forbliver ved redesigngaten.
