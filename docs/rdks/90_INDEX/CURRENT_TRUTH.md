...
- De to P1-rettelser og den målrettede lokale matrix er grønne: producer, provenance, rollover, active/candidate, workflow, downstream, atomic/history, `py_compile`, YAML-/JSON-parse, RDKS/security samt releaseversion/geodata. Fuld lokal sourcegate er ikke kørt og skal ikke køres lokalt; næste sourcebevis er GitHubs exact-head `validate:source`. Exact-head, merge, active-bootstrap, runtime og komplet 210/673/118 er åbne. Candidate G er fortsat offentlig.
