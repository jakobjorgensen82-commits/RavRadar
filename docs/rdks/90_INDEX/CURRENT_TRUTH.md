...
## Aktuel kandidat 2026-08-18 – kontrolleret live-pilot er ejer-godkendt
...
- Begge Copernicus-secrets findes i GitHub og forbliver kun i det autentificerede indsamlingsjob. Privat run `#32129799346` brugte Toolbox 2.4.1 og friske centrale punkter og bekræftede 39 Baltic + 4 AMM15 blandt de 51 DMI-huller. 4.0.232-kandidaten bygger nu en credentialfri online syvdøgnshistorik med gyldige U/V- og provenanceposter og kan bruge dem i score/pile efter 673/673-gaten; seneste deploy er endnu ikke opdateret.
- Ejeren har besluttet en afgrænset regional fallback for de sidste otte vestlige Limfjordsdele. `data/current-regional-proxy-policy.json` tillader kun disse, kun `dkss_lf`, kun uændret samplingpunkt og højst 15 km. Det målte spænd er 5,416–12,110 km. Kandidaten fører de valgte eksakte poster ind i score og pile med særskilt proxyproveniens; central 673/673- og liveverifikation mangler fortsat.
...
- Den implementerede rækkefølge er DMI ≤5 km → Copernicus Baltic ≤5 km → AMM15 ≤5 km → regional `dkss_lf`-proxy for de otte dele ≤15 km. Se DEC-0041. Kun eksakt samme tidspunkt må udfyldes. Aktivering afventer frisk central 673/673; den nuværende deploy er fortsat DMI-only.
