...
- #2855 afdækkede dermed et opsamlingsgab: den første rotation flyttede kun cursoren, når et nyt marineasset blev behandlet. Den lokale rettelse genlæser højst fem tidsrelevante, allerede cachede GRIB-assets pr. tilgængeligt modelområde for kun de næste 15 private forskningsdele. Den kan hverken downloade ekstra eller skrive offentlig zonecache. Cursoren avancerer efter en fuldført cachegenlæsning, også når sample keys allerede findes, så den ikke låses på dubletter eller datamangler. Ved 15-minutters drift er en 673-dels runde 45 kørsler/cirka 11 timer og 15 minutter. CI-bevis mangler endnu.
