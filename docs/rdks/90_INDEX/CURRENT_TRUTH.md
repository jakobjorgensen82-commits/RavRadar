...
## 4.0.237 kandidat – én komplet aktuel time pr. lokal zone
...
- I det aktuelle 210-zone/673-dels livegrundlag findes en komplet fælles række for begge jagtformer i alle 210 zoner. 192 zoner vælger produktionsreferencetimen, 14 den nærmeste komplette time én time før og fire én time efter. Ingen ny strømkilde eller ejerbeslutning er nødvendig.
...
- Målrettede regressioner består for progressiv runtime, 210 zoner, 673 dele, 2.100 femdøgnsvisninger, eksakte pile, DMI-bulk/forecast og Copernicus-livefletning. Fuld central validering, releasegate, frisk 673/673-produktion og livekontrol af 673/673 tidsjusterede dele afventer.
...
- De friske 12:00- og 13:00-datasæt afklarede 673/673-kildeproveniens, men beviste ikke, at hver lokal zonevisning valgte sin nærmeste komplette fælles række; denne skelnen og rettelsen ligger i 4.0.237 ovenfor. Alle tre native workflows står aktive med korrekte schedules på `main`, men GitHub oprettede ingen nye naturlige events efter cirka 11:58 UTC. Det er et eksternt driftsmæssigt hold, ikke et datamodbevis. cron-job.org må ikke deaktiveres, før et nyt naturligt event igen er verificeret.
