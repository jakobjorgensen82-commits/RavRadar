...
- De seks ejer-godkendte rettelser er nu samlet med den additive kandidat i en ny privat slutkandidat: 209 hovedzoner med præcis kyst og 643 lokale kystdele. En korrigeret, symmetrisk overlapgate fandt 11 additive dubletdele, som den tidligere ensidige kontrol overså; de er fjernet med eksisterende ejer-godkendt linje som autoritet. Én 120,7 meter lukket, irrelevant småø-del er også fjernet, og ejerskabet ved Pøl Huk er overført til `Mommark & Pøl Huk`. Den samlede kandidat har nul tværzoneoverlap.
...
- Alle 643 dele har nu land- og vandpunkt. De 604 genbrugte dele bevarer deres eksisterende punktpar; alle 39 reelt nye eller ændrede dele har nye punktpar uden blokering. Den tidligere Linux-kørsel #31531318575 bestod for den før-deduplikerede 50-punktsbestand, men er nu kun historisk evidens. En ny native DMI-gridkontrol kræves for den endelige 39-punktsbestand. Det samlede kommende hovedzoneregister er 212: 209 zoner med præcis kyst, tre eksisterende fallbackzoner og tre nye Vadehavszoner minus de tre nye zoner, som allerede tælles i de 209. Intet er aktiveret offentligt endnu.
