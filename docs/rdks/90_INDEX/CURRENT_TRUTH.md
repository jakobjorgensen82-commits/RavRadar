...
- Exact-main-run `33498108421` er fortsat negativ upstream-evidens: alle forsøgte DMI-collections blev afvist som stale katalogplan. Den sekundære selector-kaskade er lokalt lukket, men der findes endnu intet grønt frisk 118-timers preflightbevis.
