...
- 4.0.142-kandidaten tilføjer en privat Blåvand-specifik admin-roundtrip/rollback. Kun en unik midlertidig kladde må oprettes, læses, opdateres og slettes; payload-hash og versioner skal bevise, at de autoritative `coastline-overrides` og `direction-reviews` ikke ændres. Ingen aktivering.
