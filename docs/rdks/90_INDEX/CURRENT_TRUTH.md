...
- Copernicus-current schema 3 forsegler hard `OPERATIONAL_COMPLETE` på DMI-first-gapmatricen `target..+117`; measured-only `target−48..target−1` er en særskilt rådgivende historikmatrix, som må være ufuldstændig og kun påvirke historikkvalitet/bounds.
