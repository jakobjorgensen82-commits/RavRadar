...
- Den efterrettede lokale løsning fører privat manifest og prioriterer en +0–12 timers marine fil pr. modelområde før LRU under det uændrede hårde 4 GB-loft. Cache-ID følger objektstien som fremtidssikring mod eventuelle querycredentials. En gammel/tømt cache kan bootstrap-hente højst én fil pr. modelområde og tre pr. kørsel af kapaciteten efter den offentlige bygning. Replay og bootstrap behandler kun næste 15 private forskningsdele i scratch-output og kan ikke skrive offentlig zonecache. Cursoren avancerer efter mindst ét fuldført U/V-asset. Ved 15-minutters drift er en 673-dels runde 45 kørsler/cirka 11 timer og 15 minutter. Nyt CI-bevis mangler endnu.
