...
- Denne aktiveringsgate er nu bestået. Commit `5a7780e4` og central `#32158041877`/support `#3127` gav præcis 673/673: 622 lokale DMI-dele, 43 Copernicus-dele og otte regionale `dkss_lf`-proxyer. Fuld validering, releasegate, Supabase, Pages-artifact og deploy var grønne. Datasæt `rr-20260818160548-210` er direkte HTTP- og hashverificeret på den aktive GitHub Pages-side; den credentialfri historik har ved første release 1.915 poster, 633 unikke dele og syv tider. Den kontrollerede live-pilot er derfor produktionens aktuelle sandhed, mens den naturlige syvdøgnseftermåling fortsætter.
