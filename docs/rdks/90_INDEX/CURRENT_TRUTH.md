...
- #2114/#2115 verificerede præcis 783 dele, 774 punktpar og ni fail-closed dele. #2122 verificerede korrekt modelrouting: 752 valgte punkter har fuld WAM+DKSS-dækning, 18 kun komplet DKSS og fire kun komplet WAM. 4.0.158 accepterer mindst én komplet native havmodelfamilie som vand/gridbevis, men bevarer den anden families mangler eksplicit; ingen sampling er aktiveret.
