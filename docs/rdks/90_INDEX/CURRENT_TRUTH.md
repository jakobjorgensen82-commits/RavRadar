...
- Ejeren har præciseret, at slutmålet er bygning og offentlig aktivering for hele Danmark, ikke kun Blåvand. Indtil den store RavScore-analyse er dækningsmarginen fast 7 point og skal senere genbesøges. Kystdelsnavne skal være stedbaserede, fx nord/syd for et huk, en by eller en havnemole. National aktivering er endnu gated af de dokumenterede geografiske redesignfejl uden for Blåvand og manglende landsdækkende ende-til-ende-validering.
