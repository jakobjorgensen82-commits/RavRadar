...
- #2114/#2115 verificerede 4.0.155 i produktion og privat nationalt: præcis 783 dele, 774 sikre punktpar og ni fail-closed dele. #2118 viste, at 4.0.156 fejlagtigt brugte `unknown` coastType og derfor filtrerede WAM væk. 4.0.157 arver korrekt zoneklassifikation og kører relevante WAM-/DKSS-modelområder for 792 kandidater; ingen sampling er aktiveret.
