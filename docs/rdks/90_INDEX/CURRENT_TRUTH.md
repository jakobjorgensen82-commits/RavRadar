...
- 4.0.139-kandidaten bygger næste private gate: begge Blåvand-dele skal hver have mindst to komplette fælles native WAM-/DKSS-tidstrin med del-ID, komponentproveniens, gridpunkt og current-lag fastholdt. Rapporten gemmer kun tilstedeværelse og kontekstbundne værdihash, ikke rå vejrværdier. Krydsmerge og alle runtime-/score-/adminændringer forbliver forbudt.
...
- Ingen Blåvand-geometri eller punkter er produktionsgodkendt. Ortofotogaten er bestået i #1982, DMI-gridgaten i #1987 og den score-neutrale identitets-/isolationskontrakt i #1992. 4.0.139-kandidatens private flertidsserie med timeproveniens og mergekontrol er næste uafsluttede gate. De øvrige otte zoner forbliver ved redesigngaten.
