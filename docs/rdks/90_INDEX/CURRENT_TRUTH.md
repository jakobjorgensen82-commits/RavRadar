...
- Cloudflare deploy-/audit-token har fortsat de præcise mindst-mulige rettigheder og er sat til **No expiration**. Supabase-PAT'et udløber 25. august 2027; D1-run `33024408547` bestod hele kæden før gammel tilbagekaldelse, og payloadfri audit `33024621109`/`98362935528` bekræftede ti shards og 0 % uden turlæsning.
- Et secret-frit GitHub-workflow med kun `issues: write` starter et tildelt issue/mailvarsel 60 dage før PAT-udløbet og følger op ved 30/14/7/3/1/0 dage. Det kan ikke læse credentials, ture eller deploye. Der findes ingen aktiv Codex-kalenderpåmindelse.
- Workflowet bestod PR #169/exact-head `33025102301`, merge `1e402834` og manuel main-prøve `33025289153` uden for tidlig issue. Frisk produktion `33025210517`/Pages `98367528389` og offentlig `rr-20260827000855-210` er grønne på 4.0.287, 210/210 aktive zoner, fem **Bedste områder** og fuld 210/673/420/2.100-browseraudit uden fejl.
- En fremtidig sammenligning af offentligt synlige Ravudsigten-/RavRadar-resultater er kun en intern, score-neutral analyseopgave. Den omgår ingen adgang, har `scoreImpact=false`/`publicRuntime=false` og må kun være synlig i RDKS, roadmap og changelog.
