...
- Ingen Blåvand-geometri eller punkter er produktionsgodkendt. Ortofotogaten er bestået i #1982 og DMI-gridgaten i #1987. Resultaterne er ikke tilladelse til selvstændig sampling eller admin-/vejrintegration; næste Blåvand-gate er systemisk design af provenance, merge, score/state, UI og admin-roundtrip før en særskilt aktiveringsbeslutning. De øvrige otte zoner forbliver ved redesigngaten.
