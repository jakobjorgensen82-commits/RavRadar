...
- 4.0.131 klassificerer hvert fysisk kildestykke og laver en nøglefri, afgrænset audit mod Danmarks officielle stednavneregister. Lokal kørsel gav Blåvand som geometriopretning, Rømø/Thisted som semantisk flyttereview og seks zoner som grænse-/partitionsreview. Navne bliver kun kandidater; aktive zoner, admin og RavScore er uændrede. CI afventes.
