...
Ny append-only migration `20260912194206_local_unavailable_cutover_binding.sql` fører kun model-/continuationforseglinger og readbackversion frem; migration 11 er byteuændret. Både den målrettede matrix og de tunge 210/673-public-runtime-/auditregressioner er grønne; version, RDKS og slutdiff er lukket. PR #285's første head `fe4969f1`/run `34717671774` fejlede uden sourceproof, fordi migrationskædetesten brugte aktuelle hashes ved historisk rekonstruktion af 4.0.349. Den lokale rettelse låser 4.0.349 separat og fører først derefter testen videre til 4.0.350; migrationskæden er grøn, og migration 11 er stadig SHA-/byteuændret. 4.0.350 er ikke online: ny exact-head-CI, merge, backendreadback, cache-only cutover, offentlig 210/673-verifikation og efterfølgende normaldriftsbevis mangler. Se DEC-0132.
