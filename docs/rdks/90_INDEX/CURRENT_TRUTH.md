...
- 4.0.141-kandidaten tilføjer en privat score-neutral UI-gate. Parent-kystlinjen forbliver den aktive RavScore-farvede linje med uændret klikmål, tooltip, score og rangering. To delkonturer må kun være neutrale, stiplede, ikke-interaktive og mærket “Privat forslag · ikke aktiv”. Del-scorefarve, rangering og “bedste del” er forbudt. Ingen offentlig integration eller aktivering.
...
- Ingen Blåvand-geometri eller punkter er produktionsgodkendt. Ortofoto-, grid-, identitets-, flertidsserie- og state-/historikgaterne er bestået privat frem til #2004. 4.0.141-kandidaten afventer privat UI-artifactverifikation; derefter følger central admin-roundtrip/rollback og ejer-go/no-go. De øvrige otte zoner forbliver ved redesigngaten.
