...
- En gyldig lokal score kræver også egen vind. 4.0.163 tilføjer derfor en separat native HARMONIE-gate for alle 774 dele med mindst to komplette wind-U/V-trin fra samme celle. Parent-vind må ikke bruges som skjult fallback.
