...
- Feggesunds tre aktive dele skal stadig bevises direkte 3 × 118 i frisk produktion. Den tidligere åbne nabozoneproxy er pensioneret for denne release. Ingen geometri, zoner, kystnormaler eller land-/vandpunkter ændres.
...
- Resterende releasegates er: commit/push af dependency-pariteten til PR #235 og ny exact-head, merge, frisk fuld produktion/releasegate/artifact/Pages, Feggesund 3 × 118 part-level, offentlig 210/673/current/fem døgn og desktop-/mobilbrowser. Indtil hele kæden er grøn, er offentlig 4.0.316/Candidate G eneste offentlige model.
...
- Feggesund/`DK-B05-11` har 118/118 wave-missing i sanitiseret parent-zone-forecast `rr-20260830104132-210`, men de tre aktive part-id'er findes, har `marineCoverage=full`, og Candidate G-current er tilgængelig for strand/waders. Da den integrerede model producerer fra part-level 673-serier, skal frisk integrated produktion først bevise de tre deles 118-timers bølgedækning. Kun ved et reelt part-level-hul og dokumenteret umulig korrekt direkte DMI/egnet officiel data må den ejerautoriserede hypotese om konservativ nabozoneinterpolation for præcis denne ene zone vurderes. Den er ikke implementeret eller generel fallback; faktisk direct missing forbliver `UNAVAILABLE`.
...
- Candidate G er fortsat den eneste offentlige model og der findes ingen offentlig shadowmodel. Historisk 4.0.317-matrix var grøn; 4.0.319-slutmatrixen er åben. State 6 er ikke udgivet før exact-head, merge, frisk fuld produktion/deploy, Feggesund 3 × 118 og offentlig mobil-/desktopkontrol af 210/673 og alle kvalitetsflader er bevist. Offlinebevis dokumenterer teknik og fysisk sammenhæng, ikke empirisk bedre fundpræcision.
