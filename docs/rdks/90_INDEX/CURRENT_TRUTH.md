...
- #1936 produktionsverificerede 4.0.129: 21/21 udtræk er komplette, seks blev pagineret, 21 rå GeoJSON-filer på ca. 341 MB ligger i det private artifact, og pilot-/vejrgrupperne kørte uafhængigt. Næste fase er parallel read-only geometrianalyse; aktive zoner og RavScore er fortsat uændrede.
