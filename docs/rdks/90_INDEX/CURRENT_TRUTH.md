...
- 4.0.130 tilføjer den næste private read-only fase: centralt effektive pilotzoner sammenholdes med GeoDanmark `Kyst` og score-neutrale havn-/vandløbs-/høfde-/terrænlag, og der dannes målinger samt tre visuelle QA-kort. Ingen aktiv zone, adminværdi eller RavScore ændres. Lokal prøvekørsel flaggede alle ni pilotzoner til review og bekræftede, at blind snapping er uforsvarlig; CI-verifikation af selve 4.0.130-kæden afventes.
