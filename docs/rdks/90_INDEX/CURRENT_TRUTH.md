...
- De seks ejer-godkendte rettelser er nu samlet med den additive kandidat i en ny privat slutkandidat: 209 hovedzoner og 654 lokale kystdele. Én 120,7 meter lukket, irrelevant småø-del er fjernet, og ejerskabet ved Pøl Huk er overført til `Mommark & Pøl Huk`. Den samlede kandidat har nul tværzoneoverlap.
...
- Alle 654 dele har nu land- og vandpunkt. De 604 genbrugte dele bevarer deres eksisterende punktpar; alle 50 nye eller ændrede dele har nye punktpar uden blokering. Privat Linux-kørsel #31531318575 godkendte alle 50 nye vandpunkter på native DMI-grid: 50 har fuld WAM- og DKSS-dækning, nul har deldækning, og nul er blokeret. Den score-neutrale vejridentitetskontrakt er bygget til de 50 nye dele med 209 hovedzoner som forældre. Intet er aktiveret offentligt endnu.
