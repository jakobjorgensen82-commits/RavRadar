...
- 4.0.144 er produktionsverificeret i #2028 med fuld Linux-validate, releasegate, artifacts og Pages-deploy. Det private nationaljob #2029 hydrerede 208 zoner, hentede 101 fliser/707 lagforespørgsler på ca. 5:15, bestod kildevalidator og `STRtree`-QA og uploadede det private råartifact på 413 MB; build og Pages var skipped. 4.0.145 tilføjer derfor et særskilt kompakt QA-artifact, så plan, manifest og 208-zoneanalysen kan auditeres uden gentagen rådownload.
