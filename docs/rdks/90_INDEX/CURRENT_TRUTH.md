...
## Lokal 4.0.311-kildekandidat – én ejerautoriseret Candidate G-rekonstruktion

- Offentlig produktionssandhed er fortsat 4.0.310. Den nye kode ligger kun lokalt og er ikke committed, pushet, merged, anvendt eller produktionsverificeret.
...
Fuld lokal testlukning, exact-head, inspect/apply, frisk produktion, Pages og offentlig desktop/mobil/210/673 mangler fortsat og må ikke foregribes i status.
...
- Historisk 4.0.287 tillod `TRIP_STORAGE_MODE=supabase` som eksplicit manuel rollback uden normal dual-write. Denne post-cutover rollback er afløst af den lokale 4.0.311-kandidats énvejs D1-kontrakt; efter intent må kun roll-forward/reconciliation bruges. Kandidaten er ikke live endnu.
