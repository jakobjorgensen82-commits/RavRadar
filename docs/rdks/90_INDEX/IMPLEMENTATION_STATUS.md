...
- [ ] Frisk CI skal bevise `rotationAdvancedThisRun=true`, `reason=completed`, mindst ét replayasset og vækst til flere end 58 dele. En efterfølgende uændret kørsel skal bevise genbrug med nul bootstrapdownload.
