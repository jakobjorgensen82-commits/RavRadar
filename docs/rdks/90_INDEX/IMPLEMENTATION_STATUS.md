...
- [x] Registrér run `34083611297` som 78.856/79.414, 558 missing og intet deploy. Klassificér `34093354004` som sikkert partial stop: Copernicus success; Open-Meteo 2.735 required / 1.873 retained / 750 fetched / 2.623 filled; 112 critical missing; cache gemt; ingen closure/artifact/deploy. `34104536681` er aktivt på eksakt `main` `c2ce63ff`.
