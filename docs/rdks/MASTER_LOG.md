...
Ny append-only migration `20260912194206_local_unavailable_cutover_binding.sql` fører alene integrated bundle `d3b6c829…`, rollbackbundle `343f9f53…`, continuation `87ea2358…` og readbackversion frem. Migration 11 er byteuændret. De korte model-, wind/current-, public/runtime-, trip-, workflow-, migration- og bundlekontroller samt de tunge 210/673-public-runtime-/auditregressioner, versionslukning, RDKS og slutdiff er grønne. Næste rækkefølge er én exact-head GitHub-sourcegate, merge, backendapply/readback, cache-only cutover og offentlig kontrol. Normal drift genaktiveres først efter launch og bruges til at bevise kommende vind/current, rotation og tidsoverskud.
