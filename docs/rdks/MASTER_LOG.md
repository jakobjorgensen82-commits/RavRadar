## 2026-08-30 – 4.0.315 integreret RavScore-releasekandidat under DEC-0110
...
- Producent-/forbrugermatricen, RDKS, forskning, modelregister, AI-flader, begge håndbøger og de tekniske specifikationer harmoniseres som én plug-and-play-leverance. Endelige hashes og grønne run-id'er må først føres ind efter faktisk exact-head og produktion.
