...
- Offentlig Candidate G/4.0.316 er frisk. Normal produktion `33345476979`/`rr-20260831010337-210` var første grønne recoverybevis. Seneste external-watchdog-`workflow_dispatch` `33347230240` på `c58deb78` bestod fuld DMI, validate, releasegate, storage gate og Pages og publicerede `rr-20260831012407-210` komplet 210/673, `VERIFIED_ONLY`, med `syntheticSampleCount=0`. Candidate G er 0/210 aktiv på grund af historikmemory. PR #236, exact-head `33342157517` og første post-merge-produktion `33342219152` består; visuel desktop-/mobilkontrol er stadig åben.
- `33343469247` og `33344823000` stoppede sikkert i build/prepare på transient HTTP 503; deploy var skipped. En bounded-retry-hotfix er under færdiggørelse, mens PR-/commit-id står åbne.
- Den lokale 4.0.318-binding er regenereret til integrated `778db7aa3946f925607a8304daa42ed17dd30294e4a51bf6d895d7293e84c4e7`/`093199540ed877c5cb94e16a7f640cb18814103adfc6dc22912d59f8e9eab061` over 43 filer/7 consumers og Candidate G-rollback `c73dac1b4376005e792580791d84eb79c9370e905a2a7fd0bdee857506a20cf8`/`e20362ad044f2a0da1cc6b196b9ae215fc48a467085a887f174d16a5559a90b1` over 54 filer.
