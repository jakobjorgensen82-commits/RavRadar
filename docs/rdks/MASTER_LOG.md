...
- Live version 4.0.236/datasæt `rr-20260819123607-210` er direkte metadata-verificeret med virkelig byggetid 12:36, `productionReferenceAt=12:00`, 210 zoner og 673 verificerede dele: 622 almindelige DMI, 39 Baltic, fire AMM15 og otte godkendte `dkss_lf`-proxyer. Alle 673 bruger ejerens centralt godkendte land-/vandpunkter. Første naturlige 4.0.236-schedule-event og faktisk cron-job.org-deaktivering afventer stadig.
...
- GitHub oprettede ingen nye naturlige events for produktion, pilot eller cachebevaring efter cirka 11:58 UTC, selv om alle tre workflows er aktive med korrekte cronudtryk på `main`. Manuel drift virker, og GitHub dokumenterer delay/drop af schedules under belastning. cron-job.org-overdragelsen er derfor sat på hold, indtil et nyt naturligt event er verificeret.
