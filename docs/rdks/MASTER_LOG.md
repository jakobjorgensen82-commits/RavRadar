...
- Et frisk final fetch før commit bekræfter `origin/main=49dd4cb454656bdf629e5df760176705e38d2cb0`, 4 commits bag branchspidsen og nul nyere main-commits at integrere. Candidate G-kildebaseline og nyere ejerbeslutninger er derfor uændrede ved dette checkpoint.
...
- DEC-0110 og loggens øverste 4.0.315-afsnit er autoritative: `RRS-COASTAL-PROCESS-INTEGRATED-1.1.0`, state `5.0.0`, det kausale energivægtede wave-approach-led med fire timers halveringstid og en ældre hale, schema-5-migration/rollback, same-model-nøddrift og de aktuelle trustgrænser. Candidate G er fortsat eneste offentlige model, indtil exact-head, merge, frisk produktion og offentlig browserkontrol er bevist.
