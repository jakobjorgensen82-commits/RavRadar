...
- Lokal implementering og den målrettede matrix er grøn. GitHub-run `33986893042` nåede alle underliggende kode- og kontrakttests, men releasegaten fejlede alene på manglende `CHANGELOG-4.0.324.md`. Changelog/status-only-opfølgningscommitten er lokalt målvalideret. Ejeren har 2026-09-05 eksplicit beordret admin-merge uden at afvente en ny exact-head. 4.0.324 får derfor ikke grønt exact-head-bevis og må ikke omtales sådan. Merge, active-bootstrap/runtime, fuld produktionsgate, stor opfyldning, komplet 210/673/118 og modelaktivering er åbne.
