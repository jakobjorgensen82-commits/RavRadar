...
- Den nye lokale efterrettelse registrerer collection/modelrun/gyldighed i et privat manifest og prioriterer en tidsrelevant +0–12 timers marine fil pr. modelområde før LRU under det hårde 4 GB-loft. Objektsti-baseret cache-ID er kun fremtidssikring mod eventuelle querycredentials. Hvis en gammel eller tømt cache mangler filen, må højst én pr. modelområde og tre pr. kørsel bootstrap-hentes af kapaciteten efter den offentlige bygning. Kun de 15 private forskningsdele og et tomt scratch-output behandles. 45 normale 15-minutters kørsler dækker én 673-dels rotation. Frisk CI- og genbrugsbevis mangler.
