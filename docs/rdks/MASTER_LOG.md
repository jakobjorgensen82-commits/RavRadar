...
- En partial kandidat må kun fastholde sit native run over seks timers modelskift, mens mindst normalt 96 timers moden/komplet fremtidshorisont består og kataloget ikke er dokumenteret stale. Manglende eller READY kandidat vælger nyeste komplette run; retention må ikke pinne cirka +120 timer gammelt arbejde.
