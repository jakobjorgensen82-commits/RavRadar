...
#2029 verificerede kæden på faktiske nationale data: 208 centralt effektive zoner gav efter hydration 100 fliser og 700 lagforespørgsler, som blev hentet på cirka 5 minutter og 15 sekunder; validator og source-QA bestod, og hele jobbet sluttede på 7 minutter og 45 sekunder. De tidligere 101/707 var repositorybaseline før central tombstone/geometri. Råartifactet er 413 MB komprimeret. #2033 verificerede det separate kompakte artifact på 6,8 MB.

Det kompakte artifact indeholder 12.094 deduplikerede `Kyst`-features og 9.929 rumligt relevante kyststykker. Kun 20 af 208 zoner er source-reference-ready; 188 er flagget. Derfor må næste trin ikke generere produktionslinjer ved nærmeste snap. 4.0.146 danner i stedet en privat read-only topologiaudit: officielle Farvand-polygoner af typerne fjord/nor maskeres uden for `coastType=limfjord`; havne og synlige åmundinger måles efter pilotens konservative buffere; klit/skrænt måles som relevansevidens, og høfter registreres fortsat uden scoreeffekt.

#2037 målte 90 officielle fjord-/norpolygoner, 1.225 havneobjekter, 3.347 høfter og henholdsvis 183/168 zoner med klit-/skræntevidens. Åmundingsheuristikken gav 2.868 klynger i 180 zoner og 189 i den mest ekstreme zone. Den tekniske gate var grøn, men det faglige resultat er afvist som oversegmentering. Fra 4.0.147 tilbageholdes åmasker i zoner over 20 klynger, og artifactet gemmer en aggregeret egenskabsprofil samt højst 200 geometri-frie diagnostiske poster til regelrevision.

#2040 bekræftede, at alle 45 overdense zoner havde `riverMasksApplied=false`. Egenskabsprofilen viste, at alle kandidater var synlige og `Almindelig`, mens bredden skilte: 2.551 var 0–2,5 m, 806 var 2,5–12 m og 37 mindst 12 m. 4.0.148 tester derfor mindst 2,5 m officiel midtebredde og mindst 100 m fysisk linjelængde; den eksisterende kystkontakt-, indlands- og overdense-gate bevares.

#2043 reducerede klyngerne fra 2.868 til 489 og overdense zoner fra 45 til én allerede kendt partitionskonflikt. 137 zoner fik kontrollerede masker, mens no-go-zonen beholdt `riverMasksApplied=false`. #2050 verificerede 755 multipart-reviewdele og fail-closed lokalitetsflag på 25 zoner/28 dele. 4.0.151 bruger 100 fliser med 0,12 graders ekstra navnemargin; lokal måling gav 503 requests, 37.815 deduplikerede officielle steder og balancerede kandidater til 755/755 dele uden automatisk navn eller lokale datapunkter.
