...
#2043 reducerede klyngerne fra 2.868 til 489 og overdense zoner fra 45 til én allerede kendt partitionskonflikt. 137 zoner fik kontrollerede masker, mens no-go-zonen beholdt `riverMasksApplied=false`. #2055 verificerede 755 multipart-reviewdele og balancerede officielle kandidater til 755/755 dele. 4.0.152 grupperer kildefragmenter inden for 3 km uden forbindelsesgeometri og deler de 28 grove dele i 56 forslag på højst 20 km; fuld kildelængde skal bevares.
