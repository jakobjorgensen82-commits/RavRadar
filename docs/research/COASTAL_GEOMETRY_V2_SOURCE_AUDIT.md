...
#2043 reducerede klyngerne fra 2.868 til 489 og overdense zoner fra 45 til én allerede kendt partitionskonflikt. 137 zoner fik kontrollerede masker, mens no-go-zonen beholdt `riverMasksApplied=false`. 4.0.149 grupperer derefter kun bevarede fysiske linjestykker til multipart-reviewdele; den tilføjer ingen forbindelsessegmenter, stednavne eller lokale datapunkter.
