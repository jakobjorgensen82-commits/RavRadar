...
#2043 reducerede klyngerne fra 2.868 til 489 og overdense zoner fra 45 til én allerede kendt partitionskonflikt. 137 zoner fik kontrollerede masker, mens no-go-zonen beholdt `riverMasksApplied=false`. #2047 grupperede kun bevarede fysiske linjestykker til 755 multipart-reviewdele og tilføjede ingen forbindelsessegmenter, stednavne eller lokale datapunkter. Auditten fandt 23 dele over 20 km og 14 med over 20 fragmenter; 4.0.150 gør disse mål til en fail-closed lokalitetsgate før navne og punkter.
