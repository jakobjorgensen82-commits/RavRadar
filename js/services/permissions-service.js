...
import { authorizedFetch, currentSession, requireFreshSession, getCurrentProfile } from "./auth-service.js?v=4.0.323";
...
export const EXPERT_PERMISSION_IDS=Object.freeze([
 'admin_access',
 'handbook_view',
 'handbook_review'
]);
