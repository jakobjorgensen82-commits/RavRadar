import { authEnabled, currentSession, sendMagicLink, signInWithPassword, signOut, signUpWithPassword } from "../services/auth-service.js?v=4.0.389";
import { getLocalObservations, getOwnTripObservations, submitAccountTripReportObservation } from "../services/observation-service.js?v=4.0.389";
import { buildAccountTripReport, toAccountObservationColumns } from "../services/account-trip-report-contract.js?v=4.0.389";
import { openAccountTripReportDialog } from "./trip-evidence-dialog.js?v=4.0.389";
import { formatDateTime, formatNumber, t } from "../i18n.js?v=4.0.389";
import { RAVSCORE_CALIBRATION_ELIGIBLE, ravScoreModelBinding } from "../core/ravscore-model-contract.js?v=4.0.389";
import { accountTripBindingStatus } from "../services/calibration-eligibility.js?v=4.0.389";
