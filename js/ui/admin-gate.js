import { authEnabled,currentSession,signInWithPassword,signOut,getCurrentRole,testConnection } from '../services/auth-service.js?v=4.0.279';
...
async function start(){
 ...
 try{const role=await getCurrentRole();if(role!=='owner'){await signOut();return showMessage('Adgang nægtet',`Denne konto har rollen ${esc(role||'ukendt')}. Kun RavRadars ejer kan åbne administrationen.`)};root.hidden=true;shell.hidden=false;await import('./admin-app.js?v=4.0.279');}
