...
function runAudit() {
  ...
  const report = {
    ...
    activationGatesRemaining: [
      'CENTRAL_DERIVED_TRANSPORT_AND_MOBILISATION_STATE_PIPELINE',
      'FRESH_FALLBACK_COMPATIBLE_NATIONAL_SCORE_NEUTRAL_SHADOW',
      'PUBLIC_EXPLANATION_AND_BROWSER_CONTRACT',
      'CENTRAL_ADMIN_ROUNDTRIP_ROLLBACK_AND_FULL_PRODUCT_GATES',
    ],
    disclosedModelUncertainties: [
      'CURRENT_NORMAL_THRESHOLDS_ARE_OWNER_APPROVED_TECHNICAL_PRIORS_NOT_FIND_CALIBRATED',
      'MOBILISATION_HALF_LIVES_ARE_RESEARCH_PRIORS_NOT_FIND_CALIBRATED',
      'REPRESENTATIVE_COMPLETE_TRIPS_ARE_NOT_AVAILABLE_FOR_PRE_ACTIVATION_CALIBRATION',
    ],
  ...
  assert.deepEqual(report.activationGatesRemaining, [
    'CENTRAL_DERIVED_TRANSPORT_AND_MOBILISATION_STATE_PIPELINE',
    'FRESH_FALLBACK_COMPATIBLE_NATIONAL_SCORE_NEUTRAL_SHADOW',
    'PUBLIC_EXPLANATION_AND_BROWSER_CONTRACT',
    'CENTRAL_ADMIN_ROUNDTRIP_ROLLBACK_AND_FULL_PRODUCT_GATES',
  ]);
  assert.ok(report.disclosedModelUncertainties.includes(
    'REPRESENTATIVE_COMPLETE_TRIPS_ARE_NOT_AVAILABLE_FOR_PRE_ACTIVATION_CALIBRATION',
  ));
