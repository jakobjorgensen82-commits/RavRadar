...
WINDOWS = {
    ...
    "DK-B10-16": (11.18, 54.87, 11.62, 55.03),
}
SELECTIONS = {
...
def audit_report(reviews, candidate):
    return {
        ...
        "zones": [{
            ...
            "legacyGeometryRejected": review["zoneId"] in {"DK-B08-18", "DK-B08-19", "DK-B10-14", "DK-B10-16"},
        } for review in reviews],
