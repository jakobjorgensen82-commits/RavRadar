...
export const RUNTIME_BINDING_REGISTRY = Object.freeze([
  ...
  freezeEntry({
    ...
    producer: 'scripts/lib/public-hour-delivery-pack.mjs#buildPrivatePublicHourDeliveryPack',
    consumers: [
      'scripts/lib/public-hour-delivery-pack.mjs#inspectPrivatePublicHourDeliveryPack',
      'scripts/lib/rebind-public-hour-pack-exact.mjs',
      'scripts/audit-pages-artifact-privacy.mjs#assertPublicDeliveryNestedBinding',
      'scripts/migrate-post-cutover-private-runtime.mjs',
      'scripts/private-production-runtime-workflow.mjs',
    ...
    validator: 'privatePublicHourDeliveryMarker+inspectPrivatePublicHourDeliveryPack+assertPublicDeliveryNestedBinding+exactSameReferencePackDigest',
