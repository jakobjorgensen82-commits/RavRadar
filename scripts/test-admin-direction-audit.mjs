...
for(const required of ['data-tab="directionAudit"','leaflet@1.9.4','4.0.33'])if(!html.includes(required))throw new Error(`admin.html mangler ${required}`);
...
if(!js.includes('ravradar-runtime-diagnostics.json?t=${Date.now()}'))throw new Error('Admin henter ikke frisk runtime ved download');
