...
assert.match(update, /(?:const|let) stationLifecycle\s*=\s*await updateStationObservationLifecycle\(rawStationRegistry,/);
assert.match(update, /(?:const|let) stationRegistry\s*=\s*stationLifecycle\.stations/);
