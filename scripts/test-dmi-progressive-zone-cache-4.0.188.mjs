...
const materialize = stepIndex('Strictly bind and materialize the active DMI generation');
...
const materializeBlock = stepBlock('Strictly bind and materialize the active DMI generation');
