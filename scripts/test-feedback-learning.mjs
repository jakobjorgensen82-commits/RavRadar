...
const features={
  modelVersion:binding.modelId,modelStateVersion:binding.stateSchemaVersion,
  modelVariantId:binding.variantId,modelProfileId:binding.profileId,
  modelComponentSchemaId:binding.componentSchemaId,
  modelExplanationSchemaId:binding.explanationSchemaId,
  modelRankingPolicyId:binding.rankingPolicyId,
  modelBestTimePolicyId:binding.bestTimePolicyId,
  modelPresentationPolicyId:binding.presentationPolicyId,
  modelContractSha256:binding.modelContractSha256,
  modelBundleSha256:binding.modelBundleSha256,appVersion:'4.0.308',totalScore:63,huntabilityScore:70,
...
assert.equal(remote.calibration_eligible,false);
