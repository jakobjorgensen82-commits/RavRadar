...
requireMarkers('Den historiske state-5-plan for Candidate G-rollback', `${operationalRollback?.title || ''}\n${operationalRollback?.body || ''}`, [
...
requireMarkers('Markdown-håndbogens aktuelle status og kontrakt', markdown, [
  ...
  '`modelContractSha256` binder parameterkontrakten som `778db7aa3946f925607a8304daa42ed17dd30294e4a51bf6d895d7293e84c4e7`',
  '`modelBundleSha256` binder præcis 43 kanonisk normaliserede, transitive implementeringsfiler som `74bfc42bb008f6743f374fc35201d3ea6f81f6e360c99873541fed83eeadcbae`',
  ...
  '`modelBundleSha256=fd3f7e70ec3706818c153c26140ae592e4f0ad2acc6c157183984689f74a2207`',
