...
assert.equal(REQUIRED_CUTOVER_MIGRATIONS.length, 33,
...
assert.equal(LATEST_REQUIRED_CUTOVER_MIGRATION.version, '20260923130000');
...
try {
  ...
  assert.match(
    helperRun.stdout,
    /exactly 20260923130000_checkpoint_rejection_diagnostic.sql/,
