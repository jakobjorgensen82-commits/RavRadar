...
const source=await fs.readFile('scripts/audit-national-coastal-part-names.py','utf8');const validator=await fs.readFile('scripts/validate-national-coastal-part-names.py','utf8');const workflow=await readProductionWorkflowSource('orchestrator');
