...
for(const x of ['inventedConnectionCount":0','official-place-name-required','landPointProposed":False','weatherSamplingEnabled":False','blocked-planned-conflict'])assert.ok(source.includes(x),`Mangler ${x}`);
