...
const source=await fs.readFile('scripts/build-national-local-part-names.py','utf8');const validator=await fs.readFile('scripts/validate-national-local-part-names.py','utf8');const workflow=await fs.readFile('.github/workflows/update-and-deploy.yml','utf8');
