...
for(const token of ['centrally-hydrated-zone-dataPoint','official-farvand-place-candidate','NO_OFFICIAL_LAND_WITNESS','NO_VALID_OPPOSITE_WITNESS_PAIR','unresolvedNormalCandidates','coastType','weatherSamplingEnabled":False','automaticActivationAllowed":False'])assert.ok(source.includes(token),`Punktbygger mangler ${token}`);
