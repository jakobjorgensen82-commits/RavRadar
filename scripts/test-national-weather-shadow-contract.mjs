...
if(!/Validate isolated private native wind series[\s\S]{0,240}DMI_BULK_ATMOSPHERIC_GRID_CANDIDATES: "32"/.test(workflow))throw new Error('National vindgate mangler afgrænset privat HARMONIE-kandidatsøgning');
