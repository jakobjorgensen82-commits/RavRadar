...
if(audit.refinedZones+audit.fallbackZones!==210) fail.push("audit dækker ikke 210 zoner");
if(zones.features.length!==210) fail.push("zonefilen har forkert antal zoner");
