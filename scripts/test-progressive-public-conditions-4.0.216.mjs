...
const scoreAvailability={schemaVersion:2,policy:'integrated-model-local-fail-closed',allZonesActive:false,allCurrentScoresFullHistory:false,activeZoneCount:0,fullHistoryModeCount:0,historyIncompleteModeCount:0,historyIncompleteZoneCount:0,evaluatedAt:generatedAt,historyIncompleteZones:[],unavailableZoneCount:1,totalZoneCount:1,unavailableZones:[{zoneId:'z1',zoneName:'Testzone',modes:['waders','beach'],reasons:['Den integrerede RavScore mangler komplette data.']}]};
...
if(JSON.stringify(Object.keys(startup.coastalParts.parts))!==JSON.stringify(['p1'])||'current' in startup.coastalParts.parts.p1)throw new Error('En lokalt utilgængelig scorerække skal bruge den deterministiske eksisterende repræsentant uden at opfinde en vinder eller offentliggøre delens fulde currentdata.');
