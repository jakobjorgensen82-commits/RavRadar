...
try {
  detailsText=await fs.readFile('data/live/public-condition-details.json','utf8');
} catch (error) {
...
const occurrences=(workflow.match(/^\s*run: node scripts\/generate-public-conditions\.mjs\s*$/gm)||[]).length;
