...
for(const token of ['protected-asset-manifest','sha256','springer skrivning over','buildRuntimeDiagnosticsEnvelope','pakket tabsfrit','handbook-source-baseline','mergeProtectedHandbook'])assert.ok(writer.includes(token),`Idempotent protected sync mangler ${token}`);
