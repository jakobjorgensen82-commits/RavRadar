...
if(all.length<1) throw new Error('Zone Registry er tomt');
if(active.length!==all.length||invalid.length) throw new Error(`Zone Registry skal kun indeholde eksplicit aktive zoner; aktive=${active.length}, ugyldige=${invalid.length}`);
