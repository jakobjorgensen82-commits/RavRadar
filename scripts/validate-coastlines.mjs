...
const errors=[];
const allowed=new Set(["2.6.24","3.0.2","4.0.45","4.0.46-safe-rollback","4.0.47","4.0.44-fallback","4.0.48","4.0.48-safe-fallback","4.0.64-manual-roemoe","4.0.182"]);
for(const feature of zones.features||[]){
 ...
 if(p.coastLineVersion==="4.0.182" && p.coastLineRefinementMode!=="owner-approved-precise-public-coast") errors.push(`${p.id}: 4.0.182-kyst mangler ejerens godkendte refinement mode`);
