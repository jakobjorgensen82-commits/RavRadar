...
function buildCandidateShadow(partRows,contract){
  ...
  const nationalCoverageGate={
    ...
    fullNativeFamilyPartCount:Number(contract.fullCoveragePartCount??partRows.length),
