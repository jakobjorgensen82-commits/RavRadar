...
def validate(report,geo,waters):
    ...
    if report.get("riverMouthOversegmentationZoneCount")!=len(over) or report.get("nationalRiverMouthPolicyAccepted")!=(len(over)==0):fail("National åmundingspolicy-status er inkonsistent.")
