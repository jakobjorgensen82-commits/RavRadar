...
export function baselineZoneIds({ baselinePath = 'data/geometry-snapshots/zones-4.0.44.geojson', permanentlyRetired = ['DK-B04-09', 'DK-B10-16'], ownerApprovedAdditions = ['DK-B04-12', 'DK-B04-13', 'DK-B04-14'] } = {}) {
