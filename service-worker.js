const CACHE = "ravradar-v2-6-15";
const STATIC = ["./", "./index.html", "./style.css?v=2.6.15", "./app.js?v=2.6.15", "./config.js", "./data/zones.geojson", "./data/model.json", "./js/core/score-engine.js", "./js/services/data-service.js", "./js/services/auth-service.js", "./js/services/trip-service.js", "./js/services/observation-service.js", "./js/map/map-view.js", "./js/ui/info-panel.js", "./js/ui/account-panel.js", "./js/ui/developer-panel.js"];
