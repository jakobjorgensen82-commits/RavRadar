...
as $$
  select case
    ...
    when p_model_version = 'RRS-COASTAL-PROCESS-INTEGRATED-1.1.0'
      ...
      and p_calibration_features ->> 'modelBundleSha256' = '4346bf2de26a0dde25c3ef8dc72e741d6259f15282801e62a95a31a8f6594c0d'
    ...
    when p_model_version = 'RRS-CANDIDATE-G-CURRENT-LED-WAVE-MOBILISATION-RESEARCH-3'
      ...
      and p_calibration_features ->> 'modelBundleSha256' = '71a093a4b419891cb41f582de2ab926a2ea23e5abbe16015cc2b6f4b3ae8be0f'
...
begin
  if jsonb_typeof(p_state) is distinct from 'object'
    ...
    or p_state ->> 'modelBundleSha256'
      is distinct from '4346bf2de26a0dde25c3ef8dc72e741d6259f15282801e62a95a31a8f6594c0d'
...
begin
  if p_target_reference is null
    ...
    or p_payload ->> 'continuationStateContractSha256' is distinct from
      '5456d603a687e03b8983b5a97712b4acd305011a6029edb90df72d1d3e4f702f'
  ...
  if v_integrated_binding is distinct from '{
    ...
    "modelBundleSha256": "4346bf2de26a0dde25c3ef8dc72e741d6259f15282801e62a95a31a8f6594c0d"
  }'::jsonb then
    return false;
  end if;
  ...
  if v_candidate_binding is distinct from '{
    ...
    "modelBundleSha256": "71a093a4b419891cb41f582de2ab926a2ea23e5abbe16015cc2b6f4b3ae8be0f"
  }'::jsonb then
    return false;
  end if;
...
begin
  ...
  return pg_catalog.jsonb_build_object(
    ...
    'appliedMigrationVersion', case when exists (
      select 1
      from supabase_migrations.schema_migrations m
      where m.version::text = '20260906162332'
    ) then '20260906162332' else null end,
