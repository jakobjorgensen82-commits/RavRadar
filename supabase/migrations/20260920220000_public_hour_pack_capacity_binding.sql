  ...
  select case
    ...
    when p_model_version = 'RRS-COASTAL-PROCESS-INTEGRATED-1.1.0'
      ...
      and p_calibration_features ->> 'modelBundleSha256' in (
        ...
        'c495e63d32cf2578296a945ef0f289a0212b5a664efdcb33602f777eb3bc7ed1'
      )
    ...
    when p_model_version = 'RRS-CANDIDATE-G-CURRENT-LED-WAVE-MOBILISATION-RESEARCH-3'
      ...
      and p_calibration_features ->> 'modelBundleSha256' = '618b2b44c93316f6798a17fbbd020cdacda9aff73bfde4cbbbaa05d3fa197ace'
...
begin
  if jsonb_typeof(p_state) is distinct from 'object'
    ...
    or p_state ->> 'modelBundleSha256'
      is distinct from 'c495e63d32cf2578296a945ef0f289a0212b5a664efdcb33602f777eb3bc7ed1'
...
begin
  if p_target_reference is null
    ...
    or p_payload ->> 'continuationStateContractSha256' is distinct from
      '9702630e114ab4cd09b185b397b302afcaf4a81881f6aae3ec0b6995419525e0'
  ...
  if v_integrated_binding is distinct from '{
    ...
    "modelBundleSha256": "c495e63d32cf2578296a945ef0f289a0212b5a664efdcb33602f777eb3bc7ed1"
  }'::jsonb then
    return false;
  end if;
...
begin
  ...
  return pg_catalog.jsonb_build_object(
    ...
    'appliedMigrationVersion', case when exists (
      select 1
      from supabase_migrations.schema_migrations m
      where m.version::text = '20260920220000'
