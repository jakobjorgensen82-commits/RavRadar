...
as $$
  select case
    ...
    when p_model_version = 'RRS-CANDIDATE-G-CURRENT-LED-WAVE-MOBILISATION-RESEARCH-3'
      ...
      and p_calibration_features ->> 'modelBundleSha256' = '6bdae434614fd3e43db15d6d03b06916fbe9a43624e3f1b4df652866c6a46d42'
...
begin
  if p_target_reference is null
    ...
    or p_payload ->> 'continuationStateContractSha256' is distinct from
      '6d3311c9204065b5e6246aa96aaef23e0784d83fa7210893e2e7fa03d0e8573e'
  ...
  if v_candidate_binding is distinct from '{
    ...
    "modelBundleSha256": "6bdae434614fd3e43db15d6d03b06916fbe9a43624e3f1b4df652866c6a46d42"
  }'::jsonb then
    return false;
  end if;
