...
-- Service-role-only metadata readback for an exact integrated RavScore
-- cutover. It inspects committed schema metadata and never selects an
-- observation row. The authoritative implementation is also carried by the
-- versioned cutover migration.
...
-- RAVSCORE_CUTOVER_FRESH_INSTALL_PARITY_BEGIN
...
-- RAVSCORE_CUTOVER_FRESH_INSTALL_PARITY_END
